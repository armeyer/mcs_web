...
\ppart Let \emph{T} be the event that the household has two girls,
and \emph{O} be the event that a girl opened the door.  List the outcomes
in \emph{T} and \emph{O}.

\begin{solution}
$T=\set{GGE,GGY}, O=\set{GGE,GGY,GBE,BGY}$
\end{solution}
...
\ppart What mistake is made in the following argument? Do not merely supply what the correct probability should be for your explanation.
