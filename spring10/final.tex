...
\examspace
  \pinput[points = 6, title = \textbf{Asymptotic Bounds and Partial Orders}]{FP_asymptotic_partial_order}

\examspace
  \pinput[points = 10, title = \textbf{Planar Embeddings}]{FP_planar_structural_induction}

\examspace
  \pinput[points = 11, title = \textbf{Graph Coloring}]{FP_coloring_false_proof}

%\examspace
%  \pinput[points = 5, title = \textbf{Tom \#3}]{FP_stable_matching_unlucky}

%\examspace
%  \pinput[points = 5, title = \textbf{Tom \#4}]{MQ_10_heads_and_100_tails}

\examspace
  \pinput[points = 10, title = \textbf{Modular Arithmetic}]{FP_modular_powerful}

\examspace
  \pinput[points = 10, title = \textbf{Magic Trick Redux}]{FP_magic_trick_27_cards}
  
%\examspace
%  \pinput[points = 5, title = \textbf{Counting + Pigeonhole}]{FP_toy_button_counting}

\examspace
  \pinput[points = 11, title = \textbf{Counting + Combinatorial Proof + Binomial Thm}]{FP_combinatorial_binomial}
...
\examspace
  \pinput[points = 12, title = \textbf{Towers of Sheboygan}]{FP_towers_of_Sheboygan}
...
\examspace
  \pinput[points = 12, title = \textbf{Hat Check}]{CP_chebyshev_hat_check}

%\examspace
%  \pinput[points = 5, title = \textbf{Eli \#3}]{FP_monty_hall_variant}

\examspace
  \pinput[points = 8, title = \textbf{Sampling}]{FP_sampling_perturbed}
