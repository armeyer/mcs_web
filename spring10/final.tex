...
\examspace
  \pinput[points = 10, title = \textbf{Graph Coloring}]{FP_coloring_false_proof}
...
\examspace
  \pinput[points = 10, title = \textbf{Counting + Combinatorial Proof + Binomial Thm}]{FP_combinatorial_binomial}
...
\examspace
  \pinput[points = 15, title = \textbf{Towers of Sheboygan}]{FP_towers_of_Sheboygan}
