...
\examspace
  \pinput[points = 5, title = \textbf{Probable Satisfiability}]{CP_probable_satisfiability_nk}
...
\examspace
  \pinput[points = 5, title = \textbf{Tom \#2}]{FP_coloring_false_proof}
...
\examspace
  \pinput[points = 5, title = \textbf{Counting + Combinatorial proof + Binomial Thm}]{FP_combinatorial_binomial}
...
\examspace
  \pinput[points = 5, title = \textbf{Eli \#2}]{CP_chebyshev_hat_check}
