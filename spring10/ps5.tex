...
edigraphs, doing digraph handhsaking with $\sum_V \indegr{v} = \sum_V
...
\pinput{CP_stable_matching_non_optimal} % used F09 pset
...
\pinput{FP_santa_state_machine} % used F09 final
