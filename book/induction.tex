...
\begin{definition}
  A \emph{preserved} \term{invariant} of a state machine is a predicate, $P$, on
...
The Invariant Principle was formulated by Robert W. \idx{Floyd} at Carnegie
...
In that same year, Albert R. \idx{Meyer} was appointed Assistant
Professor in the Carnegie Tech Computer Science Department, where he
