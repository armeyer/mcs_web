...
During the development of MIT famous Stata Center, costs rose further
...
Induction proof.  It's equally easy to take any Induction proof and
reformat it into a Well Ordering proof.
...
Well Ordering proofs sometimes come out slightly shorter than induction
proofs.  On the other hand, induction proofs may make them clearer because
they resemble recursive procedures which reduce handling an input of size
$n+1$ to handling one of size $n$, The choice of method is really a matter
of style---but style does matter.
