...
\gnote{Fig.~E1, p. 39 (E-19), ch17-ftl-jul25.pdf}
...
\dmj{You call it ``collusion'' in the section title but
  ``collaboration'' throughout the text.  It doesn't have to be
  consistent, but it would be better if it were.  I like ``colluding''.}
...
\gnote{Fig.~E2, p. 43 (E-23), ch17-ftl-jul25.pdf}
...
\item the states divides 1/2 of the money collected among the people
  ...
  Dig.\dmj{The ``Big Dig'' reference might be too parochial.}
...
\subsection{Sums of Indicator Variables}\sec{sec:hat_check}
...
Since $G_i$~is an indicator random variable, we from
...
But what if the coins are no mutually independent?  It doesn't
