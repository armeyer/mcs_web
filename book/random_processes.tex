...
bankruptcy, it's clear by symmetry that his probability of winning in
this case is 1/2.
...
nearly all the time, when he loses, he loses big: \$1M, while when he
wins, he wins only \$100.  The gambler's average win remains zero
dollars, which is what you'd expect when making fair bets.
...
single bet is $p = 18/38$ is a little less the one half \iffalse
\approx 0.47\fi The casino has an advantage, but the bets are close to
fair, and you might expect that starting with \$500, the gambler has a
reasonable chance of winning \$100---the 5/6 probability of winning in
the unbiased game surely gets reduced, but perhaps not too
drastically.

That mistaken intuition is how casinos stay in business.  In fact, the
...
namely 0.\footnote{Here we're legitimately appealing to infinite
...
The web graph is an enormous graph with many trillions of vertices.
