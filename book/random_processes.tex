...
The gambler plays until either he is runs out of money or increases
his capital to a target amount of $T$ dollars.  The amount $T-n$ is
defined to be his \term{intended profit}.  If he reaches his target,
...
The bound~\eqref{LN12:biaswinsimp} decreases exponentially with the
intended profit.  So, for example, doubling his intended profit will
square his probability of winning.  In particular, the probability
that the gambler's stake goes up $200$ dollars before he goes broke
playing roulette is at most
\[
...
6.042 text\footnote{First rank for some reason was an early version
  ...
  Courseware site ranked 4th and 5th.} \texttt{:-)} .  So how did
