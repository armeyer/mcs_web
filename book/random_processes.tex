...
in the example above.  Albert starts with a stack of $n$ chips and
Eric starts with a stack of $m = T-n$ chips.  At each bet, Albert wins
...
Pascal's an ingenious idea was to alter the value of the chips to make
...
\begin{cases}
 \frac{n}{T} & \text{ for } p = \frac{1}{2},\\
 \frac{r^n-1}{r^{T} -1} & \text{ for } p \neq \frac{1}{2},
\end{cases}
\end{equation}
where $r \eqdef q/p$.
\end{theorem}
