...
even if a user does not get stuck at a dead end, he will commonly find
himself following some unproductive path and decide to restart.
...
restart from a random place.  The ensures that the graph is strongly
connected.
