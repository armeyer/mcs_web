...
are sometimes called \term{Boolean variables} after their inventor, the
\arm{inserted 19th century} nineteenth century mathematician George---you
guessed it---Boole.
...
\term{truth tables}.  For example, if $P$ denotes an arbitrary
