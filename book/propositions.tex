...
example, the truth table for a proposition involving 10 propositional
variables there are more than a million cases (rows) to check.  \arm{CUT:
  ...
  of cases,} And case checking it is not going to work at all when there
