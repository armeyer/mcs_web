...
%
\begin{center}
\emph{An implication is true exactly when the if-part is false or the
then-part is true.}
\end{center}
%
...
\]
%
Thus, an implication \emph{is} logically equivalent to its
contrapositive but is \emph{not} equivalent to its converse.
