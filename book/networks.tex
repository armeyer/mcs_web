...
\section{Digraphs}\label{digraphs-sec}
...
\begin{definition}
A \term{cycle} in a digraph is a path that begins and ends at the same
vertex.  Note that by convention, a single vertex is considered to be a
cycle of length 0 that begins and ends at the vertex.  A \term{directed
...
aFor example, here is a 2-coloring of the constraint graph:
