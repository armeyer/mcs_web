...
deductions} leading to the proposition from a base set of \index{axiom|see{ZFC axioms}}\emph{axioms}. %|seealso
\end{definition*}
...
\section{References}
 ...
 \cite{MR1818534},    %Cupillari
 \cite{Velleman1994},
 \cite{MR1723092}     %Proofs from The Book
