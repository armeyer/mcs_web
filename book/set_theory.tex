...
and the same methods confirm the countability of a bunch of familiar
sets:
...
\]
\end{corollary}
Problem~\ref{CP_rationals_are_countable} illustrates how the facts listed
...
integer greater than or equal to 3.  But if you add 1 a countably
