...
\hline
\end{array}\]
But now we can exhibit a sequence that's missing from our alleged
complete list of all the sequences.  Let's look at the diagonal in our
sample list:
\[\begin{array}{|rc c c c c c c l|}
\hline
...
\end{array}\]
and then form another sequence by switching the
