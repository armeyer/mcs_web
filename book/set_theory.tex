...
c_0, c_1, \dots, c_n, \dots
\]
of the elements of $C$, possibly with repeats(Problem~\ref{CP_countable_from_surj}):
...
its size, it's obvious that neither will adding any \emph{finite}
number of elements.  Something even stronger is true: you can add a
\emph{countably} infinite number of new elements to an infinite set
and still wind up with just a set of the same size
...
something any finite number of times, it also OK to do it an infinite
