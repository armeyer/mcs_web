...
also countable, because they can be listed in the order,
...
countably infinite.  From that it's a small step to reach the conclusion
that the set, $\rationals^{\ge 0}$, of nonnegative rational numbers is
countable.  This may be a surprise ---after all, the rationals densely
fill up the space between integers, and for any two, there's another inb
between, so it might seem as though you couldn't write them all out in a
list.  Combining these fact in simple ways confirms the countability of a
bunch a familiar sets:
...
\[\integers^+, 
 ...
 \rationals, \set{\text{finite, matrices of rational numbers}}.
\]
\end{corollary}
