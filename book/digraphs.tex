...
\begin{lemma}\label{path_total_lem} In a path-total digraph, for any
  finite, nonempty set of vertices, there is a directed path going
  through exactly these vertices.  In fact, if the digraph is a DAG,
  the directed path is unique.
\end{lemma}
