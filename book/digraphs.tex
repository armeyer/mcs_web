...
4~units of time because there is a length~4 sequence of tasks each of
which must be done before the next.  We must put on our
shirt before our pants, our pants before our belt, and our belt before
our jacket.  Such a sequence of items is known as a \term{chain}.
...
critical path for the getting-dressed partial order.
