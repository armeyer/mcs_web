...
\term{size} is equal to the number of vertices in the set, which is
...
called the \term{blocks}\footnote{We think it would be nicer to call
...
called the \term{depth} of $a$.  In any possible parallel schedule,
