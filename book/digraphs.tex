...
Of course it would take forver to graduate if this direct prerequisite
...
as forbidding positive length cycles.  So, the direct prerequisite
...
\examproblems
\pinput{MQ_partial_order_on_123}
...
\pinput{TP_relation_properties_expressions}
