...
\idx{satisfiable} is called \term{SAT}.  One approach to SAT is to
construct a truth table and check whether or not a $\true$ ever
appears, but as for validity, this approach quickly bogs down for
formulas with many variables because because truth tables grow
\idx{exponentially} with the number of variables.
