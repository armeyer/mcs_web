...
continuous faces.
\begin{figure}[h]
\centering \includegraphics[height=2in]{continuous-faces}
...
\begin{figure}
\centering \includegraphics[height=2in]{continuous-cycles}
...
\begin{figure}[h]
\centering \includegraphics[height=2in]{edge-twice-same-face}
...
\begin{figure}[h]
\centering \includegraphics[height=2in]{dongle-face}
...
\begin{figure}[h]
\centering \includegraphics[height=2.5in]{split-a-face}
...
\]
\begin{figure}[h]
\centering \includegraphics[height=3in]{add-bridge}
...
\begin{figure}%[h]
\centering \includegraphics[height=4in]{vertex-merge-arrows.pdf}
...
%\mfigure{!}{1.25in}{polyhedra-blowup.pdf}
\begin{center}
