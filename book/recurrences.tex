...
\arm{This paragraph revised 4/15/10 to mention gen func Chapter}
...
\arm{REDUNDANT:
The general divide-and-conquer recurrence~\eqref{dandc_genl_eq} is
\begin{equation*}
...
2 \cdot (1/2)^p = 1\, .
\]
So $p = 1$ does the job.  \arm{Next, since in this case $g(u) = u-1$,}
