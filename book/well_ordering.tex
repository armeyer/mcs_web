...
sets of real numbers according to this more general form of WOP.  For
example:
\begin{lemma}\label{finite-WOP}
Every nonempty finite set of real numbers is well ordered.
\end{lemma}

Lemma~\ref{finite-WOP} is one of those observations that are so
obvious that it becomes a puzzle how to prove it.  What even more
...
Besides finite sets, there are lots of infinite sets of real number
that are well orderd.  A simple example would be the set $r\nngint$ of
numbers of the form $rn$, where $r$ is a positive real number and $n
\in \nngint$.  (Why does this work?)
...
%Another similar corollary confirms the existence of \emph{maximum} elements:
