...
it turns out that not all infinite sets are the same size---some are
...
computation.  And a well-educated computer scientist will be
...
\pinput{CP_smallest_number_described}
