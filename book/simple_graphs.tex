...
<x-color><param>LightGray</param>\term</x-color>{complete graph} on <x-color><param>burlywood</param>$n$</x-color> vertices, also called <x-color><param>LightGray</param>\term</x-color>{<x-color><param>burlywood</param>$K_</x-color><x-display><param>(raise -0.3)</param><x-color><param>burlywood</param>n</x-color></x-display><x-color><param>burlywood</param>$</x-color>}, has an edge
between every two vertices.  Here is <x-color><param>burlywood</param>$K_</x-color><x-display><param>(raise -0.3)</param><x-color><param>burlywood</param>5</x-color></x-display><x-color><param>burlywood</param>$</x-color>:
...
<x-color><param>LightGray</param><x-color><param>Cyan1</param>\begin</x-color></x-color><x-color><param>LightSkyBlue</param>{definition}</x-color>
  For <x-color><param>burlywood</param>$n </x-color><x-color><param>burlywood</param><x-color><param>LightGray</param>\ge</x-color></x-color><x-color><param>burlywood</param> 3$</x-color>, let <x-color><param>LightGray</param>\term</x-color>{<x-color><param>burlywood</param>$C_</x-color><x-display><param>(raise -0.3)</param><x-color><param>burlywood</param>n</x-color></x-display><x-color><param>burlywood</param>$</x-color>} be the graph with vertices <x-color><param>burlywood</param>$1,</x-color><x-color><param>burlywood</param><x-color><param>LightGray</param>\dots</x-color></x-color><x-color><param>burlywood</param>, n$</x-color>
  and edges
<x-color><param>burlywood</param>\[
