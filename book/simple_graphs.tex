...
\begin{problems}
\classproblems
\pinput{CP_Mark_a_spanning_tree}
...
we show in Section~\ref{bipartitesec}.  Later in Chapter~\ref{planarsec},
we'll develop enough planar graph theory to present an easy proof that
