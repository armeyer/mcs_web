...
<x-color><param>LightGray</param><x-color><param>Cyan1</param>\begin</x-color></x-color><x-color><param>LightSkyBlue</param>{align*}</x-color><x-color><param>burlywood</param>
V <x-color><param>red</param>&</x-color> =  <x-color><param>LightGray</param>\set</x-color>{A, B, C, D, E, F, G, H, I} <x-color><param>red</param>\\</x-color>
E <x-color><param>red</param>&</x-color> =  <x-color><param>LightGray</param>\set</x-color>{ <x-color><param>LightGray</param>\set</x-color>{A, B}, <x-color><param>LightGray</param>\set</x-color>{A, C}, <x-color><param>LightGray</param>\set</x-color>{B, D}, <x-color><param>LightGray</param>\set</x-color>{C, D},
...
</x-color><x-color><param>LightGray</param><x-color><param>Cyan1</param>\end</x-color></x-color><x-color><param>LightSkyBlue</param>{align*}</x-color>          
It will be helpful to use the notation <x-color><param>burlywood</param>$<x-color><param>LightGray</param>\edge</x-color>{A}{B}$</x-color> for the edge
<x-color><param>burlywood</param>$<x-color><param>LightGray</param>\set</x-color>{A,B}$</x-color>.  Note that <x-color><param>burlywood</param>$<x-color><param>LightGray</param>\edge</x-color>{A}{B}$</x-color> and <x-color><param>burlywood</param>$<x-color><param>LightGray</param>\edge</x-color>{B}{A}$</x-color> are different
...
adjacent to <x-color><param>burlywood</param>$D$</x-color>, and the edge <x-color><param>burlywood</param>$<x-color><param>LightGray</param>\edge</x-color>{A}{C}$</x-color> is incident to vertices <x-color><param>burlywood</param>$A$</x-color>
...
%<x-color><param>chocolate1</param>A 1994 University of Chicago study entitled <x-color><param>LightGray</param>\emph</x-color>{The Social
...
<x-color><param>burlywood</param>$<x-color><param>LightGray</param>\card</x-color>{V} <x-color><param>LightGray</param>\approx</x-color> 300M$</x-color>!  Of these, approximately 50.8\% are female and
49.2\% are male, so <x-color><param>burlywood</param>$<x-color><param>LightGray</param>\card</x-color>{M} <x-color><param>LightGray</param>\approx</x-color> 147.6M$</x-color>, and <x-color><param>burlywood</param>$<x-color><param>LightGray</param>\card</x-color>{F} <x-color><param>LightGray</param>\approx</x-color>
...
<x-color><param>LightGray</param>\term</x-color>{complete graph} on <x-color><param>burlywood</param>$n$</x-color> vertices, also called <x-color><param>LightGray</param>\term</x-color>{<x-color><param>burlywood</param>$K_<x-display><param>(raise -0.3)</param>n</x-display>$</x-color>}, has an edge
between every two vertices.  Here is <x-color><param>burlywood</param>$K_<x-display><param>(raise -0.3)</param>5</x-display>$</x-color>:
...
Another 5 vertex graph is <x-color><param>burlywood</param>$L_<x-display><param>(raise -0.3)</param>4</x-display>$</x-color>, the <x-color><param>LightGray</param>\term</x-color>{line graph} of length four:

<x-color><param>LightGray</param>\mfigure</x-color>{!}{1in}{figures/path-graph.pdf}

And here is <x-color><param>burlywood</param>$C_<x-display><param>(raise -0.3)</param>5</x-display>$</x-color>, a <x-color><param>LightGray</param>\term</x-color>{simple cycle} with 5 vertices:
...
But one graph has vertex set <x-color><param>burlywood</param>$<x-color><param>LightGray</param>\set</x-color>{A, B, C, D}$</x-color> while the
...
<x-color><param>LightGray</param><x-color><param>Cyan1</param>\begin</x-color></x-color><x-color><param>LightSkyBlue</param>{definition}</x-color>
  If <x-color><param>burlywood</param>$G_<x-display><param>(raise -0.3)</param>1</x-display>$</x-color> is a graph with vertices, <x-color><param>burlywood</param>$V_<x-display><param>(raise -0.3)</param>1</x-display>$</x-color>, and edges, <x-color><param>burlywood</param>$E_<x-display><param>(raise -0.3)</param>1</x-display>$</x-color>, and likewise
  for <x-color><param>burlywood</param>$G_<x-display><param>(raise -0.3)</param>2</x-display>$</x-color>, then <x-color><param>burlywood</param>$G_<x-display><param>(raise -0.3)</param>1</x-display>$</x-color> is <x-color><param>LightGray</param>\term</x-color>{isomorphic} to <x-color><param>burlywood</param>$G_<x-display><param>(raise -0.3)</param>2</x-display>$</x-color> iff there exists a
  <x-color><param>LightGray</param><x-color><param>Cyan1</param>\textbf</x-color></x-color><x-color><param>OliveDrab</param>{bijection}</x-color>, <x-color><param>burlywood</param>$f: V_<x-display><param>(raise -0.3)</param>1</x-display> <x-color><param>LightGray</param>\to</x-color> V_<x-display><param>(raise -0.3)</param>2</x-display>$</x-color>, such that for every pair of
  vertices <x-color><param>burlywood</param>$u, v <x-color><param>LightGray</param>\in</x-color> V_<x-display><param>(raise -0.3)</param>1</x-display>$</x-color>:
<x-color><param>burlywood</param>\[
...
\]</x-color>
The function <x-color><param>burlywood</param>$f$</x-color> is called an <x-color><param>LightGray</param>\term</x-color>{isomorphism} between <x-color><param>burlywood</param>$G_<x-display><param>(raise -0.3)</param>1</x-display>$</x-color> and
<x-color><param>burlywood</param>$G_<x-display><param>(raise -0.3)</param>2</x-display>$</x-color>.
<x-color><param>LightGray</param><x-color><param>Cyan1</param>\end</x-color></x-color><x-color><param>LightSkyBlue</param>{definition}</x-color>
...
<x-color><param>LightGray</param>\pinput</x-color>{CP_Handshaking_Lemma}
...
<x-color><param>LightGray</param><x-color><param>Cyan1</param>\begin</x-color></x-color><x-color><param>LightSkyBlue</param>{definition}</x-color>
A <x-color><param>LightGray</param>\term</x-color>{path} in a graph, <x-color><param>burlywood</param>$G$</x-color>, is a sequence of <x-color><param>burlywood</param>$k <x-color><param>LightGray</param>\geq</x-color> 0$</x-color> vertices
<x-color><param>burlywood</param>\[
...
\]</x-color>
such that <x-color><param>burlywood</param>$<x-color><param>LightGray</param>\edge</x-color>{v_<x-display><param>(raise -0.3)</param>i</x-display>}{v_<x-display><param>(raise -0.3)</param>{i+1}</x-display>}$</x-color> is an edge of <x-color><param>burlywood</param>$G$</x-color> for all <x-color><param>burlywood</param>$i$</x-color> where <x-color><param>burlywood</param>$0
<x-color><param>LightGray</param>\leq</x-color> i << k$</x-color> .  The path is said to <x-color><param>LightGray</param><x-color><param>Cyan1</param>\index</x-color></x-color><x-color><param>Aquamarine</param>{start of path}</x-color><x-color><param>LightGray</param><x-color><param>Cyan1</param>\emph</x-color></x-color><x-color><param>OliveDrab</param>{start}</x-color> at
<x-color><param>burlywood</param>$v_<x-display><param>(raise -0.3)</param>0</x-display>$</x-color>, to <x-color><param>LightGray</param><x-color><param>Cyan1</param>\index</x-color></x-color><x-color><param>Aquamarine</param>{end of path}</x-color><x-color><param>LightGray</param><x-color><param>Cyan1</param>\emph</x-color></x-color><x-color><param>OliveDrab</param>{end}</x-color> at <x-color><param>burlywood</param>$v_<x-display><param>(raise -0.3)</param>k</x-display>$</x-color>, and <x-color><param>LightGray</param><x-color><param>Cyan1</param>\index</x-color></x-color><x-color><param>Aquamarine</param>{length of
...
<x-color><param>burlywood</param>$<x-color><param>LightGray</param>\edge</x-color>{u}{v}$</x-color>, is <x-color><param>LightGray</param>\term</x-color>{traversed} <x-color><param>burlywood</param>$n$</x-color> times by the path if there are <x-color><param>burlywood</param>$n$</x-color>
different values of <x-color><param>burlywood</param>$i$</x-color> such that <x-color><param>burlywood</param>$<x-color><param>LightGray</param>\edge</x-color>{v_<x-display><param>(raise -0.3)</param>i</x-display>}{v_<x-display><param>(raise -0.3)</param>{i+1}</x-display>} = <x-color><param>LightGray</param>\edge</x-color>{u}{v}$</x-color>.
The path is <x-color><param>LightGray</param>\term</x-color>{simple}<x-color><param>LightGray</param><x-color><param>Cyan1</param>\footnote</x-color></x-color><x-color><param>Aquamarine</param>{Heads up: what we call <x-color><param>LightSalmon</param>``paths''</x-color> are
  ...
  walks''</x-color> and just <x-color><param>LightSalmon</param>``cycles''</x-color>.}</x-color>  iff all the <x-color><param>burlywood</param>$v_<x-display><param>(raise -0.3)</param>i</x-display>$</x-color>'s are different, that
is, <x-color><param>burlywood</param>$v_<x-display><param>(raise -0.3)</param>i</x-display> = v_<x-display><param>(raise -0.3)</param>j</x-display>$</x-color> only if <x-color><param>burlywood</param>$i=j$</x-color>.
...
<x-color><param>LightGray</param><x-color><param>Cyan1</param>\begin</x-color></x-color><x-color><param>LightSkyBlue</param>{definition}</x-color>
  For <x-color><param>burlywood</param>$n <x-color><param>LightGray</param>\ge</x-color> 3$</x-color>, let <x-color><param>LightGray</param>\term</x-color>{<x-color><param>burlywood</param>$C_<x-display><param>(raise -0.3)</param>n</x-display>$</x-color>} be the graph with vertices <x-color><param>burlywood</param>$1,<x-color><param>LightGray</param>\dots</x-color>, n$</x-color>
  and edges
<x-color><param>burlywood</param>\[
...
\]</x-color>
graph is a <x-color><param>LightGray</param>\term</x-color>{simple cycle} of length <x-color><param>burlywood</param>$n$</x-color> iff it is isomorphic to <x-color><param>burlywood</param>$C_<x-display><param>(raise -0.3)</param>n</x-display>$</x-color>
for some <x-color><param>burlywood</param>$n <x-color><param>LightGray</param>\ge</x-color> 3$</x-color>.  A <x-color><param>LightGray</param>\term</x-color>{simple cycle of a graph}, <x-color><param>burlywood</param>$G$</x-color>, is a subgraph
...
% <x-color><param>chocolate1</param><x-color><param>LightGray</param>\centerline</x-color>{<x-color><param>LightGray</param>\psfig</x-color>{figure=figures/3comp.eps,height=1.5in}}
...
<x-color><param>burlywood</param>$K_<x-display><param>(raise -0.3)</param>n</x-display>$</x-color>, is <x-color><param>burlywood</param>$(n-1)$</x-color>-edge connected.
...
\]</x-color>
from <x-color><param>burlywood</param>$u = v_<x-display><param>(raise -0.3)</param>0</x-display>$</x-color> to <x-color><param>burlywood</param>$v = v_<x-display><param>(raise -0.3)</param>k</x-display>$</x-color> where <x-color><param>burlywood</param>$k <x-color><param>LightGray</param>\geq</x-color> 2$</x-color>.  We claim this path must be
simple.
...
integers <x-color><param>burlywood</param>$i,j$</x-color> such that <x-color><param>burlywood</param>$0 <x-color><param>LightGray</param>\leq</x-color> i << j <x-color><param>LightGray</param>\leq</x-color> k$</x-color> with <x-color><param>burlywood</param>$v_<x-display><param>(raise -0.3)</param>i</x-display>= v_<x-display><param>(raise -0.3)</param>j</x-display>$</x-color>.  Then
...
<x-color><param>LightGray</param><x-color><param>Cyan1</param>\item</x-color></x-color> An additional edge <x-color><param>burlywood</param>$<x-color><param>LightGray</param>\edge</x-color>{u}{v}$</x-color> together with the unique path
between <x-color><param>burlywood</param>$u$</x-color> and <x-color><param>burlywood</param>$v$</x-color> forms a simple cycle.

<x-color><param>LightGray</param><x-color><param>Cyan1</param>\item</x-color></x-color> Suppose that we remove edge <x-color><param>burlywood</param>$<x-color><param>LightGray</param>\edge</x-color>{u}{v}$</x-color>.  Since a tree
...
<x-color><param>burlywood</param>$<x-color><param>LightGray</param>\edge</x-color>{u}{v}$</x-color>.  Therefore, when that edge is removed, no path remains,
and so the graph is not connected.

<x-color><param>LightGray</param><x-color><param>Cyan1</param>\item</x-color></x-color> Let <x-color><param>burlywood</param>$v_<x-display><param>(raise -0.3)</param>1</x-display>, <x-color><param>LightGray</param>\dots</x-color>, v_<x-display><param>(raise -0.3)</param>m</x-display>$</x-color> be the sequence of vertices on a longest
...
\]</x-color>
Suppose that we remove the last edge, <x-color><param>burlywood</param>$<x-color><param>LightGray</param>\edge</x-color>{v_<x-display><param>(raise -0.3)</param>n</x-display>}{v_<x-display><param>(raise -0.3)</param>0</x-display>}$</x-color>.  If a pair of
...
<x-color><param>burlywood</param>$<x-color><param>LightGray</param>\edge</x-color>{v_<x-display><param>(raise -0.3)</param>n</x-display>}{v_<x-display><param>(raise -0.3)</param>0</x-display>}$</x-color>, then they remain joined by that path.  On the other
hand, if <x-color><param>burlywood</param>$x$</x-color> and <x-color><param>burlywood</param>$y$</x-color> were joined by a path containing <x-color><param>burlywood</param>$<x-color><param>LightGray</param>\edge</x-color>{v_<x-display><param>(raise -0.3)</param>n</x-display>}{v_<x-display><param>(raise -0.3)</param>0</x-display>}$</x-color>,
...
<x-color><param>burlywood</param>$<x-color><param>LightGray</param>\edge</x-color>{u}{v}$</x-color> be an edge in a rooted tree such that <x-color><param>burlywood</param>$u$</x-color> is closer to
...
<x-color><param>burlywood</param>$W$</x-color>.  Call this edge <x-color><param>burlywood</param>$<x-color><param>LightGray</param>\edge</x-color>{u}{v_<x-display><param>(raise -0.3)</param>i</x-display>}$</x-color>.  But then we can construct a
longer walk:
%<x-color><param>chocolate1</param>
</x-color><x-color><param>burlywood</param>\[
...
the <x-color><param>LightGray</param>\term</x-color>{chromatic number}, <x-color><param>burlywood</param>$<x-color><param>LightGray</param>\chi</x-color>(G)$</x-color>, of <x-color><param>burlywood</param>$G$</x-color>.
...
complete graph, <x-color><param>burlywood</param>$K_<x-display><param>(raise -0.3)</param>{n}</x-display>$</x-color>, every one of its <x-color><param>burlywood</param>$n$</x-color> vertices is adjacent to all
...
colors is also enough, so <x-color><param>burlywood</param>$<x-color><param>LightGray</param>\chi</x-color>(K_<x-display><param>(raise -0.3)</param>n</x-display>)=n$</x-color>.  So <x-color><param>burlywood</param>$K_<x-display><param>(raise -0.3)</param>{k+1}</x-display>$</x-color> is an example where
...
<x-color><param>LightGray</param><x-color><param>Cyan1</param>\emph</x-color></x-color><x-color><param>OliveDrab</param>{any}</x-color> graph with degree bounded by <x-color><param>burlywood</param>$k$</x-color> that has <x-color><param>burlywood</param>$K_<x-display><param>(raise -0.3)</param>{k+1}</x-display>$</x-color> as a
subgraph.
...
complete graph</x-color>} <x-color><param>burlywood</param>$K_<x-display><param>(raise -0.3)</param>n</x-display>$</x-color> or a {<x-color><param>LightGray</param><x-color><param>Cyan1</param>\em</x-color></x-color><x-color><param>OliveDrab</param> clique</x-color>}, just like a clique of friends,
...
%<x-color><param>chocolate1</param><x-color><param>LightGray</param>\startclassproblems</x-color>
</x-color>%<x-color><param>chocolate1</param><x-color><param>LightGray</param>\pinput</x-color>{CP_}
...
%<x-color><param>chocolate1</param><x-color><param>LightGray</param>\pinput</x-color>{PS_simple_triangle_free_graph_coloring}
</x-color>
<x-color><param>LightGray</param><x-color><param>Cyan1</param>\end</x-color></x-color><x-color><param>LightSkyBlue</param>{problems}</x-color>
...
<x-color><param>LightGray</param>\centerline</x-color>{{<x-color><param>LightGray</param><x-color><param>Cyan1</param>\em</x-color></x-color><x-color><param>OliveDrab</param> Every subset of girls likes at least as large a set of boys.</x-color>}}
<x-color><param>LightGray</param>\bigskip</x-color>
...
matching exists.  We use strong induction on <x-color><param>burlywood</param>$<x-color><param>LightGray</param>\card</x-color>{G}$</x-color>, the number of
girls.  If <x-color><param>burlywood</param>$<x-color><param>LightGray</param>\card</x-color>{G} = 1$</x-color>, then the matching condition implies that the
lone girl likes at least one boy, and so a matching exists.  Now suppose
that <x-color><param>burlywood</param>$<x-color><param>LightGray</param>\card</x-color>{G} <x-color><param>LightGray</param>\geq</x-color> 2$</x-color>.  There are two possibilities:
...
% <x-color><param>chocolate1</param>A <x-color><param>LightGray</param>\emph</x-color>{matching} in a graph is an injection on the set of vertices
...
<x-color><param>LightGray</param>\term</x-color>{degree-constrained} if <x-color><param>burlywood</param>$<x-color><param>LightGray</param>\degr</x-color>{l} <x-color><param>LightGray</param>\geq</x-color> <x-color><param>LightGray</param>\degr</x-color>{r}$</x-color> for every <x-color><param>burlywood</param>$l <x-color><param>LightGray</param>\in</x-color> L$</x-color>
and <x-color><param>burlywood</param>$r <x-color><param>LightGray</param>\in</x-color> R$</x-color>.
<x-color><param>LightGray</param><x-color><param>Cyan1</param>\end</x-color></x-color><x-color><param>LightSkyBlue</param>{definition}</x-color>}
...
</x-color>%<x-color><param>chocolate1</param><x-color><param>LightGray</param>\TBA</x-color>{Add conclusion here...}
</x-color>
