...
multiple women married to one man, a scenario we consider in the
problem section at the end of the chapter.).  Before the Ritual-like
algorithm was adopted, there were chronic disruptions and awkward
...
1989.\footnote{Much more about the Stable Marriage Problem can be
  ...
  \href{http://mitpress.mit.edu/catalog/item/default.asp?ttype=2&tid=7676}
       {\cite{Gusfield1989}}.}
For this and related work, Shapley was awarded the 2012 Nobel prize in
Economics.
...
vertex.  A single vertex counts as a length closed walk as well as a
length zero path.
