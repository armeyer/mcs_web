...
annunities.  Figuring out the value of the annuity will involve a
...
magntitude of a sum or product.
...
A key question is, ``What is an annunity worth?''  For example,
...
\subsection{Variations of Geometry Sums}
...
formula:\dmj{This seems a bit terse.  I knew what you where you were
  going and I still had to stare at the equations to figure out how
...
\section{\idx{Book Stacking}}\label{book_stacking_sec}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=.40\textwidth]{bookstack-3}}
...
\begin{figure}
\centerline{\includegraphics[width=.4\textwidth]{bookstack-2}}
%\centerline{\psfig{file=bookstack-2.ps,width=.4\textwidth}}
...
\begin{figure}
\centerline{\includegraphics[width=.80\textwidth]{bookstack-5}}
%\centerline{\psfig{file=bookstack-5.ps,width=.80\textwidth}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[height=1.5in]{optstack}}
\caption{Stack of four books with maximum overhang.}
\label{fig:optstack}
\end{figure}

\subsection{Evaluating the Sum---The \idx{Integral Method}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[height=2.0in]{integral}}
...
\begin{figure}[htbp]
\centerline{%
%\psfig{figure=integral2.eps,height=2in}
\includegraphics[height=2in]{integral2}
}
\caption{This figure illustrates the Integral Method for bounding
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=6in]{asymp}
\end{center}
