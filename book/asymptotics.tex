...
to explain a way that you could use to figure it out for yourself
called the \term{Perturbation Method}.
...
second and third responses---is ``No block will ever get completely
past the edge of the table.''  But in fact, if $n$~is large enough,
you can get the top block to stick out as far as you want: one
...
1$~blocks.  In other words, the center of mass of~$S$ is~$1/2n$ to the
left of the center of mass of the top $n - 1$~blocks.  (The difference
is due to the effect of the bottom block, whose center of mass is
$1/2$ unit to the left of~$C$.)  This means that the spread
