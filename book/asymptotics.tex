...
\gnote{Geoff: Make weights of $x$- and $y$-axes consistent with
  Fig~\ref{fig:9G9}.}
...
\gnote{Geoff: Make weights of2 $x$- and $y$-axes consistent with
  Fig~\ref{fig:9G9}.}
...
\gnote{Geoff: Can you squeeze another half inch out of the vertical
  height?}
...
\gnote{Geoff: Top label: break between ``mass'' and ``of'' instead of
  after ``of''.}
