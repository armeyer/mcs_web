...
On the other hand, it's a routine exercise
(Problem~\ref{PS_st_peterburg_bounded}) to verify that, if you have
only a finite amount of money when you start following the bet
doubling strategy, then your expected win comes out sensibly: it will
be negative when the wheel is biased against you and will be zero
against a fair wheel.
...
\pinput{PS_st_peterburg_bounded}
\pinput{PS_st_peterburg}
