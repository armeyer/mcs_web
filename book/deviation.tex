...
the expected value of the square.  \dmj{What do the highlighted
  ``it''s refer to?  Proximity suggests ``the expected value of the
  square'', but then the two sentences become vacuous because that's
  the definition of variance.  Presumably ``it'' is supposed to be the
  square itself?}If \highlight{it} is likely to be large, then the
variance will be large.  If \highlight{it} is likely to be small, then
