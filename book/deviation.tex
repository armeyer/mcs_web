...
\end{equation}
Linearity of expecation make it easy to calculate the expected number of
...
%% \pinput{FP_chebyshev_pq}  %%after S16 final
%% FP_flirt_dependence_deviation  %%after S16 final
