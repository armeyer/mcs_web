...
%
  \dmj{I initially read the highlighted ``it'' as referring to the
    ``expected value of the square'', not just the ``square''.  Maybe
    change that ``it'' to ``the square'' to make it clearer?}
%
If \highlight{it} is likely to be large, then the variance will be
