...
professor even though he never got a Ph.D.  (He had beenadmitted to a
...
\section{Partial Correctness \& Termination}
...
Suppose we have a population of men and women where each person has
preferences of the opposite-gender person they would like to marry:
each man has preference list of all the women, and each woman has a
preference list of all of the men.
