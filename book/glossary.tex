...
$\abs{r}$      & the absolute value of a real number $r$
\end{tabular}
\end{center}
...
$m \divides n$ & integer $m$ divides $n$; $m$ is a factor of $n$; $\exists k \in \integers.\, km=n$\\
$\gcd$         & greatest common divisor\\
$\log$         & the base 2 logarithm, $log_2$\\
$\ln$          & the natural logarithm, $log_e$\\
$\lcm$         & least common multiple\\
$\Zintv{k}{n}$ & $\set{i \suchthat k \leq i \leq n}$\\
$\Zintvoc{k}{n}$ & $\Zintv{k}{n} - \set{k}$\\
$\Zintvco{k}{n}$ & $\Zintv{k}{n} - \set{n}$\\
$\Zintvoo{k}{n}$ & $\Zintv{k}{n} - \set{k,n}$\\
