...
\emph{The Fibonacci numbers.}  Fibonacci numbers arose out of an effort 800
...
a\emph{Sum-notation.}\label{sum-notation-def}  Let ``$S(n)$'' abbreviate the expression
...
and recursive computation.  This makes it a technique every computer
