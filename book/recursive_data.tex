...
illustration of how to give simple recursive definitions for a basic
data type and functions on the data, along with proofs of correctness
...
\end{proof}
\end{corollary}
\footnote{The inequality~\eqref{Tleq1LR} is actually an equality,
  see~\eqref{sT1sl} below.}
