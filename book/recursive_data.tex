...
basic functions on trees recursively.  For example, the \term{size}
\index{tree size} of a tree is the number of subtrees it has:
...
A $T \in \rectr$ is a \term{balanced tree} when all the paths that end at
