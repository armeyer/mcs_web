\hyperdef{recursive}{data}{\chapter{Recursive Data Types}}\label{recursive-data-chapter}
%\coursecopyright
...
formulas.  The first rule captures the fact that strengthening the
preconditions and weakening the postconditions makes a specification
easier to satisfy:
