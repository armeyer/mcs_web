...
\newcommand{\avlnsrt}[1]{\text{insert}#1}
...
of size of the set of values.  Namely, define a tree to be \term{fully
...
trees.  This means the depth of the left and right branches of any
...
\end{equation}
where $\phi$ is the ``golden ration'' $(1+\sqrt{5})/2 \geq 1.6$.
