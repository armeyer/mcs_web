...
\textbf{Constructor case}: Suppose $s \eqdef \ang{a,r}$ and assume the induction hypothesis, $P(r)$.  We must show that $P(s)$ holds:
\begin{align*}
\lnth{s \cdot t}
    & = \lnth{\ang{a, r} \cdot t}\\
    & = \lnth{\ang{a,r \cdot t}}
...
\textbf{Constructor case}: By structural induction hypothesis, we assume
