...
functions on the data, along with proofs of correctness by structural
induction.
...
branches of all the subtrees (Problem~\bref{PS_update_balanced}), an
...
\begin{editingnotes}
CP verify rotate2 above
PS Verify another rotation case
\end{editingnotes}

\homeworkproblems
\pinput{PS_shared_leaves}
\pinput{PS_update_balanced}
