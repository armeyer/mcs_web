...
O_{\ang{2}} \eqdef \set{\nimg{\emptystring}, \nimg{1}}.
\]
This gives the second player a winning move to $\nimg{\emptystring}
...
disappeared leaving only a set of sets of sets\dots.  For example, the
full expansion of $\nimg{3,2}$ is
\begin{align*}
\left\{ \right. & \\
...
\]
\[
\dpth{\avlrot{(B,r,S)}} = \dpth{S}\ \text{or}\ \dpth{S} + 1,
\]
