...
\begin{definition}\label{recstring_def}
  Let $A$ be a nonempty set called an \emph{alphabet}, whose elements are
  referred to as \emph{characters}, \emph{letters}, or \emph{symbols}.
...
\pinput{CP_structural_induction_rational_composition}
    %subsumes FP_structural_induction_lF18_composition

%%%%\pinput{FP_binary_tree_induction}  %insert after F15 final

%%%%%\pinput{CP_recursive_binary_trees}  %%Good problem, Needs work.
\end{problems}
