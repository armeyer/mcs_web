...
We study random variables and their probability distributions in the
following Chapter. %~\ref{ran_var_chap}.
...
it is likely to rain.  The fundamental concept of the \term{expected
  value} of a random variable is introduced and some of its key
properties are developed.

After that, %In Chapter~\ref{chap:deviations},
...
% in Chapter~\ref{ran_process_chap} by combining the tools we have acquired
