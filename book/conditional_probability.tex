...
Nown suppose that we are testing middle-aged women with no family
...
These are all important questions, but it is important to understand
that they are \emph{not mathematical questions}.  Rather, these are
questions about statistical judgements and the philosophical meaning
of probability which probability theory itself does not address.
\begin{editingnotes}
...
data showing women more likely to be admitted, that gender bias
against women was \emph{not} an issue in the university.
...
admission.\footnote{These issues are thoughtfully examined in
  ...
  Cambridge U. Press, 2001.}  This illustrates a basic principle in
statistics which people constantly ignore: \emph{never assume that
...
has occurred.  This is equivalent to saying that the chances of any
combination of those events equals the product of the probabilities of
those events.
