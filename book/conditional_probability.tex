...
\end{editingnotes}. But the real
point we wanted to make is that conditional probability is used and
misused all the time, and even experts subject to widespread scrutiny
can make mistakes.  }
...
\[
\pr{A} = \condpr{A}{E_1} \cdot \pr{E_1} + \condpr{A}{E_2} \cdot \pr{E_2} + \condpr{A}{E_3} \cdot \pr{E_3}
\]
