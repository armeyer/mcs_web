...
\dmj{Need to have another go at formatting this.}
...
The probability rules that we derived in Chapter~\ref{probability}
...
\begin{align*}
\prcond{A \union B}{C}
    &= \frac{\pr{(A \union B) \intersect C}}{\pr{C}} \\
    &= \frac{\pr{(A \intersect C) \union (A \intersect C)}}{\pr{C}} \\
...
of the following equations must hold:\footnote{There is an equivalent
  definition based on conditional probabilities, as in
...
learned how to do in Chapter~\ref{counting_intro}.  In fact, from
