...
%%%% Insert transition sentence to True props needed.  Insert Fermat
%%%% last conjecture.
...
This proposition is true and is known as the ``\term{Four Color
  Theorem}.''  However, several incorrect proofs have been published,
including one that stood for 10 years in the late 19th century before
the mistake was found.  A laborious proof was finally found in 1976 by
...
computer calculated correctly, nor did anyone have the energy to
recheck the four-colorings of thousands of maps that were done by
hand.  Two decades later a mostly
...
maps.\footnote{The story of the proof of the Four Color Theorem is told in
  a well-reviewed popular (non-technical) book: ``Four Colors Suffice.
  How the Map Problem was Solved.'' \emph{Robin Wilson}.  Princeton
...
just a handful of axioms, called the axioms \idx{Zermelo-Frankel} with
...
\false fact can't be true, the proposition \begin{editingnotes}must not be false.  That
is, the proposition really\end{editingnotes} must be true. 
