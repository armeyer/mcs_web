...
\begin{definition*}
  A \term{proposition} is a statement (communiucation) that is either
  true or false.
\end{definition*}
...
But if you know, for example, that $n$ equals 4, the predicate becomes
the true proposition "4 is a perfect square".  Remember, nothing says
that the proposition has to be true: if the value of $n$ is 5, you
...
just a handful of axioms, called the \idx{Zermelo-Fraenkel} with
Choice axioms (\term{ZFC}), together with a few logical deduction
