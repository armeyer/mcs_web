...
The symbol ``$\in$'' is read as ``is a member of,'' or
...
In a book he was reading around 1630, \idx{Fermat} claimed to have a proof
...
Throughout the text there are also examples of \emph{bogus proofs}
