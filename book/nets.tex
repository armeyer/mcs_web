...
length, namely, $2(n+1)-1$, and the diameter of the Bene\v{s} net with
$2^{n+1}$ inputs is this length plus two because of the two edges
...
So Bene\v{s} has doubled the number of switches and the diameter, of
...
a moment.  Let's first see how the Bene\v{s} network stacks up:
%
\[
\begin{array}{r|c|c|c|c}
\textbf{network} &
