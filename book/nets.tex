...
because the logarithm function grows very slowly.  We could connect up
$2^{10} = 1024$ inputs and outputs using a complete binary tree and
the worst input-output delay for any packet would be $2 \log(2^{10}) +
2 = 22$.
...
In the 1960's, a researcher at Bell Labs named Bene\v{s} had a
...
amounts to recursively growing \term{Bene\v{s} nets} by adding both inputs
...
\]
%
The Bene\v{s} network has small size and diameter, and completely
