...
\index{communication net|seealso{routing problem}} 
...
Let's start with a \index{communication net!complete binary tree|textbf}\emph{complete 
...
\term{routing problem}: get a packet that starts at input $i$ to output
...
\index{routing problem!congestion} 
...
\index{communication net!2-dimensional array|textbf} 
or \emph{grid}.
...
\index{communication net!butterfly|textbf} 
is a widely-used compromise between the two.  \iffalse
