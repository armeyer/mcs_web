...
\newcommand{\rslt}[2]{\text{result}_{#1}#2}
...
So we finall arrive at \fintr, the familiar trees that underlie search trees.
\begin{definition}
\[
...
argument following Theorem~\ref\label{szT2d1}.
