...
\newcommand{\lr}{l_{\tiny{\mbox{right}}}}
\renewcommand{\ll}{l_{\tiny{\mbox{left}}}}
...
\emph{We should allow for them to just show the direct, drawn solution, the previous solution is very pedantic.}
true, but it was also written terribly.  I'm going to try to rewrite it better.

% this is just a very human unfriendly way of describing the solution.
% shouldn't we add a picture instead.  The inducton way of proving the picture is right is also
% not worth it, perhaps here we should accept a proof by picture
...
\end{center}
%\centerline{\resizebox{!}{2.0in}{\includegraphics{adjgraph}}}
}
