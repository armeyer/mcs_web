...
\examspace
  \pinput[points = 6, title = \textbf{Bipartite Average}]{FP_bipartite_matching_sex}

\examspace
  \pinput[points = 8, title = \textbf{Graphs, Congruences}]{FP_multiple_choice}

\examspace
  \pinput[points = 8, title= \textbf{State Machine}]{FP_santa_state_machine}
...
\examspace
  \pinput[points = 8, title= \textbf{Markov, Chebyshev Bounds}]{FP_gambling_man}
