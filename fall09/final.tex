...
\pinput[points = 7, title = \textbf{Graph Coloring
  Induction}]{FP_coloring_false-proof}

%\examspace
%  \pinput[points = 10, title= \textbf{Logic formulas, Counting }]{FP_lining_up}

\examspace
\pinput[points = 6, title= \textbf{Structural
  Induction}]{FP_structural_induction_arithmetic_expressions}

\examspace
  \pinput[points = 4, title = \textbf{Bipartite Average}]{FP_bipartite_matching_sex}

\examspace
  \pinput[points = 7, title = \textbf{Graphs, Congruences}]{FP_multiple_choice}
...
\examspace
  \pinput[points = 4, title= \textbf{Asymptotics}]{FP_asymptotics_define_functions}

\examspace
  \pinput[points = 6, title = \textbf{Conditional Probability}]{FP_conditional_prob_inequality}

\examspace
  \pinput[points = 6, title = \textbf{Probable Satisfiability}]{CP_probable_satisfiability_nk}

\examspace
  \pinput[points = 8, title= \textbf{Probable Congestion}]{FP_network_probability}

\examspace
  \pinput[points = 6, title= \textbf{Convolution}]{FP_boat_trip} 

\examspace
  \pinput[points = 4, title= \textbf{Counting Strings}]{FP_string_counting}

\examspace
  \pinput[points = 3, title= \textbf{Euler's Probability}]{FP_modular_exponential}

%\examspace
%  \pinput[points = 8, title= \textbf{Counting}]{FP_counting_given_answers}  

\examspace
  \pinput[points = 7, title= \textbf{Counting paths; Combinatorial Proof}]{FP_more_counting}  

\examspace
  \pinput[points = 5, title= \textbf{Markov, Chebyshev Bounds}]{FP_gambling_man}

\examspace
  \pinput[points = 4, title= \textbf{Sampling \& Confidence}]{FP_random_sampling}
