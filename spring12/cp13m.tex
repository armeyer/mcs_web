...
\pinput{TP_markov_chebyshev_for_card_games}  % uses linearity of variance, which is next day's reading
%\pinput{CP_pairwise_independent_theorem}  18.5.1 not covered in this day's reading

%\pinput{CP_chebyshev_hat_check}  not ps11 anymore, but also needs reading for next day
