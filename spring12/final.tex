...
\pinput[points = 5, title = \textbf{FP large numbers
...
\begin{editingnotes}F11 Sampling \& Confidence\end{editingnotes}
  ...
  \pinput[points = 5, title= \textbf{random sampling}]{FP_random_sampling}
...
\examspace
\pinput[points = 5, title = \textbf{Counting Permutations}]{FP_permutations_inc_exc}
...
\examspace
\pinput[points = 3, title = \textbf{Countable Set}]{FP_countable_quadratics}

\examspace
\pinput[points = 2, title = \textbf{UnCountable Stationary
