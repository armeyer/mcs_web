...
\pinput[points = 25, title= \textbf{State Machines, Induction, Congruence}]{asg_TP_sub_one_with_two_of_opposite_color}
...
\pinput[points = 10, title= \textbf{Stable Marriage}]{asg_FP_stable_matching_unequal_invariants}
...
\pinput[points = 15, title= \textbf{Recursive Data}]{asg_M2_structural_induction_rational_composition_S13}
...
\pinput[points = 12, title= \textbf{Sets}]{asg_M2_sets}
...
\pinput[points = 15, title= \textbf{GCD}]{asg_M2_GCD_congruence}
...
\pinput[points = 13, title= \textbf{Euler, Congruence}]{asg_M2_Euler_congruence}
