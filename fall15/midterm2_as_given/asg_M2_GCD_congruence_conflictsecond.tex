...
Let
\begin{align*}
    x & \eqdef 6^{15} \cdot 7^{7}  \\
    y & \eqdef 7^{7} \cdot 15^{6}.
\end{align*}
...
\begin{solution}
Let us first rewrite $x$ and $y$ as
\begin{align*}
    x & \eqdef 2^{15} \cdot 3^{15} \cdot 7^{7}  \\
    y & \eqdef 7^{7} \cdot 3^{6} \cdot 5^{6}.
\end{align*}

$\gcd(x,y) = 3^{6}\cdot 7^{7}$.
...
$\lcm(x,y) = 2^{15} \cdot 3^{15} \cdot 5^{6} \cdot 7^{7}$.
