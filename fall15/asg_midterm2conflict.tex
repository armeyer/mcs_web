...
\pinput[points = 25, title= \textbf{State Machines, Induction, Congruence}]{midterm2_as_given/asg_FP_token_state_machine_conflict}%{TP_sub_one_with_two_of_opposite_color-conflict}
