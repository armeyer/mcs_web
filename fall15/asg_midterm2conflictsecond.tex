...
\pinput[points = 25, title= \textbf{State Machines, Induction, Congruence}]{midterm2_as_given/asg_TP_sub_one_with_two_of_opposite_color-conflictsecond}
...
% CONFLICT
\pinput[points = 10, title= \textbf{Stable Marriage}]{midterm2_as_given/asg_TP_Stable_Marriage_Invariants-conflict}
...
\pinput[points = 12, title= \textbf{Sets}]{midterm2_as_given/asg_M2_sets_conflictsecond}
...
\pinput[points = 15, title= \textbf{GCD, Congruence}]{midterm2_as_given/asg_M2_GCD_congruence_conflictsecond}
...
\pinput[points = 13, title= \textbf{Euler, Congruence}]{midterm2_as_given/asg_M2_Euler_congruence_conflictsecond}
