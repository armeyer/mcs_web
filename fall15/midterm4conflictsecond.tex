...
\conflictmidtermsecond{November 24}
...
\pinput[points = 15, title= \textbf{Counting}]{FP_counting_various_f15_ver2}
\examspace
\begin{staffnotes}
...
\pinput[points = 8, title= \textbf{Pigeonhole Principle}]{PS_pigeonhole-diff_k}
\examspace
\begin{staffnotes}
...
\pinput[points = 15, title= \textbf{Counting, Inclusion-Exclusion}]{FP_counting_4_digit_numbers_with_sum_of_digits_22_ver2}
\examspace
\begin{staffnotes}
...
\pinput[points = 10, title= \textbf{Generating Functions}]{FP_linear_recur_squares_f15_ver2}
\examspace
\begin{staffnotes}
...
\pinput[points = 12, title= \textbf{Probability}]{MQ_voldemort_returns_again_ver2}
