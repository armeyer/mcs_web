...
\pinput[points = 25, title= \textbf{State Machines, Induction, Congruence}]{FP_token_state_machine}
...
\pinput[points = 15, title= \textbf{Recursive Data}]{FP_structural_induction_rational_composition}
...
\pinput[points = 15, title= \textbf{GCD}]{MQ_GCD_congruence}
...
\pinput[points = 13, title= \textbf{Euler, Congruence}]{TP_Euler_congruence}
