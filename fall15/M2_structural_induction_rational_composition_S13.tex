...
\begin{pcomments}
  \pcomment{M2_structural_induction_rational_composition_S13}
  \pcomment{same as FP_structural_induction_rational_composition w/o second part}
  \pcomment{ARM 1/31/12, format 10/15/15}
  \pcomment{F15.mid2}
\end{pcomments}
...
\]
prove that $P(h)$ holds for all $h \in \RAF$. 
...
sum/product/quotient -- by the constructor rules.  This proves $P(h)$
for all three of the constructor cases $\textbf{@} = +$, $\cdot$, or
$\div$.
