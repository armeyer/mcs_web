...
\examspace
\begin{editingnotes}
\TBA{USE INTERSECTION part instead of union---uses more interesting
  pairwise independent counterexample}
\end{editingnotes}
...
\examspace
\begin{editingnotes}
\TBA{CH COMPOSE} a Chebyshev bound version of part(b) of
