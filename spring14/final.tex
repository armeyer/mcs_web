...
\pinput[points = 40, title = \textbf{Basics}]{exit-diagnostic-short-S14}

\examspace
\pinput[points = 25, title = \textbf{GCD \&  Invariants}]{FP_binary_gcd}

\examspace
\pinput[points = 20, title = \textbf{Propositional formulas,
  Relations, Partial Orders, Matchings}]{FP_propositional_formulas_matching}

\examspace
\pinput[points = 25, title = \textbf{$\Zmod{n}$}]{FP_Fermat_primes}
...
\examspace
\pinput[points = 25, title = \textbf{Binary sequences}]{FP_infinite_binary_sequences_S14}

\examspace
\pinput[points = 20, title = \textbf{Bijections, Inclusion-Exclusion}]{FP_string_inclusion_exclusion}

\examspace
\pinput[points = 20, title = \textbf{Generating Functions}]{FP_dangerous_dan_gen_func_S14}

\examspace
\pinput[points = 20, title = \textbf{Simple Graphs, Asymptotics}]{FP_simple_graphs_asymptotics}
...
\examspace
\pinput[points = 20, title = \textbf{Conditional Expectation, Theta()}]{FP_infinite_repeat}

\examspace
\pinput[points = 20, title = \textbf{Deviation, Estimation}]{FP_hot_cows_chebyshev}
