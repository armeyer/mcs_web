...
\examspace
\pinput[points = 20, title= \textbf{Degree sequences}]{MQ_degree_sequences}
...
\examspace
\pinput[points = 30, title= \textbf{Coloring \& Induction}]{FP_graph_colorable}
...
%%%%%%%%%sums
\examspace
\pinput[points = 20, title= \textbf{Convergent Series}]{TP_Summation}
