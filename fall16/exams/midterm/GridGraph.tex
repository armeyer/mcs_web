...
\begin{tikzpicture}[thick,scale=0.8]
  ...
  \node [circle, draw, inner sep=2pt, minimum width=2pt] (1) at 	(0,0) {};
  \node [circle, draw, inner sep=2pt, minimum width=2pt] (2) at 	(2,0) {};
  \node [circle, draw, inner sep=2pt, minimum width=2pt] (3) at 	(0,2) {};
  \node [circle, draw, inner sep=2pt, minimum width=2pt] (4) at 	(2,2) {};
  \node [circle, draw, inner sep=2pt, minimum width=2pt] (5) at 	(1, 3) {};
