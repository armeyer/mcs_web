...
\ppart{7}
  For two distinct non-multiple sets of values of PageRank, $d_1$ and $d_2$, let $\gamma$ be defined as 
...
\ppart{5}
    ...
    \solution{
        ...
        \begin{tabular}{r|cccccccc}
            ...
            contrib & $\frac18$ & $\frac1{24}$ & $\frac1{16}$ & $\frac1{16}, \frac1{16}$ & $\frac18, \frac1{16}, \frac1{24}$ & $\frac18, \frac1{16}, \frac1{24}$ & $\frac1{16}$ & $\frac18$ \\[1em]
            iter 1  & $\frac18$ & $\frac1{24}$ & $\frac1{16}$ & $\frac1{8}$ & $\frac{11}{48}$ & $\frac{11}{48}$ & $\frac1{16}$ & $\frac18$ \\[1em]
...
\ppart{10}
    ...
    $u$ to $v$ and one from $v$ to $u$. That is, the strongly connected component is a subgraph of the original graph that is strongly connected and maximal.
...
\ppart{3}
$R_G := $ the set of $(x, y) \in V \times V$ such that $V$ is the set of vertices of an undirected graph $G$, and there is a path $x, v_1, \ldots, v_k, y$ from $x$ to $y$ along the edges of $G$.
