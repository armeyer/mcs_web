...
\ppart{10}  A chain in a poset is called maximal if it cannot be extended (that is no other element of the poset can be added to it).  Let $B_n$ (the Boolean algebra) be the set of subsets of $\{ 1, 2, \ldots n \} $.  How many maximal chains does $B_n$ have?
