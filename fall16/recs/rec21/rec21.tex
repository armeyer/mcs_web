...
\solution[\vspace{1in}]{There are six equally-probable sums: 2, 4, 6, 8, 10, and 12.
...
\solution[\vspace{1in}]{Let the random variables $D_1$ and $D_2$ be the
...
\solution[\vspace{1in}]{We plug the values
