...
%\examspace
\pinput[points = 10, title = \textbf{Induction, GCD}]
       {FP_gcd_linear_combination_induction}

%\examspace
\pinput[points = 10, title = \textbf{Structural Induction, Congruence}]
       {FP_structural_induction_polynomial}


%\examspace
\pinput[points = 20, title = \textbf{Multiple Choice}]
       {FP_multiple_choice_unhidden_fall13}

%\examspace
\pinput[points = 5, title = \textbf{Partial Orders}]
...
%\examspace
\pinput[points = 5, title = \textbf{Combinatorial Proof}]
...
%\examspace
\pinput[points = 8, title = \textbf{Sampling}]
       {TP_sampling_perturbed}

%\examspace
\pinput[points = 5, title = \textbf{Random Walk}]
       {FP_ran3p_graph}
