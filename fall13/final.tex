...
\examspace
\pinput[points = 45, title = \textbf{Basics}]
       {exit-diagnostic-short}
...
\examspace
\pinput[points = 5, title = \textbf{GCD, True/False}]
       {FP_gcd_TF}
...
\examspace
\pinput[points = 5, title = \textbf{Trees, True/False}]
       {FP_trees_TF}
...
\examspace
\pinput[points = 6, title = \textbf{Counting Graphs \& Relations}]
       {PS_counting_graphs}

\examspace
\pinput[points = 8, title = \textbf{Relations and Predicates}]
...
\examspace
\pinput[points = 8, title = \textbf{Combinatorial Proof}]
...
\examspace
\pinput[points = 5, title = \textbf{Random Walk, Stationary Distribution}]
