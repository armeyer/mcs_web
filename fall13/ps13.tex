...
\renewcommand{\reading}{
  Section~\bref{expectation_sec}.\ \emph{Expectation} through ~\bref{finlin}.\ \emph{Linearity of Expectation};\\
  Chapter~\bref{deviation_chap}.\ \emph{Deviation from the Mean} through ~\bref{sec: Confidence_v_Prob}.\ \emph{Confidence versus Probability}.
}
...
\pinput{CP_expected_number_of_keys}			% on draft of ps12
...
\pinput{PS_levitating_LAs}					%used in sp10
