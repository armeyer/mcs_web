...
\examspace
Diagnostic Question 1 is not public

\pinput[points = 40, title = \textbf{Basics}]
       {}

\examspace
\pinput[points = 14, title = \textbf{Induction, GCD}]
       {FP_gcd_linear_combination_induction}

\examspace
\pinput[points = 14, title = \textbf{Structural Induction, Congruence}]
...
\pinput[points = 10, title = \textbf{Partial Orders, Multiple choice}]
       {FP_partial_order_short_answer_f13b}
