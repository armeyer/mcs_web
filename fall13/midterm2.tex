...
\examspace
\pinput[points = 12, title= \textbf{Integral Method}]{TP_integral_sum_asymptotic}

%\examspace
\pinput[points = 13, title= \textbf{MSTs}]{MQ_many_MSTs}

\examspace
\pinput[points = 15, title= \textbf{Partial Order}]{MQ_partial_order_on_12345}

%\examspace
\pinput[points = 15, title= \textbf{Big Oh}]{MQ_asymptotic_incomparable}

%\examspace
%\pinput[points = 20, title= \textbf{Digraph Induction}]{MQ_tournament_chain}
