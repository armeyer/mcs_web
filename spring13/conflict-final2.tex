...
\examspace
\pinput[points = 6, title= \textbf{Expectation}]{FP_expected_adjacent}
...
%elim from S12,final
\examspace
\pinput[points = 8, title = \textbf{Modular Sum}]{CP_Sk_equiv_-1_mod_p}
...
\examspace
%elim from S12,final
\pinput[points = 8, title = \textbf{Logic of Inequalities}]{FP_logic_of_leq}
