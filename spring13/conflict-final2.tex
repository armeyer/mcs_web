...
\pinput[points = 8, title = \textbf{Variance}]{CP_variance_properties_S13}

\examspace
\pinput[points = 8, title =
  \textbf{Modular Sum of Digits}]{FP_check_factor_by_digits_S13}


\examspace
\pinput[points = 12, title= \textbf{Induction}]{FP_3fib}
