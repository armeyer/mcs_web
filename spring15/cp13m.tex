...
\pinput{CP_Until_We_Have_a_Girl}  %too easy for CP (but maybe not w/out multiple choice?)

% Supplemental problem has come to overlap with ps12.  For now, it's commented out.
