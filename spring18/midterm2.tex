...
\pinput[points = 20, title= \textbf{WOP}]{PS_3_exponent_inequality_wop}
\examspace
...
\pinput[points = 20, title= \textbf{Injections}]{FP_inj_expressions} % pretty generic
\examspace
...
% State Machines
\pinput[points = 20, title= \textbf{State Machines}]{MQ_red_blue_machine}
\examspace
...
\pinput[points = 20, title= \textbf{Stable Matching}]{FP_rogue_pair}
\examspace
...
% Recursive data
\pinput[points = 20, title= \textbf{Structural Induction}]{MQ_RM_subs_M}
\examspace
