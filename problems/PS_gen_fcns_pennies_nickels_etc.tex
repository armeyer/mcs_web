...
\end{solution}
  ...
  \begin{solution}The answer is the coefficient to $x^{50}$ of the power series
  for $C$.  (It happens to be 50.)  This could be extracted by taking the
  50th derivative of $C$ or using the partial fraction method to obtain a
  ...
  appropriate for hand calculation.\end{solution}
