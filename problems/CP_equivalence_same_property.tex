...
\ppart Observe (and sketch a proof) that $\equiv_f$ is an \idx{equivalence relation} on
$A$.
...
To prove the left-to-right implication, suppose $f(a) = f(a')$, that
is $R(a)=R(a')$.  Since $R$ is reflexive, $a' \in R(a')$.  So $a' \in
R(a)$.  By definition, this means $a \mrel{R} a'$.
