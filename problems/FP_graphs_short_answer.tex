...
\ppart For the following statements about \textbf{trees}, circle \textbf{true}
...
\item For every finite graph, there is one (a tree) that spans it.
\hfill \textbf{true} \qquad \textbf{false} \examspace[0.8in]

\begin{solution}
false.  needs to connected.
\end{solution}
