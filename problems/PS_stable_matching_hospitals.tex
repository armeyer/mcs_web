...
\begin{pcomments}
  \pcomment{PS_stable_matching_hospitals}
  \pcomment{from: S08.ps4}
  \pcomment{From draft: This problem is \textcolor{green}{not due} with this
    problem set.  It will be included in pset 5.}
\end{pcomments}
...
Briefly indicate what, if any, modifications of the preserved invariant
used to verify the original Mating are needed to verify this one for
...
\begin{editingnotes}
TBA: Comment on Preserved Invariant
\end{editingnotes}
