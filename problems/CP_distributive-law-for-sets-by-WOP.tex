...
\begin{pcomments}
  ...
  \pcomment{revised ARM 3/17/13 to cite problem CP_distribute_union_over_intersection}
\end{pcomments}
...
\begin{problem}
Use the Well-ordering Principle to prove the following extension
of~\eqref{distr} to a Distributive Law for $n \geq 2$ sets:
...
\himt You may assume
(Problem~\bref{CP_distribute_union_over_intersection}) the
distributivity of union over the intersection of two sets:
