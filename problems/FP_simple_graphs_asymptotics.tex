...
\begin{problem} 
A property of finite simple graphs is said to hold for all \emph{large
  enough} graphs when it holds for all but finitely many
...
\[
f(G) \leq c g(G) \text{ for some constant $c>0$ and all large enough
  connected simple graphs } G.
\]
