...
\begin{problem}
In this problem we consider the famous 6.042 magic trick, but this time
the magician and his assistant are more limited.  The assistant will
now collect 4 cards and show the magician 3 of them (in some particular order)
rather than 5 and 4.

\bparts

\ppart Show that the Magician could not pull off this trick with a deck larger
than 27 cards.
