...
In a variant of the magic card trick decribed in the
Section~\bref{cardmagic_sec} of the text, an Assistant will have the
audience choose 4 cards, and the Assistant then reveals 3 of them
---in an order he chooses ---to the Magician.
