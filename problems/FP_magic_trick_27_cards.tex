...
In this problem we consider the famous Math for Computer Science magic
trick. Unlike the one performed in class by the TAs, this time the
Assistant will be choosing 4 cards and revealing 3 of them to the
Magician (in some particular order) instead of choosing 5 and
revealing 4.
