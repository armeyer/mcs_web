...
\begin{pcomments}
    \pcomment{CP_absolute_convergence}
    \pcomment{F01.ps7}
...
But rearranging terms can cause big changes even for convergent sums
with positive and negative terms.  To illustrate the problem, we can
reorder the terms in the Alternating Harmonic Series:
\[
1 - 1/2 + 1/3 - 1/4 + \cdots \pm
\]
converges

Explain how to reorder terms in the Alternating Harmonic Series so
that the reordered series converges to 7.  Then reorder so it diverges..
...
positive terms and whose sum of negative terms each diverge.  The
moral: when reordering terms in a series, be sure to verify
