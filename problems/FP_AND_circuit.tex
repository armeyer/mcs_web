...
\includegraphics[width=0.4\linewidth]{AND_serial}
...
\includegraphics[width=0.4\linewidth]{AND_tree_recursive}
...
\includegraphics[width=0.25\linewidth]{AND_tree_4}
...
gates, $n-1$ is the coorect formula when $n=1$, so $m$ must be $>1$.
