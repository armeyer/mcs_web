...
% $d \cdot e \equiv 1 \pmod{pq}$. \inhandout{\hfill \textbf{T} \qquad \textbf{F}}
 \ppart Complete the statement.
 In the RSA Cryptosystem, if $n=pq$ then the private key $d$ and the public key
 $(e,n)$ are chosen to satisfy:
 \begin{solution}
   %\textbf{False}.
   The values of $d$ and $e$ are chosen to satisfy:
 \[
...
\ppart Why would an efficient algorithm for \textsc{Factoring} render RSA insecure?

\begin{solution}
 %\textbf{True}.
 An eavesdropper could find the private key from the
