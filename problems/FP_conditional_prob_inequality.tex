...
\ppart[1]\label{ppEREB} State an inequality between probabilities and/or conditional
...
\ppart[1]\label{ppREBE} State a similar inequality that formalizes the assertion
...
\ppart[3] Assuming the each deck is equally likely to be the one in the
...
\ppart[1] Suppose you couldn't be sure that the red deck and blue deck were
