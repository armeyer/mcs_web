...
\ppart\label{xin0ab} Conclude that there is a \emph{unique} $x \in \Zintvco{0}{ab}$ satisfying~\eqref{xma}
  and~\eqref{xnb}.
...
\in \Zintvco{0}{ab}$ is also a solution by part~\eqref{xempab}.   By part~\eqref{},
any other
...
the numbers in $\Zintvco{0}{ab$ are $\equiv \bmod{ab}$, it follows that if
  $x^\prime$ and $x$ are both in $[0,ab}$, they must be equal.

An alternative argument is that the function $f: \Zintvco{0}{ab} \to \Zintvco{0}{a} \cross \Zintvco{0}{b}$ defined by
\[
...
that $f^{-1}(m,n)$ is the unique $x \in \Zintvco{a0}{ab}$ satisfying~\eqref{xma}
  and~\eqref{xnb}.
