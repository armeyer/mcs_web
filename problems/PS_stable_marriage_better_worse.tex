...
A man does worse in his second marriage iff his first wife does better
in her second marriage.
\end{lemma*}

Let's say someone is a \emph{1-winner} when they prefer their first
spouse to their second spouse, and they are a \emph{1-loser} when they
prefer their second spouse to their first; likewise for
\emph{2-winner} and \emph{2-loser}.  (If someone has the same spouse
in both sets of marriages, then they will be neither a 1-winner nor a
1-loser.)

\bparts

\ppart\label{2l2w} Prove that a 2-loser must have a spouse who is a 2-winner.

\hint Follows directly from the definition of a rogue couple.

\begin{solution}
If both members of a first marriage were 2-losers, then they would, by
definition, be a rogue couple for the second marriages, contradicting
stability.  So if someone is a 2-loser, their first spouse must be a
2-winner.
\end{solution}


\ppart\label{same-active} Part~\eqref{2l2w} implies that there must be
at least as many 2-loser men as 2-winner women.  Prove that there are
the same number of each.

\hint 2-losers are the same as 1-winners.

\begin{solution}
Since there are as many 2-loser men as 2-winner women, there are at
least as many 1-winner men as 1-loser women.  But reversing the roles
of men and women, Part~\eqref{2l2w} implies there are at least as many
1-loser women as 1-winner men.  So the number of 1-loser women equals
the number of 1-winner men.
