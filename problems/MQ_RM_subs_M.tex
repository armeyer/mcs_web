...
\ppart One of these set definitions is \emph{ambiguous}.  Which one is it?  Show that your chosen definition is ambiguous with an example.

\begin{solution}

$M$ is an ambiguous definition.  Consider derivations of the empty string.  This could be derived directly from the base case $\lambda$, or by starting with $\lambda$ and then constructing $\lambda\lambda$ through the second constructor case.
