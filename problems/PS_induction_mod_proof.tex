...
\begin{problem}
  ...
  \begin{solution}
    ...
    \noindent \textit{Base case:} The claim holds for $k = 1$ by the second
    fact provided above.

    \noindent \textit{Inductive step:} Now we assume that the claim holds
  ...
  \begin{solution}
    ...
    \noindent \textit{Base case:} When $n = 1$, the claim asserts that if
