...
\solution{Take the conjunction ($QAND$) of formulas~\ref{xsubeqy}
  and~\ref{setneq}.}

\ppart Write a formula of set theory that means that $y$ is the powerset
of $x$.

\solution{Let $P(x,y)$ be the formula~\ref{xsubeqy} meaning $x \subseteq
...
\solution{It is easy to write a formula, $\text{Two}(y)$, that means
