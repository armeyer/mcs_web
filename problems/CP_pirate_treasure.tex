...
10 pirates.  No two of the $g_i$'s are $\equiv \pmid{10}$, so these
numbers must be $\equiv \pmid{10}$ to all ten values in $[0,10)$.  So
  the number of gold coins is $\equiv 0+1+2+\ldots+9 = 45 \equiv 5
  \pmod{10}$.  The same reasoning implies that the if the silver coins
  ...
  5 \equiv 0 \equiv 5 \pmod{10}$, so the silver coins cannot be
...
5.  So from eadch of these pair, no sequence of moves can yield a pile
of size 1.
