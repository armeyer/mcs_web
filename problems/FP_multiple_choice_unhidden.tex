...
\ppart Circle \textbf{true} or \textbf{false} for the statements below,
...
\textbf{true} \textbf{false}: \examspace[0.4in]
...
The following statements about congruence modulo $n$, where $n > 1$.
