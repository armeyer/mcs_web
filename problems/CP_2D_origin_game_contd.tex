...
\iffalse
\solution{That's because min's cannot increase as more moves are made, so
...
\iffalse
\solution{Moves North of the rectangle are not allowed because they
...
\solution{Week 3 Notes explained that lexicographic order on $\naturals^2$
...
\solution{No, because neither of the winning strategies described in the
...
\iffalse
\solution{The elements of an antichain, listed in any order, is an allowed
...
\iffalse
\solution{If the size of a game position was $\nu \in \naturals$, and size
