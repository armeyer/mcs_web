...
\begin{figure}[h]\redrawn %[htbp]
\begin{center}
\mbox{  \subfloat[$G_1$]{\includegraphics{G1}}
        \hspace{17mm}
        \subfloat[$G_2$]{\includegraphics{G4}} }
\mbox{  \subfloat[$G_3$]{\includegraphics{G2}}
        \hspace{17mm}
        \subfloat[$G_4$]{\includegraphics{G3}}
        }
\end{center}
