...
\end{equation}
For each of the assertions below, determine whether the assertion:
\begin{itemize}
\item \textbf{C}an be true for some $P$ and false for others,
\item \textbf{A}lways is true for any $P$,
\item \textbf{N}ever is true for any $P$.
\end{itemize}
...
\problempart $\exists n.\, \exists m < n.\, [P(2n) \QAND \QNOT(P(2m))]$  \inhandout{\hfill \textbf{C\quad A\quad N}}
