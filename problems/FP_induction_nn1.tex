...
\begin{proof}
We use induction.  Let the induction hypothesis $P(n)$ be the proposition, where
$P(n)$ is equation~\eqref{nn1n2}
...
\lefteqn{1 \cdot 2 + 2 \cdot 3 + \dots + (n+1) (n+2)}\\
    ...
    & \equiv P(n+1).
\end{align*}
By the induction principle, $P(n)$ is true for all $n \ge 1$, which proves the
claim.\footnote{We spelled out all three routine algebra steps here; it would
have been OK to skip the first two steps.}
\end{proof}
