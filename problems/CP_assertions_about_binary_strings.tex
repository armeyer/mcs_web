...
if $x$ is an even length string of \STR{0}'s, and its meaning might
...
but it is not immediately clear whether the definition is inconsistent
with itself (as, for example, $Q(n) \eqdef \QNOT Q(n)$ is).
