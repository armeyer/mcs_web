...
that the integer $n$ is positive.  Now we have
\[
P(n)\ \qiff\ (P(n+1) \QOR \QNOT(n = 0)) \QAND (n = 1 \QOR  P(n-1)).
\]

ELABORATION NEEDED: we want $P$ to be uniquely determined by the above; tweak def if not.
\end{editingnotes}
