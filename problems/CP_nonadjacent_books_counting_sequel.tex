...
with eight 1's indicating the selected book positions.  But there is a
...
insert two 0's after the first seven 1's in a 16 bit-string with eight
1's, to obtain a 30 bit-string with 8 occurrences of 1's that are at
least two apart.
\end{solution}
...
But taking an integer solution to the equality
\[
