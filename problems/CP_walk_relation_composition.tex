...
\begin{pcomments}
  ...
  \pcomment{better version of PS_walk_relation_composition}
...
\ppart Conclude that
\[
R^{+} = \lgunion_{i=1}^n R^i
\]
where $n \eqdef \card{A}$ and $R^{+}$ is the positive length walk
relation of $R$.
...
path can be longer than $n-1$ and no positive length cycle can be
