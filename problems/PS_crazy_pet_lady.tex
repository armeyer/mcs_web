...
\cdots)}_{\text{collections of songbirds}} \cdot
\underbrace{(1 + x)}_{\text{collections of gators}} \cdot
\underbrace{(x^2 + x^3 + x^4 + \cdots)}_{\text{collections of cats}} \cdot
\underbrace{(2^2x^2 + 2^3x^3 + 2^4x^4 + \cdots)}_{\text{lines of dogs}}
\\
