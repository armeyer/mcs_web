...
\begin{figure}
\includegraphics[height=3in]{mq3digraph}
\caption{Task DAG}
\label{fig:dag}
\end{figure}
...
\begin{solution}
One largest chain is $\set{1,6,7,11,14}$
\end{solution}

\examspace[0.4in]

\ppart What is the largest antichain? (again, pick one if you find
there is more than one).

\begin{solution}
One largest antichain is $\set{1,2,3,4,5,8,9,10,12,13}$
\end{solution}
