...
\problempart Conclude that even in a fair game, the gambler is sure to get
...
\problempart  Let $t$ be the expected time for the gambler's stake to go down by
