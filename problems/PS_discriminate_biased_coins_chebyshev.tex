...
\begin{pcomments}
  ...
  \pcomment{subsumed by of PS_discriminate_biased_coins}
\end{pcomments}
...
\begin{problemparts}
  ...
  \ppart\label{cheb95discrim} Use the Chebyshev Bound to estimate how
  large must $n$ be for you to be able to infer, with 95\% confidence,
  which of the two coins had been chosen?  \iffalse (Get close to the
  minimum value of $n$ required without considering any details of the
  relevant distribution functions, apart from mean and variance.)\fi
