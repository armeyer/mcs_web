...
\begin{pcomments}
  \pcomment{FP_conditional_prob_inequality_fall11}
  \pcomment{same as FP_conditional_prob_inequality w/o last part}
...
\inhandout{\iffalse  %GOOD, but problem is already long enough for a final exam}
