...
\begin{problem}
  ...
  \[\begin{array}{| l | c | c | c | c |}
      \hline
      \text{derived variables:}    & B & 4*A+7*B & \rem{B}{2} & \rem{4*A+7*B}{2}\\
      \hline
  ...
  stamps with a total value of exactly one dollar when the machine
  starts with \textit{ten} 4-cent stamps and \textit{five} 7-cent
  stamps.  (You may assume that the properties you chose in part b are
  preserved invariants without proof.)
