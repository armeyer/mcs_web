...
\begin{problem}
  ...
  \begin{enumerate}
    \item[(i)]  Add \textit{one} 4-cent stamps, or
    \item[(ii)] Remove \textit{two} 4-cent AND \textit{two} 7-cent stamps. (must have at least
    \textit{two} of each kind of stamps.)
  \end{enumerate}
  
  The machine always starts with \textit{ten} 4-cent stamps and \textit{five} 7-cent stamps.
