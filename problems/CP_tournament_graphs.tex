...
\begin{pcomments}
  ...
  \pcomment{revised by ARM 10/16/09, 3/8/11, 10/31/13, 4/20/17}
...
%  \item symmetric,
  ...
  \item has a directed path including all the vertices.
    \begin{solution}
      Sometimes.  It follows from part~\eqref{linear_order_length3} that
      it will have such a path iff it is a DAG.
    \end{solution}
    \examspace[0.5in]
  \end{itemize}

   \ppart\label{linear_order_length3} Show that a tournament graph is
