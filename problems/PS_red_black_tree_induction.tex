...
\begin{pcomments}
  \pcomment{PS_red_black_tree_induction}
...
Prove by structural induction that if an \RBT $T$ has $r_T$ \redl\ labels and $b_T$ \blackl\ labels and $T$ starts with \redl,
then
...
An alternative approach would be to just use~\eqref{nT3leqrT} as the induction hypothesis and 
consider constructor cases
\[
T = \begin{cases}
