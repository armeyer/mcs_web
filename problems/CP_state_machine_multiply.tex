...
\begin{align*}
\text{states} & \eqdef \naturals^3 & \text{(triples of nonnegative integers)}\\
...
\end{equation}
is an invariant of $R$.  How about $Q((r,s,a)) \eqdef \quad [r=r+1]$? :-)

\begin{solution}
Q is a trivial invariant since it is always false.  

To prove that $P$ is invariant, assume that $P((r,s,a))$ and
$(r,s,a) \movesto (r',s',a')$.  We must prove that $P((r',s',a'))$ holds,
that is
\begin{equation}\label{inv'}
r's'+a' = xy.
\end{equation}
...
number of transitions bouned by a small constant time the
...
\begin{solution}
  ...
  most $1+\log_2 y$ transitions.  But each transition reduces the
