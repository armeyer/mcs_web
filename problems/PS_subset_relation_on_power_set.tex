...
\solution{All the size 3 subsets of $\set{1,2,\dots, 6}$ form an antichain
...
\solution{$\emptyset$ is minimum and $\set{1,2,\dots,6}$ is maximum.}

\ppart Answer the previous part for the $\subset$ partial order on the set
$\power{\set{1,2,\dots, 6}}$ with $\emptyset$ removed.

\solution{Now the six size 1 subsets are minimal and there is no minimum.
