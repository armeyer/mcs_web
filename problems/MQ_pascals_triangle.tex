...
The following combinational identity is known as \idx{Pascal's Triangle}: 
\begin{equation*}
...
\ppart Give a \emph{\idx{combinatorial proof}} of the Pascal Triangle identity.
...
\ppart  Give an algebraic proof of the Pascal Triangle identity.
