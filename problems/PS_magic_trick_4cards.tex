...
Students usually identify $R$ correctly, put define it ambiguously,
saying an element of $R$ is ``a sequence of 4 cards with one hidden.''
This might mean a sequence of 4 cards with a further indication of
which of the 4 was hidden --not the same as ``a sequence with one `?'
and 3 cards.''
\end{staffnotes}
