...
problem.  The vertices $L$ are the possible $\binom{52}{4}$ sets of 4
cards, representing the possible sets of cards selected by the
audience.  The vertices $R$ are the collection of all possible length
4 sequences where the first 3 positions show the first 3 visible cards
and the 4th position is an integer between 1 and 4 indicating the
position of the hidden card.  So $R$ has $52 \cdot 51 \cdot 50 \cdot 4$
vertices.
...
1 hidden and 3 visible cards.  But for each $l \in L$,
\[
