...
\emph{For the following statements about the \textbf{greatest common
  divisor}, \inhandout{circle}\inbook{indicate} \textbf{true} or
\textbf{false}, and \emph{provide counterexamples} for those that are
\textbf{false}.}
