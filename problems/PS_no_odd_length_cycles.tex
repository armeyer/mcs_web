...
\solution{Assume $G$ is 2-colorable and select a 2-coloring of $G$.
...
\solution{If we can 2-color every connected component of $G$, then we can
...
\solution{A 2-coloring of a tree can be defined by selecting any fixed
...
\solution{Let $\edge{x}{y}$ be an edge not in $T$, and consider the unique
