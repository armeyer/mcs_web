...
\TBA{UPDATE:} For example, $T_0 = T_1 = 0$ since there are at least
two breaks, and $T_2 = 10$, because there are ten possible
combinations of two mishaps, namely nine sequences of two breaks along
with blurting twice.
...
\]
as a quotient of polynomials.  Briefly explain your derivation.
