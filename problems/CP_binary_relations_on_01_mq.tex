...
relation, $R$, on the set, $A$, is a weak partial order or a total order
...
\begin{center}
  \begin{tabular*}{\textwidth}{@{\extracolsep{\fill}} | c | c | c | c | c | c |}
    \hline
    $\mathbf{A}$ & $\mathbf{a\mrel{R}b}$ & \textbf{weak partial order} & \textbf{total order} & \textbf{minimal(s)} & \textbf{maximal(s)} \\ \hline
