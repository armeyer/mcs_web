...
\ppart \dots using the Unique Factorization Theorem and the
basic GCD properties of Lemma~\bref{lem:gcd-hold}.
...
Lemma~\bref{lem:gcd-hold}.\bref{gcd5}, so $\gcd(n, \rem{k_1k_2,n}) = 1$.
\end{solution}
