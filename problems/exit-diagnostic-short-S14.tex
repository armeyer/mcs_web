...
\ppart There twenty families in a small village.  Four families have 1
child each, five families have 2 children with different ages each,
two families have twins, three families have 3 children each, and a
single family has 4 children.
...
\ppart What propositional connective has the following truth table? 
\[\begin{array}{|c|c|c|}
\hline
P & Q & P\ \mathbf{?}\ Q\\
\hline
...
\false & \false & \false\\
\hline
\end{array}\] \hfill\examrule[0.5in]
...
the target in the second shot is $p$.  Given that
the probability that he will hit the target in the second shot is
0.62, what is $p$? \hfill \examrule[0.5in]
