...
indistinguishable except for color.  George is blindfolded and asked
to pick a ball from a jar and guess its color.  Before guessing, he
gets told the color of the ball by two friends, Anna and Sam.  Anna is
color blind, so her answer is random.  Sam can see the ball George
...
\item What is the probability that George will be correct when he
  responds?\hfill \examrule[0.6in]
...
\item Suppose that there is only one ball in the jar.  Will your
