...
\emph{antisymmetric}: Suppose $a\neq b$ and $a\mrel{R^*}b$, that is, there is
a (necessarily positive length) walk from $a$ to $b$.  If $b\mrel{R^*}a$ also
...
conclude that $\QNOT(b\mrel{R^*}a)$, which proves antisymmetry.
