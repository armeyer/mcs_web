...
\]
For exactly what integers $k \in (1,15]$ is it true that the sum of
  the digits of the base 16 representation of every nonnegative
...
16, namely, the string \texttt{10}.  The digit-sum requirement means
