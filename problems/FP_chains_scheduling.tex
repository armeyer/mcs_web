...
\begin{tabular}{rlrl}
1. & Indirect prerequisite & % Transitive closure
2. & Topological sort \\
3. & Chain &
4. & Antichain \\
...
Ringwraiths that Suaron would need in order to be sure of completing
all $n$ tasks in $t$ weeks---no matter how unlucky he was.
