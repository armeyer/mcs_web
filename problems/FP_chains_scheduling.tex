...
have crew of Ringwraiths working in parallel.

\bparts

\ppart Write a simple formula involving $n$ and $t$ for the smallest
number of Ringwraiths that Sauron could possibly need.  (Do not make
any assumptions about the values of $n$ and $t$ besides $1 \leq t \leq
n$.)

\begin{center}
\exambox{0.7in}{0.3in}{0.3in}
\end{center}
\examspace[0.5in]
...
completed in some week requiring at least this many Ringwraiths.
...
length chain of $t$ that would require this many Ringwraiths.  (Again,
do not make any assumptions about the values of $n$ and $t$ besides $1
\leq t \leq n$.)

\begin{solution}
There will be $n - t + 1$ Ringwraiths needed if there is an antichain
of $n - t + 1$ tasks that can not be started until a chain of $t - 1$
