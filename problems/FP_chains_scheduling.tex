...
time.  Sauron realizes the prerequisites among the tasks defines a
partial order.  He has $n$ tasks in his partial order, with a maximum
length chain of $c$ tasks, and a maximum size antichain of $a$ tasks.
