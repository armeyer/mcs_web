...
\begin{pcomments}
  \pcomment{MQ_irrational_raised_to_sqrt3}
...
\examspace
\begin{solution}
Case 1: [$\sqrt[3]{2}^{\sqrt{3}}$ is rational].  Let $a =
\sqrt[3]{2}$.  We know that $a$ is irrational from
...
\]
which is rational.  So we have found the required $a$ in this case
also.
