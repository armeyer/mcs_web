...
\begin{problem}
  ...
  behind the others.  No door are opend until the contestant makes a
  ...
  \bparts
  \ppart If the contestant asks ``is there is a goat behind one 
...
\end{solution}
  ...
  does it not matter?  Justify your answer for full credit.
