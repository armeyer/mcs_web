...
Note that the condition for the first transition is not $C < 1000$. A car can enter so long as it is not in the collapsed state ($C > 1000$). In other words, a car may still enter when $C = 1000$ -- and the next state will be a collapsed state with $C = 1001 > 1000$. 
