...
set of strings containing only lower case Roman letter
...
\begin{solution}
  ...
  that starts by checking that the scans an input string left to right
  checking that successive characters in the string re an arabic
  letters followed by a duplicate.
