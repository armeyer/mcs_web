...
compiling $s$.\footnote{The string, $s$, and the procedure, $P_s$,
  ...
  to a string argument, say \texttt{aabbccdd}, should throw a type
  exception; what you need to do is apply the procedure $P_s$ to
  \texttt{aabbccdd}.  This should result in a returned value \True,
  since \texttt{aabbccdd} consists of consecutive pairs of lowercase
  roman letters.}
