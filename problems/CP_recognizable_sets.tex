...
A set of \textbf{string}s is called \emph{recognizable} if there is a
...
described by some \textbf{string} of typed characters.  If a
\textbf{string}, $s$, is actually the typed description of some string
...
mapping every \textbf{string}, $s$, to the set, $f(s)$, of
\textbf{string}s recognized by $P_s$.  That is we have a total
function,
