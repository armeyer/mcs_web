...
\ppart\label{double_letters} Describe how a recognizer would work for the
...
ill-formed string, $P_S$ will ne a recognizer for the empty set of
strings.
...
$\range{f}$ is a recogizable set.  Conversely, every recogizable set
...
aCombining~\eqref{Psnf} and ~\eqref{Psfw}, we have that for every string, $s$,
