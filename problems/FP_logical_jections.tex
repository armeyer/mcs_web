...
the expressions below whose meaning is that $R$ is an \emph{injection}
$[\leq 1\ \text{in}]$.  Remember $R$ is a not necessarily total or a
function.
...
\inbook{\item $\inv{R}(R(x)) \supseteq \set{x}$}
\item $R(\inv{R}(x)) = x$
