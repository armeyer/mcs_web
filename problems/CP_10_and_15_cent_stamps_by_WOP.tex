...
\begin{problem}
  ...
  cent stamps, is divisible by 5.  Let $P(n)$ mean that exactly $n$ cents
  postage can be paid using only 10 and 15 cent stamps.  Then the proof
  shows that
%
\begin{equation}\tag{*}
P(n)\ \QIMPLIES\ 5 \divides n, \quad \text{for all nonnegative integers $n$}.
\end{equation}
