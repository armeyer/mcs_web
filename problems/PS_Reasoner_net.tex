...
$N$-input/output network he modestly calls a \emph{Reasoner-net} with the
aim of combining the best features of both the butterfly and Bene\v{s} nets:
\begin{quote}
...
congestion.  Likewise, the \term{congestion for min-latency} (\term{CML})
is the best bound on congestion achievable using routings that minimize
latency.
