...
dollars. Using induction, prove the following 

\begin{quote}
\textbf{Property}: For any $m$,
given a (nonnegative) dollar amount $n < 2^m$, there exists a subset
of envelopes whose contents add up to {\em exactly} $n$ dollars. 
\end{quote}
