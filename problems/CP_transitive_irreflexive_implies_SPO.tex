...
\begin{pcomments}
  \pcomment{CP_transitive_irreflexive_implies_SPO}
...
\begin{solution}
  ...
  asymmetric.  That $R$ is transitive we know already. To prove that
  it is asymmetric, suppose $a\mrel{R}b$ holds for some $a,b\in A$.
  We need to prove $\QNOT(b \mrel{R} a)$.
