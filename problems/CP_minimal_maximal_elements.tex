...
positive integer, under the \term{empty relation}\footnote{the \emph{empty relation} has
a domain and a codomain, but no element is connect to each other--that is, 
it has vertices but no edges.}?
...
divides all nonnegative integers.  The maximum (and therefore unique
