...
\emph{3-clause} is a $\QOR$ of three literals from three different
variables.  For example,
\[
P_1 \QOR P_2 \QOR \bar{P_3}
\]
is a 3-clause, but $P_1 \QOR P_1 \QOR \bar{P_1}$ is not because $P_1$
appears twice.  A \emph{3-CNF} is a formula that is a $\QAND$ of
...
\ppart\label{e3cf} What is the expected number of true 3-clauses in $F$?
