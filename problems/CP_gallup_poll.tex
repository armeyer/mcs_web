...
probability $q$ being 0.  By Lemma~\bref{bernoulli-variance}, $\variance{H} = pq$.
...
Noting that the derivative of $pq = p(1-p)$ with respect to $p$, $2p-1$, is zero when $p=1/2$, it follows that
