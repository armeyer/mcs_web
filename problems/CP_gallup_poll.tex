...
Noting that the derivative of $p(1-p)$ with respect to $p$, $2p-1$, is
zero when $p=1/2$, it follows that $p(1-p)$ is maximal when $p = 1/2$,
so the maximum value of $\variance{H}$ is $(1/2)(1 -(1/2)) = 1/4$.
\end{solution}
