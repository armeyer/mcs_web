...
\begin{problem}
There is a rare and deadly disease called Nerditosis which afflicts about 10 MIT students in 100.
...
-If you don't have it, there's a 30\% chance the test will say you do.
...
\begin{equation*}
\prcond{A}{B} = \frac{\pr{A \cap B}}{\pr{B}} = \frac{.09}{.09+.027} = \frac{1}{4}
\end{equation*}
