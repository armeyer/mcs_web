...
of degree 5, have $f=O(g)$.  The behavior of $f(n)$ when $n$ is not a multiple of 4
leads to $g \neq O(f)$.  It is obvious that $\lim_{n\to\infty}{\frac{f(n)}{g(n)}}$
and $\lim_{n\to\infty}{\frac{g(n)}{f(n)}}$ are both nonzero, so $f \neq o(g)$ and
$g \neq o(f)$.
\end{solution}
