...
probability of winning.  Therefore, the variance of the total number of hands won in a day is
%\[
...
which evaluates to $(50/3) + 15 + (16/5) = 523/15 = 34\ \tfrac{13}{15}$.
...
the probability that the gambler will win at least 108 hands on a
given day?  You may answer with a numerical expression that is not
