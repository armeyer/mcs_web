...
every vertex is on an odd-length cycle and \emph{no} vertex is on an
even-length cycle.  Conclude that the \TBA{DRAFT}.
...
\ppart Give an example of a simple graph whose minimum size even-length
