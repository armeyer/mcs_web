...
\item If $T \eqdef$ \includegraphics[width=1cm]{tiling_1} is a DET, then
the structure in Figure~\ref{4DET-fig} built out of four copies of $T$
is also a DET, and the subtriangles of this DET are exactly the
subtriangles of each of the four copies of $T$.
\end{itemize}
