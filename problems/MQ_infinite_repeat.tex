...
\expect{H}
    ...
    & = \sum_{k \in \naturals} \frac{1}{q^{m_k}} \cdot q^k p\\
...
\begin{align*}
\expect{H_r}
    & = \sum_{k \in \naturals} \expcond{H_r}{T=k} \cdot \prob{T=k}\\
    & = \sum_{k \in \naturals} \frac{1}{q^{\ceil{rk}}} \cdot q^k p\\
    & \leq \sum_{k \in \naturals} \frac{1}{q^{rk+1}} \cdot q^k p\\
    & = \sum_{k \in \naturals} q^{k(1-r)} pq = \sum_{k \in \naturals} \paren{q^{1-r}}^k pq\\
