...
\bparts \ppart \label{counterexample} Give a counterexample to the
...
\ppart  Underline the exact sentence or part of a sentence where the
following proof of the False Claim first makes an unjustified deduction.
%goes wrong:
