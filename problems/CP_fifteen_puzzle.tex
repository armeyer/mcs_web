...
\term{parity} of $S$ to be 0 or 1 depending on whether the sum of the number of
...
To see how the parity is changed in this case, we need to consider
only the 3 pairs in $L$ that are between the tile's old and new position.
(The other pairs are not affected by the tile's move).  This reverses the
