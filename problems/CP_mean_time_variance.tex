...
\ppart\label{varH} A computer program crashes at the end of each hour of use with
$1/365p$, if it has not crashed already.  We know that the expected
number of hours, $\expect{H}$, until the program crashes is $1/p$.  What
is the \idx{variance} of the number of hours until the program crashes?
