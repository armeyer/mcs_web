...
\end{itemize}
You may use earlier predicates in later parts, even if you did not solve the earlier parts. For example, your answer to part (c) might refer to $\text{inline}(x)$ and/or $\text{first}(x)$.
...
\ppart Student $x$ is in the line. (Call this predicate $\text{inline}(x)$.)
...
\ppart
Student $x$ is first in line. (Call this predicate $\text{first}(x)$.)
...
\ppart
Student $x$ is immediately to the right of student $y$. (Call this predicate $\text{isnext}(x,y)$.)
