...
that are preserved under graph isomorphism.
...
\ppart For the following four statements about finite simple graphs,
\inbook{indicate}\inhandout{circle} those that are \textbf{true}, and
...
\iffalse
%NOT USED S11---fortunately, since it's wrong---ARM 12/13/13
...
%S11 \ppart A \term{sink} in a digraph is a vertex with no edges
leaving it.  \inbook{Indicate}\inhandout{Circle} whichever of the
following assertions are true of \idx{stationary distributions} on
finite digraphs with exactly two sinks:
