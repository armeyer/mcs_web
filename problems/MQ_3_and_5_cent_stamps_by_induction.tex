...
\begin{problem}
   Prove that using only 3 and 5 cent stamps, every amount of postage
   $\geq 8\cents$ can be made.

\hint Let $S(n)$ mean that exactly $n+8$ cents of postage can be paid
using only 5 and 3 cent stamps.
