...
\begin{problem}
  ...
  exactly using 3 and 5 cent stamps.  Use induction to prove that
  your answer is correct.
  
  \hint Let $S(n)$ mean that exactly $n$ cents of postage can be
  paid using only 3 and 5 cent stamps. Prove that the following 
...
\begin{solution}
  ...
  \begin{proof}
    ...
    be made by 3 and 5 cent stamps:
