...
\begin{pcomments}
  \pcomment{FP_counting_given_answers_F15}
...
questions~\eqref{x1x2xnm}--\eqref{mbdnd} below, in no particular
...
\ppart How many functions are there from a set of size $n$ to a set of
  size $m$? \begin{center}
\exambox{0.4in}{0.4in}{0in}
\end{center}
...
sequences of distinct elements of the size-$n$ $.  By the Generalized Product
...
\ppart How many ways are there to place a total of $m$ indistinguishable
  balls into $n$ distinguishable urns, with some urns possibly empty or
  with several balls?
\begin{center}
\exambox{0.4in}{0.4in}{0in}
