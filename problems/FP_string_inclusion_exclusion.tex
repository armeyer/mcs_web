...
\STR{011} occurs starting at the 4th position.  By convention Strings
start with position zero, so the length 14 string
\[
\STR{0010\textbf{011}0011101}
\]
for example has \STR{011} in the 4th position as well as the 8th
position.
...
Write a formula for $s$ in terms of $n$.
