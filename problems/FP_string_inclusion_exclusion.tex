...
\STR{011} occurs starting at the $i$th position.  \iffalse , for $0
\leq i < n-2$.  So $A_i$ is empty for $i \geq n-2$.\fi If $i \neq j$,
the intersection $A_i \intersect A_j$ is either empty or of size $s$.
