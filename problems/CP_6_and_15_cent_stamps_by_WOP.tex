...
\begin{pcomments}
  ...
  \pcomment{3 divides m-6 part edited ARM 1/30/2015}
\end{pcomments}
...
But if $3 \divides (m-6)$, then $3 \divides m$, because\dots,

\begin{solution}
if 3 divides two numbers, then it divides their sum (because $3x+3y= 3(x+y))$, so since 
$3 \divides (m-6)$ it also divides $(m-6)+6=m$.
\end{solution}
