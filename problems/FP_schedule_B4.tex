...
That is,
\[
(b_1,b_2,b_3,b_4) \leq (c_1,c_2,c_3,c_4)
\]
...
constraints on 16 tasks.\footnote{As usual, we assume each task
  requires one time unit to complete.}  That is, if $(b_1,b_2,b_3,b_4)
\leq (c_1,c_2,c_3,c_4)$ are two different tasks, then
$(b_1,b_2,b_3,b_4)$ has to be completed before $(c_1,c_2,c_3,c_4)$
starts.  What is the length of a minimum time \textbf{3}-processor
schedule for $B^4$?
