...
Let $R$ and $S$ be relations on the set $A$. For each of the following statements, determine whether it is true or false and prove your answer.
\bparts
\ppart
...
Counterexample: Let $R$ be the equality relation.  Then 
\end{solution}
\ppart
