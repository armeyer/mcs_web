...
Let $R$ and $S$ be relations on the set $A$. Determine whether each of
the following statements is true or false and prove your answer.

\bparts

\ppart If $R$ is reflexive then the complement of $R$ is also
reflexive.
...
$\mathcal{R}$ is symmetric means: $\forall a,b \in A, a \mathcal{R} b \QIMPLIES b \mathcal{R} a$.
This implies that $\forall a,b \in A, \QNOT (a \mathcal{R} b) \QIMPLIES \QNOT(b \mathcal{R} a)$,
...
$\forall a\in A a\mathcal{R}a \QAND \forall a \in A a\mathcal{S}a \QIMPLIES \forall a \in A a(\mathcal{R}\intersect\mathcal{S})a$.
