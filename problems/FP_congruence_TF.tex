...
\textbf{\large \inbook{Indicate} which of the following statements
  about \textbf{congruence modulo} $n$, where $n > 1$, are
  \textbf{true} or \textbf{false}, and \emph{provide counterexamples}
  for those that are \textbf{false}.}
