...
\begin{problem}
  \emph{Euler's Conjecture}~\ref{a4} was described in class notes was that there
  are no positive integer solutions to the equation
\[
a^4 + b^4 + c^4 =  d^4.
\]
Integer values for $a,b,c,d$ that do satisfy this equation, were first
discovered in 1988, more than two hundred years after the conjecture.  So
Euler guessed wrong.
