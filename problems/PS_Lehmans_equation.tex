...
\begin{problem}
  \emph{Euler's
    Conjecture}~\href{http://library.thinkquest.org/28049/Euler's
    Conjecture.html} in 1769 was that there are no positive integer
  solutions to the equation
\[
a^4 + b^4 + c^4 =  d^4.
\]
Integer values for $a,b,c,d$ that do satisfy this equation, were first
discovered in 1988.  So Euler guessed wrong, but it took more two hundred
years to prove it.
