...
\begin{quote}
$P(n) \eqdef$ If $n$ moves from a set of stacks, $A$, leads to a set $B$ of stacks, then
...
steps.  So the inductive hypothesis $P(n)$ implies that $p(A_1) \geq p(B)$ and
...
sizes $k_1,k_2 \geq 1$ where $k = k_1+k_2$. The score for such a move
is $k_1k_2$.  Also,
\[
