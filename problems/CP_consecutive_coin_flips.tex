...
\texttt{TT} has appeared.  That's because when \texttt{TT} appears,
we're already one step along the way to having \texttt{TH} appear
afterward, yet when \texttt{TH} shows up first, we have to start
waiting for \texttt{TT} to appear without a similar head start.
