...
\begin{proof}
  ...
  whose distance is minimum among all dpp's (we apply the WOP
  implicitly!), and let $\walkv{p}$ be a shortest path between $u$ and
  $v$.  By definition of dpp, there must be another path $\walkv{q}
