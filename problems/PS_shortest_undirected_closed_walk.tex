...
\begin{pcomments}
  ...
  \pcomment{undirected version of MQ_cycle_from_closed_walk}
\end{pcomments}
...
\begin{proof}
  ...
  there are distinct paths between them.  Suppose $u, v$ is a
  dpp whose distance is minimum among all dpp's (we apply the WOP implicitly!),
  and let $\walkv{p}$
