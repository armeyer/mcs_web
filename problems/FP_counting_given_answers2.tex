...
entries drawn from $\set{1, 2, \ldots, m}$?} \begin{center}
\exambox{0.4in}{0.4in}{0in}
\end{center}
...
if $\card{A} = m$ and $\card{B} = n$? \begin{center}
\exambox{0.4in}{0.4in}{0in}
\end{center}
...
set of size $n$? \begin{center} \exambox{0.4in}{0.4in}{0in}
\end{center}
...
alphabet, if no letter is used more than once? \begin{center}
\exambox{0.4in}{0.4in}{0in}
\end{center}
...
\ppart How many length $m$ words can be formed from an $n$-letter
  alphabet, if letters can be reused? \begin{center}
\exambox{0.4in}{0.4in}{0in}
\end{center}
...
set of size $m$?\begin{center}
\exambox{0.4in}{0.4in}{0in}
\end{center}

\iffalse
\ppart How many different subsets of the set $A \times B$ are there
  when $\card{A} = m$ and $\card{B} = n$? \begin{center}
\exambox{0.4in}{0.4in}{0in}
\end{center}
\fi
...
\ppart How many total injective functions are there from set of size
  $m$ to a set of size $n$ where $n \geq m$? \begin{center}
\exambox{0.4in}{0.4in}{0in}
\end{center}
