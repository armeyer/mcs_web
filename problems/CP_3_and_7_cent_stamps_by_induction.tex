...
\begin{problem}
  ...
  exactly using 3 and 7 cent stamps.  Use induction to prove that your
  answer is correct.

  \hint Let $S(n)$ mean that exactly $n$ cents of postage can be
  paid using only 3 and 7 cent stamps. Prove that the following
...
\begin{solution}
  ...
  $k \geq 12$ can be paid by 3 and 7 cent stamps.
