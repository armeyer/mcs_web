...
\ppart Let $n$ and $a$ be positive integers. If $n$ and $a$ are relatively
prime, then $a^{n\phi(n)} \equiv 1 \pmod{n}$.
...
sides to the $n^\text{th}$ power, we get that $(a^{\phi(n)})^n \equiv
a^{n\phi(n)} \equiv 1 \pmod{n}.$
\end{solution}
