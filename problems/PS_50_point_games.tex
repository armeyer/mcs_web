...
\begin{pcomments}
  \pcomment{PS_50_point_games}
  \pcomment{alternative to PS_value_games} 
...
\begin{problem}
 Define \emph{2-person 50-point games of perfect information}
...
$\fiftypg$'s for some $n \in \nngint$, then the following game $G$ is a
...
If the play ends at the terminated game $k$ then $k$ is called the
...
\]
of $\fiftypg$'s.  Now a $\fiftypg$ can be a mind-bendingly infinite datum
