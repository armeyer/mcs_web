...
to split $8N$ students in 6.042 into $N$ groups of $8$ students.
...
$8N$ students is obtained that is mapped to a same set of groups. %splitting into teams. %group splitting.
