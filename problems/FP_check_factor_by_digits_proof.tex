...
\begin{solution}
\begin{align*}
d_m \cdot b^m + d_{m-1} \cdot b^{m-1} + \cdots + d_1 \cdot b^1 + d_0 \cdot b^0
   & \equiv d_m \cdot 1^m + d_{m-1} \cdot 1^{m-1} + \cdots + d_1 \cdot 1^1 + d_0 \cdot 1^0 \pmod k\\
   & = d_m + d_{m-1} + \cdots + d_1 + d_0.
\end{align*}
\end{solution}

\ppart Prove conversely, that for any base $b \geq 2$, a modulus $k$
is good for base $b$ only if $b \equiv 1 \pmod k$.
