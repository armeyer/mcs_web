...
whose faces are all simple cycles (no dongles or bridges).  Let $M$ be
...
\begin{solution}
  ...
  \begin{enumerate}
  \item map
    No. Consider a graph with a length-7 cycle. The graph will no longer be
  ...
  \item sevenish
    ...
    was sevenish.
  \item connected % take it out if reusing.. implied by "connected" subgraphs
    Yes. All \textit{connected} subgraph is clearly connected.
  \item 3-colorable
