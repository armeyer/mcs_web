...
\begin{pcomments}
  ...
  \pcomment{from: S09.cp6r, S07.cp6m}
\end{pcomments}
...
\begin{problem}
Let $G$ be the graph below\footnote{From\inbook{~\cite{MR1952453}}\inhandout{ \emph{Discrete Mathematics: Elementary and Beyond}, Lov{\'a}sz \emph{et al.}, Springer, 2003}, Exercise 13.3.1}.
