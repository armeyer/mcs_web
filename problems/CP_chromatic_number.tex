...
\begin{pcomments}
  ...
  \pcomment{from: S07.cp6m, S09.cp6r, S10.cp8w, F11.cp8f S12.cp8m, S13.cp8f, S14.cp7f, F13.cp8f}
\end{pcomments}
...
\begin{problem}
Let $G$ be the graph
below.\footnote{From\inbook{~\cite{LovaszPV03}}\inhandout{
    \emph{Discrete Mathematics: Elementary and Beyond}, Lov{\'a}sz
    \emph{et al.}, Springer, 2003}, Exercise 13.3.1} Carefully explain
why $\chi(G)=4$.
\begin{figure}[h]
\graphic{4-chromatic}
\end{figure}
...
\begin{solution}
Figure~\ref{fig:4-coloring} shows a four coloring, so $\chi(G) \leq
4$.

\begin{figure}[h]
\graphic{4-chromatic-colored}
