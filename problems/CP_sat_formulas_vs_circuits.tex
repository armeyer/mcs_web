...
\begin{pcomments}
    ...
    \pcomment{subsumes PS_sat_formulas_vs_circuits}
...
truth assignment of the variables.  The problem is that, in general,
...
and satifiability of formulas take rougly the same effort to solve,
