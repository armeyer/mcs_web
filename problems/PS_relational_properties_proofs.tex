...
\inhandout{
\hint Arguments based on ``arrows'' using  Definition~\bref{archery-def} are fine.
}
...
Suppose $A = C = \set{1}$ and $B = \set{1, 2}$.  Let $f$ be such that $f(1) = f(2) = 1$, and
