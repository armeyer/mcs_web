...
\ppart[1]\label{002020paths} Theory Hippo wants to travel from point (0, 0) to point (20, 20)
using only steps that add one to the $x$ or the $y$ coordinate.  How many
different paths can he choose from?  \examspace[0.5in]
