...
\begin{solution}
  ...
  So there no alternative but to rank the elements from smallest to
  largest (most losing).  (By convention, the arrows in the graph of a
  partial order are interpreted as pointing from ``smaller'' to
  ``larger,'' so the smallest element corresponds to the most winning
  player and the largest to the most losing.)
\end{solution}
