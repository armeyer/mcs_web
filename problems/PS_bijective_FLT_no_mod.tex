...
\begin{pcomments}
  \pcomment{PS_bijective_FLT_no_mod}
  \pcomment{same as PS_bijective_FLT_S16 but no ``mod p''}
...
\]
for all primes $p$ and integers $a$ not divisible by $p$, which
follows immediately from~\eqref{apeqvap}.}
asserts that
