...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{problem}
  The set {\RM} of strings with matching brackets is defined recursively as follows:
  ...
  \item
    \textbf{Constructor case}: If $s,t\in\RM$, then $\lefbrk s\,\rhtbrk t\in\RM$.
  \end{itemize}
  
  A different way to determine if a string has matching brackets, that is, if it is
in the set \RM,
...
\ppart\label{recstruct} Prove that $\RM\subseteq\GC$ by structural induction. Be sure to clearly state your inductive hypothesis.

% What inductive hypothesis would you use to prove RecMatch
