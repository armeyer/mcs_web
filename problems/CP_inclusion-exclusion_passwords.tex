...
\begin{quote}
a\textbf{drop}eflis, \textbf{failedrop}s, \textbf{drop}e\textbf{fails}.
\end{quote}
\bparts

\ppart How many cwords contain the subword ``drop''?

\solution{Such cwords are obtainable by taking the word ``drop'' and the
...
\ppart Use the Inclusion-Exclusion Principle to find a simple formula for
