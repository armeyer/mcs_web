...
\begin{problem}
  ...
  \solution{One such bijection is defined by lining up all the integers and
...
\solution{Line up all the pairs by following successive upper-right to
...
\solution{One way to line up the positive rationals is to take the list
