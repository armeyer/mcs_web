...
\begin{pcomments}
  ...
  \pcomment{depends on PS_stable_marriage_better_worse_count}
  \pcomment{by ARM 4/11/15, soln added 5/6/15}
\end{pcomments}
...
third set of marriages, then without loss of generality we can
conclude that there are no rogue couples in the third set of
marriages.

So suppose Bob and Carol are a rogue couple in the third set, that is,
Bob prefers Carol to Alice, and Carol prefers Bob to Ted.  Then we
claim that Bob and Carol are a rogue couple in the second set of
marriages, contradicting stability.  The follows from~\eqref{swsl},
because Bob prefers Alice to his second wife, and therefore he prefers
Carol to his second wife, and we know conversely that Carol prefers
Bob to her second husband, Ted.
\end{solution}
