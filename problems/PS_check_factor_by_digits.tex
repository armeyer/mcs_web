...
\begin{pcomments}
  ...
  \pcomment{subsumed by FP_check_factor_by_digits_proof}
...
\ppart\label{base16sum} For exactly what integers $k>1$ is it true
that the sum of the digits of the base 16 representation of an integer
is congruent modulo $k$ to that integer?  Justify your answer.
