...
that integer?  Give a rule that produces this answer and generalizes to
arbitrary number bases $b > 1$, finding all valid $k$ values for any $b$,
and prove that your rule never yields incorrect $k$ values.
\iffalse
\begin{center}
...
16 \equiv 1 \pmod{k} & (\textrm{letting } $a = 1, b=0$).
\end{align*}
\end{solution}
