...
%\iffalse
Given any integer $x$ represented in base $b$\footnote{Base $b$ represents a number as a sum of powers of $b$: binary is base $2$, decimal is base $10$, hex is base $16$....}, for some $k \in [2,b)$,
