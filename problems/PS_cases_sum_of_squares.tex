...
\begin{solution}
Case 1. (None of $a,b,c$ are even).  Since neither $W$ nor $T$ is true
...
Case 2. (Exactly one among $a,b,c$ is even.)  TBA.

Case 3. (Exactly two among $a,b,c$ are even.) TBA.

Case 4. (All three of $a,b,c$ are even.)      TBA.
