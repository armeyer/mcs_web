...
\inductioncase{Case 1}: if $w,x,y$ are all odd $\Rightarrow$ $a,b,c$ are all odd $\Rightarrow$ $d$ is odd $\Rightarrow$ $z$ is odd. $P$ and $R$ are both False so the \QIFF\ assertion is True.

\inductioncase{Case 3}: if two of $w,x,y$ are even $\Rightarrow$ two of $a,b,c$ are even $\Rightarrow$ $d$ is odd $\Rightarrow$ $z$ is odd. $P$ and $R$ are both False so the \QIFF\ assertion is True.

\inductioncase{Case 4}: if $w,x,y$ are all even $\Rightarrow$ $a,b,c$ are all even $\Rightarrow$ $d$ is even $\Rightarrow$ $z$ is even. $P$ and $R$ are both True so the \QIFF\ assertion is True. 

\inductioncase{Case 2}: if one of $w,x,y$ is even $\Rightarrow$ one of the $a,b,c$ is even $\Rightarrow$ $d$ is even $\Rightarrow$ $z$ is even. In this case, let's assume without loss of generality that $a$ and $b$ are odd and $c$ is even. This means that $w$ and $x$ are odd and $y$ is even. Then let $w=2m+1$, $x=2n+1$, and $y=2p$ for some nonnegative integers $m,n,p$. Then,
\[
