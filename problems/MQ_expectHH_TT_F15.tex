...
e(A) & = 1 + \frac{p(1+q)}{1-pq} + \frac{q(1+p)}{1-pq}\\
     ...
     & = \frac{2+pq}{1-pq}.
\end{align*}
Note that $e(A)$ is smallest when $pq$ is smallest.
That happens when $p=0$ or $q=0$, in which case $e(A) = 2$.  
On the other hand, $e(A)$ is largest when $pq$ is largest.
That happens when $p=q=1/2$, in which case $e(A) = 3$.  
\end{solution}
