...
\ppart Express each of $e(A),e(b),e(c)$ as a linear combination of $e(A),e(b),e(c)$.
\begin{solution}
By the Total Expectation Rule, we have
\begin{align*}
e(A) & = p(1+ e(B)) + q(1+e(A)) = 1 + p\cdot e(B) + q\cdot e(C),\\
...
\ppart Express the value of $e(A)$ as a simple function of $p$.
