...
\begin{editingnotes}
\textcolor{red}{THIS PROBLEM NEEDS WORK!}
\end{editingnotes}

You've seen how the RSA encryption scheme works, but why is it hard to
break?  In this problem, you will see that finding private keys is as hard
...
it will take the same kind of overwhelming effort to find RSA private keys
