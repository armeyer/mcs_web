...
line graph of length two or three whose unique embedding is a closed
walk of length four or six going from one end of the graph to the
other and back.  In any case, the one face has length more than three.
