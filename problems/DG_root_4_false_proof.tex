...
\begin{problem}\label{generprob}
 Sloppy Sam was trying to generalize the proof that $\sqrt{2}$ is irrational, but he accidentally proved that $\sqrt{4}$ is also irrational! Circle the first significant mistake, and write him a brief note explaining his mistake.
