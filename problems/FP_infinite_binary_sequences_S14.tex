...
set of infinite binary sequences, and $F$ be the set of infinite
binary sequences that contain an infinite number of occurrences of
\mtt{1}'s.
...
any results from class about countability.)}
