...
\ppart Use the Invariant Principle to prove that you can not make
the entire first half of the deck black through a sequence of
inshuffles and outshuffles.

\begin{solution}
Define two cards to be {\em opposites} if the sum of their positions
...
Note that $P$ holds for the start state by definition.  However, the
$P$ cannot hold when all black cards are in the top half of the deck;
in that case, every black card is opposite a red card.  Therefore, by
