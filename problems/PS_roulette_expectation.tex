...
\ppart\label{ppart:product} the product of the numbers chosen?  What is this maximum?

\hint For part \ref{ppart:product} , verify that the best way to maximize the expected product is to ensure that successive
