...
\bparts
\ppart \dots the sum of the numbers chosen?  What is the max?
...
\ppart \dots the product of the numbers chosen?  What is the max?
...
\begin{solution}
We claim the best way to do this is to have each odd number $k$
