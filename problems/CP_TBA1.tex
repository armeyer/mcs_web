...
\begin{problem}
\bparts \ppart Prove using the Well Ordering Principle that using
6\textcent, 15\textcent, and 21\textcent\ stamps, it is possible to
make any amount of postage over 50\textcent.  To save time, you may
\emph{assume without proof} that all amounts between 50 and $50+k$\textcent\ are
makeable for some \emph{fixed} integer $k \geq 0$.
...
makeable since anything $\geq 50$ and less than $m$ is makeable by
...
\ppart What is the smallest value of $k$ for which your proof will work? 
\begin{solution}
