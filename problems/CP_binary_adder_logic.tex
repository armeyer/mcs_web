...
\begin{problem}
  ...
  o_1,o_0$.  The 2-bit word $a_1a_0$ gives the binary representation
  of an integer, $k$, between 0 and 3.  The 3-bit word $cs_1s_0$ gives
  the binary representation of $k+b$.  The third output bit, $c$, is
  called the final \term{carry bit}.
...
for $s_{i}$ and $c_{i}$ for $0 \leq i \leq n+1$, where $c_i$ is the carry
