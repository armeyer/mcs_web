...
\]
A standard result of elementary calculus is that this series converges
to $\ln 2$~\cite{Apostol66},p.403, but things change if we reorder
...
known as \emph{Riemann's Series Theorem}~\cite{Apostol66},p.413.  The
