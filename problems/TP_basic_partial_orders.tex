...
If it is a partial order, state whether it is a total order and
...
\begin{solution}
  ...
  order.  It's irreflexive.  It's not total.  Every element is
...
\begin{solution}
  ...
  It's obviously reflexive.  It's vacuously antisymmetric and
  transitive, so it's a weak partial order.  It's not total.  Every
  element is vacuously both minimal and maximal.
...
\begin{solution}
Not antisymmetric: 3 and -3 divide each other.  It is transitive and reflexove.
\end{solution}
