...
\begin{problem}
According to the Multinomial theorem, $(x_1 + x_2 + ... + x_k)^n$ can be expressed as a
sum of terms of the form
\[
\binom{n}{r_1,r_2,...,r_k}x_1^{r_1}x_2^{r_2}...x_k^{r_k}.
\]
...
\sum_{\substack{r_1+r_2+...+r_k = n,\\
      r_i \in \naturals}}         \binom{n}{r_1,\, r_2,\, ...,\, r_k} = k^n
\end{equation}

Give a combinatorial proof of this identity.

\hint How many terms are there when $(x_1+x_2+...+x_k)^n$ is expressed as a sum of
monomials in $x_i$ \emph{before} terms with like powers of these
...
\begin{solution}
  ...
  $(x_1 + x_2 + ... + x_k)$, and each choice corresponds to a degree $n$ product of
  these variables.  Each of the $\binom{n+k}{k}$ coefficients in the
