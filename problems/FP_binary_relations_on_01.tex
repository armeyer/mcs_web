...
\begin{problem}
How many binary relations are there on the set $\set{0,1}$? \hfill \examrule[0.7in]

\noindent How many are there that are:

\examspace[0.2in]
transitive? \hfill \examrule[0.7in]

\examspace[0.2in]
asymmetric? \hfill \examrule[0.7in]

\examspace[0.2in]
reflexive? \hfill \examrule[0.7in]

\examspace[0.2in]
irreflexive? \hfill \examrule[0.7in]

\examspace[0.2in]
strict partial orders? \hfill \examrule[0.7in]

\examspace[0.2in]
weak partial orders? \hfill \examrule[0.7in]
