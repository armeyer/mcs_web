...
We know from class problems that integers, rationals and the set of finite binary sequences are countable. Moreover,
 \integers  strict  \power(\integers) 
from which there is a bijection to the set of real numbers. Consequently,  \power(\integers)  has the same cardinality as the set of real numbers. Finally, 
\binw  strict  \power(\binw)
Hence,  \power(\binw)  is even bigger than the rest of these sets in terms of cardinality.
