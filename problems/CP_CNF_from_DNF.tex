...
\QOR or \QAND, we have
\begin{align}
\QNOT(A \QOR B \QOR \cdots \QOR Z) & \qiff \bar{A} \QAND \bar{B} \QAND \cdots \QAND \bar{Z})  \label{m
oreDeMnotor} \\
\QNOT(A \QAND B \QAND \cdots \QAND Z) & \qiff \bar{A} \QOR \bar{B} \QOR \cdots \QOR \bar{Z})  \label{m
oreDeMnotand}
\end{align}
