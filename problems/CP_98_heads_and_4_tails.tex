...
\solution{This can be modeled by a state machine.  The state of the
...
\item strictly increasing \solution{NONE}
\item weakly increasing \solution{$C$, $H_2$}
\item strictly decreasing \solution{NONE}
\item weakly decreasing \solution{$H_2$}
\item constant \solution{$H_2$}
\end{enumerate}
