...
\begin{solution}
  ...
  last parentheses leaves a string with a good count.  In short, being the
  ...
  the number of strings with $n+1$ left parentheses that have positive
...
that are wraps of strings with good counts and $s = s_1\cdots s_k$.
For example, the string $r \eqdef \mtt{(())()(()())} \in \GC$ equals
$s_1s_2s_3$ where $s_1= \mtt{(())}, s_2 = \mtt{()}, s_3 = \mtt{(()())}$,
and this is the only way to express $r$ as a sequence of wraps of strings
with good counts.
