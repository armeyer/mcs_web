...
\begin{problem}
  ...
  of strings of matched brackets.  To do this, we'll use the
  description of these strings given in Definition~\bref{gc-def} as
  the set, $\GC$, of strings of brackets with a \idx{good count}.
...
$\mtt{[}s\mtt{)}$, that starts with a left bracket followed by the
