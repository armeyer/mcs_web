...
\item With probability $\frac{4}{7}$ the exam is graded by a \emph{TA},with
probability $\frac{2}{7}$ it is graded by a \emph{lecturer}, and with
probability $\frac{1}{7}$, it is accidentally dropped behind the radiator
and arbitrarily given a score of 84.

\item \emph{TAs} score an exam by scoring each problem individually and
then taking the sum.
...
\item \emph{Lecturers} score an exam by rolling a fair die twice,
