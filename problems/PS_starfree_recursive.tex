...
\begin{problem}
At the lowest level of abstraction, document in a written
language---natural or computer language--just consists of sequence of
symbols.  In formal language theory, such sequences of symbols are referred to as \emph{words}, though they could equally well be called ``phrases,'' or ``sentences.''
...
Now a more interesting example of a c-d set is language of all binary
