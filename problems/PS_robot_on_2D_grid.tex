...
\begin{solution}
Let the set of states be $\integers \times \integers$.  The start
...
transitions.
  ...
  Now $P$ holds in the start state, since $3 \divides (0 + 2 \cdot
  0)$.  However, $P$ does not hold for Eve's position, $(0, 2)$, since
  $0 + 2 \cdot 2 = 4$ is not a multiple of 3.  Therefore, by the
  Invariant Principle, Eve's position is not a reachable state.
