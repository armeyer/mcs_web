...
\begin{pcomments}
  \pcomment{CP_magic_trick_4cards}
  \pcomment{subset of PS_magic_trick_4cards}
\end{pcomments}
...
Section 14.8.6 explained why it is not possible to
...
\begin{solution}
We proceed as in Section 14.8.6 by modeling the
...
Theorem 11.5.4 satisfies Hall's matching condition and so has a matching.
\end{solution}
