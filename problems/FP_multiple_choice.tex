...
that are preserved under isomorphism of simple graphs.
\begin{itemize}
...
\begin{solution}
\textbf{false}.  Requires $\gcd(c,n)=1$.

Counterexample: $n=2 \cdot 3, a=0, b=2, c=3$
\end{solution}
...
Counterexample: $n=4$, so $\phi(n) = 2$; $a=1, b=3$, so $a \equiv b
