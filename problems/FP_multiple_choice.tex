...
\begin{comments}
  ...
  \pcomment{Tom Brown: changed a few, reordered them.  Picked favorites.
...
\ppart Circle \textbf{true} for the statements below that are true, and
\emph{provide counterexamples} for those that are not.
