...
\ppart[2] Circle all the properties below that are preserved under graph
isomorphism.
\begin{itemize}
...
\ppart[6] Circle \textbf{true} for the statements below that are true, and
