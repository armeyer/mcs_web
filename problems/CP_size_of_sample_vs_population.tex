...
\begin{problem}
  A defendent in traffic court is trying to beat a speeding ticket on the
  grounds that ---since virtually everybody speeds on the turnpike ---the
  police have an unconstitutional ability to give tickets to anyone they
  choose.  (By the way, we don't recommend this defense :-) )
  ...
  was never considered in making this estimate.  He is sceptical that,
  ...
  to provide an intuitive explanation, which is not quantitative.
...
\begin{quote}
  ...
  way amounts to rolling a pair dice because and checking that double
  ...
  bunch of trips.  Now each pick is like rolling the die and checking
  against double sixes.

  Now everyone understands that if we keep rolling dice looking or double
  sixes, then the longer we roll, the closer the fraction of rolls that
  are not double sixes will be to 35/36.  Mathematical theory lets us
  calculate us how many times to roll the dice to make the fraction of
  nondouble sixes very likely close to 35/36, but we needn't go into the
