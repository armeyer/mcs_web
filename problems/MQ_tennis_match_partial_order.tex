...
means that the positive length walk relation, $L^+$, of $L$ is a
strict partial order.  Which of the partial order concepts listed
below correspond to the following properties of a stage of the
tournament:

Partial Order concepts:
\begin{itemize}
\item comparable, incomparable  %*
\item maximal, maximum  %*
\item minimal, minimum  %*
\item a chain,  an antichain %*
%\item a path-total order %*
