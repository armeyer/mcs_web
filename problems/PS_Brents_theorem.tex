...
\ppart\label{Mntp-possible} Show that \emph{every} DAG with $n$ vertices
and maximum chain size, $t$, has a $p$-processor schedule that runs in
time $M(n,t,p)$.
...
problem part~\rqref{Mntp-possible} holds for all positive integers,
$n,p$.
