...
\begin{pcomments}
  \pcomment{FP_sampling_concepts_S14}
  \pcomment{Forked from FP_sampling_concepts, CH May '14}
...
\begin{problem}
  ...
  Programmers at a company write a large program.  To
  ...
  independently (so it is possible that the same line of
  ...
  they will use the fraction of buggy lines in their \emph{sample} as their
  ...
  % are described in some of the statements below. 
  
Indicate which of these statements are true, and explain your answers
