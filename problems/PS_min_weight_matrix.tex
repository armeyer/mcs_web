...
\begin{problem}
  ...
  the successive edges in the walk.  The \term{minimum weight matrix} for length $k$ walks in an $n$-vertex
...
\begin{theorem*}\label{thm:weightmatrix-min+}
  ...
  then $W\minplusop M$ is the minimum weight matrix for length $k+m$
  walks.
\end{theorem*}
