...
\begin{pcomments}
  ...
  \pcomment{variant of FP_numbers_short_answer_F15}
...
\ppart If $a c \equiv b c \pmod{n}$ and $n$ does not divide $c$,

\noindent then $a \equiv b \pmod{n}$.
\hfill \textbf{true} \qquad \textbf{false} \examspace[0.4in]
...
\noindent  then $a \equiv b \pmod{n}$.  \hfill \textbf{true} \qquad
...
\noindent then $c^a \equiv c^b \pmod{n}$.  \hfill \textbf{true} \qquad
\textbf{false} \examspace[0.4in]
...
\noindent $[a \equiv b \pmod{m} \QAND\ a \equiv b \pmod{n}]$ iff $[a
  \equiv b \pmod{mn}]$ \hfill \textbf{true} \qquad
\textbf{false} \examspace[0.4in]
