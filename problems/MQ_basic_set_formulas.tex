...
\begin{problem}
\inhandout{A \emph{formula of \idx{set theory}} is a
...
members, here's how we can express equality of $x=y$ with a
formula of set theory:
\begin{equation}\label{x=xAz}
\forall z.\, (z \in x\ \QIFF\ z \in y).
\end{equation}}

Express the following assertions about sets by a formula of
set theory.
