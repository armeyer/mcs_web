...
of \emph{every} MST.  So use any black/white coloring which the
...
same-weight edges and among edges with the same weight, treating
higher rank vertices as having larger weight.  Since $e$ has
min-weight with no ties, it will be in every MST for each such
ranking, and therefore in all MST's with same-weights allowed.
\end{quote}


Second proof mimics the proof of the Gray Edge Swap
