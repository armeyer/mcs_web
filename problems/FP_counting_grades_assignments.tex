...
\begin{problem}
In $6.043$ there are $n$ students, who have distinct total scores.
$6.043$ staff needs to assign one of eleven letter grades \emph{A+, A,
  A-, B+, \dots, C-, D, F} to each student according to their
scores---that is, one student has a higher score than another, then
they cannot get a lower grade than the other.  How many grade
...
$\Zintv{1}{11}$.  We showed in class that there is a bijection between
