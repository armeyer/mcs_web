...
\begin{problem}
``Token Switching'' is a process for updating a set of black
...
\end{enumerate}
  ...
  We can model Token Switching as a state machine whose states are
  pairs $(b,w)$ of nonnegative integers, where $b$ equals the number
  of black tokens, and $w$ equals the number of white tokens.  So the
  start state is $(1,0)$.
