...
\begin{problem}
  Prove \emph{by induction} that every amount of postage of $12$ cents can
  be formed using 7 and 3 cent stamps. 
...
\begin{solution}
  ...
  \begin{proof}
    ...
    hypothesis
    \[
S(n) \eqdef  \text{exactly $n$ cents postage can be formed using 7 and 3 cent stamps}.
\]
