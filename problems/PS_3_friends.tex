...
2-colored triangles.  Conclude that there are at most eighteen
2-colored triangles.

\begin{solution}
The edges in a two 2set are edges of a unique 2-color triangle, so map
the set to the triangle.  Since the edge set of a 2-color triangle
...
2sets and hence at most $(6 \cdot 6)/2 = 18$ 2-colored triangles.
\end{solution}
