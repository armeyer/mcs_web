...
\ppart What is the value of $\phi(2)$? \hfill\examrule

\begin{solution}
$\phi(2) = 2^1 - 2^0 = 1$.
\end{solution}

\ppart What are three nonnegative integers $k>1$ such that $\phi(k) =
2$?  \hfill\examrule[0.75in]
