...
\hint Explain why $\binom{p}{k_1, k_2, \dots, k_m}$ is divisible by $p$ if
all the $k_i$'s are positive integers less than $p$.

\begin{solution}
  By the Multinomial Theorem~\bref{multinom-thm}, $(x_1 + x_2 + \cdots
  +x_n)^p$ is a sum of monomials in $x_1,\dots,x_m$ whose coefficients are
\[
...
\begin{solution}
  Let $x_1=x_2=\cdots x_m = 1$.  Then~\eqref{xp} implies $n^p \equiv
