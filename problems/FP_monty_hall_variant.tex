...
least $n$ times.  This probability goes to zero and $n$ goes to
infinity.
\end{solution}
...
\ppart What is the value of $\pr{W}$? \examrule[0.7in]
...
\inhandout{\ppart Let $R$ be the number of times the game is restarted before
Carol picks a goat.  What is $\expect{R}$? \hfill \examrule[0.8in]
