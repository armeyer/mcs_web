...
\begin{solution}
\[
\paren{1- \frac{1}{5}}\paren{1- \frac{1}{4}} = \frac{3}{5}
\]
\end{solution}
...
\begin{solution}
\[
\frac{1}{5}\paren{1- \frac{1}{4}} + \paren{1 - \frac{1}{5}}\frac{1}{4} = \frac{7}{20}.
\]
\end{solution}
...
\begin{solution}
\[
\frac{1}{4} + \frac{1}{5} - \frac{1}{4}\cdot \frac{1}{5} = \frac{2}{5}
\]
\end{solution}
...
that is, another proposition known to be false.
\end{solution}
...
\examspace[1.0in]
\[
2\paren{\paren{\frac{1}{2}}^3}^2 + 2\paren{3\paren{\frac{1}{2}}^3}^2= \frac{5}{16}
\]
...
\begin{solution}
\[
40160006 = \frac{(2+2\cdot 2002)(2002)}{2}
\]
\end{solution}
...
Specifically, $pq^2 > p^2q$ iff $q>p$, where $p$ is the probability of
Head and $q$ the probability of Tails.
\end{solution}
\eparts
