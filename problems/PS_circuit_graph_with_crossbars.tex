...
\begin{problem}
  ...
  Let $G$ be the graph formed from $C_{2n}$, the cycle of
...
%That is, opposite vertices are distance 1 apart in $G$.
  ...
  Suppose a path, $Q$, in $G$ begins with a crossing edge,
  then follows a walk, $P$, in $C_{2n}$ and ends with another
  crossing edge.  Replacing every vertex in $P$ by its opposite, you get
  a new walk in $C_{2n}$ between the endpoints of $Q$, but the new walk is
  two edges shorter than $Q$.  This implies that a \emph{shortest} walk in
