...
confidence level.  The editors and reviewers carefully check that any
trial whose results they publish was \emph{properly performed and
  accurately reported}.  They are also careful to check that trials
whose results they publish have been conducted independently of each
other.
...
\hint \href{http://xkcd.com/882/}{xkcd comic: ``significant''}
