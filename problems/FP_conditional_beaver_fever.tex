...
\begin{problem}
 ...
 think they're funny.
  ...
  So the description above explicitly gives the values of the
  quantities
   \[
   \pr{B}, \prcond{Y}{B},\text{ and } \prcond{\bar{Y}}{\bar{B}}.
   \]
...
solely in terms of the explicitly given quantities .  (Literally use the
expressions, not the numeric values, of the explicitly given quantities.)
