...
Answer the questions below using the four step method. Explicitly exhibit the tree,
assign probabilities to outcomes, and calculate the required probabilities. You can use
