...
\ppart The set of fractions of the form $n/(n+5)$:
\[
\frac05, \frac16 \frac27, \frac38, \dots.
\]
...
expressed in the form $n/(n+5)$.
\end{solution}

\ppart Let $W \eqdef \naturals \union \twodone$ be the set consisting
of the nonnegative integers along with all the fractions of the form
$n/(n+1)$.  Describe a length 5 decreasing sequence of 5 elements of
$W$ starting with 1,\dots length 50 elements,\dots length 500.
...
well ordered, every decreasing sequence in $W$ starting at 1 is finite
---since the elements in any infinite decreasing sequence would be a
subset with no minimum element.
