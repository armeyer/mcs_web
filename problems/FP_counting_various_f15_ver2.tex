...
from the position $(20,20)$ to the position $(80, 80)$ if he makes exactly $20$ diagonal
...
\begin{solution}
A set of strings of length $100$ with exactly
$20$ 0's, $40$ 1's and $40$ 2's.
The robot will make exactly $20$ diagonal steps, which implies that it will
make exactly $40$ steps along the first coordinate, and $40$ steps along
...
\begin{solution}
$\binom{100}{20,40,40}$, which is the number of strings of
$20$ 0's, $40$ 1's and $40$ 2's.
\end{solution}
\end{enumerate}
...
to split $100$ students in 6.042 into $10$ groups of $10$ students.
Zoran naively says the answer is $(100)!$ with the following
justification: for any permutation of students, groups can
be formed by taking the first $10$ students as one group,
the next $10$ students as another group, etc.
Albert responds -- ``That is totally wrong! Your mapping
between permutations of numbers $1,\ldots,100$ and
splittings into $10$ groups is not a bijection!'' %... er... \underline{\hspace{2cm}}''.
...
\begin{solution}
$(10!)^{11}$.
For each permutation of $10$ students within each group,
as well as each permutation of $10$ groups, a different permutation of
$100$ students is obtained that is mapped to a same set of groups. %splitting into teams. %group splitting.
