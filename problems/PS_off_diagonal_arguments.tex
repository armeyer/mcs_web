...
$K$ of nonnegative integers $k$ for which $t_{2k+1}$ is a 1.  This
...
a sequence not in $S$ that has a \emph{negligible number of non-2
  elements}.
...
$k^2$, and it has a negligible number of non-2's because among the
