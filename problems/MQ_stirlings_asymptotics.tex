...
\]
We can now take logarithms (see Problem~\ref{MQ_asymptotics_and_logs})
to get:

\begin{align*}
\ln(n^2!)
    & \sim \ln\paren{\sqrt{2 \pi n^2} \left(\frac{n^2}{e}\right)^{n^2}} \\
    & = \ln(\sqrt{2 \pi n^2}) + \ln\paren{\frac{n^2}{e}}^{n^2} \\
