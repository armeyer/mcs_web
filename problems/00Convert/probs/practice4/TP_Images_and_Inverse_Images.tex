...
\ppart
Let $\mathcal{V}$ be the relation with domain the integers from 7 to~15 and codomain
...
Here are some assertions about images under a binary relation $\mathcal{R}:A \to B$:
\begin{align}
