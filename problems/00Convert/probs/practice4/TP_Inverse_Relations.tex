...
\ppart $R$ is a function iff $\inv{R}$ is \examrule.

\begin{solution}
an injection.
\end{solution}

\ppart $R$ is a surjection iff $\inv{R}$ is \examrule.
...
\ppart
$R$ is an injection iff $\inv{R}$ is \examrule.

\begin{solution}
a function.
\end{solution}

\ppart $R$ is a total iff $\inv{R}$ is \examrule.
...
\ppart
$R$ is a function iff $\inv{R}$ is \examrule.
