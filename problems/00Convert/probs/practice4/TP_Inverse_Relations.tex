...
\ppart $R$ is a function iff $\inv{R}$ is \brule.

\begin{solution}
an injection.
\end{solution}

\ppart $R$ is a surjection iff $\inv{R}$ is \brule.
...
\ppart
$R$ is an injection iff $\inv{R}$ is \brule.

\begin{solution}
a function.
\end{solution}

\ppart $R$ is a total iff $\inv{R}$ is \brule.
...
\ppart
$R$ is a function iff $\inv{R}$ is \brule.
