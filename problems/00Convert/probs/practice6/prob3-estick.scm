...
amount. Therefore predicates (1) and (2) are preserved invariants.  In contrast, the
...
At the end of the process every square is separated, since otherwise, more cuts could be performed.  So <i>p=mn</i>." )));!
  ...
  <li> <i>s</i> = <i>mn</i> + 1
      ...
      (questions
       (! "" (answer (1) (compare test-set)
(rationale
"By Part 1, <i>s=p-1</i> is a preserved invariant. Moreover, it is true at the
...
<i>p=mn</i>. Substituting in the preserved invariant, we get <i>s=mn-1</i>."
        )));!
       );questions
      );prob
     );subproblems
