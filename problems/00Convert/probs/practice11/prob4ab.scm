...
(define-problem
    '(
      ...
      (intro "<strong>Bruce Lee, on a movie that didn't go public, is practicing 
...
not 1), and he breaks each board independently.</strong>")
      (box-width 50)
      (questions
       (! "<strong>What is the probability that Bruce breaks exactly 2 out of the 5 boards 
that are placed before him? <br>
(Your answer can be an infix expression such as <tt>(3! * 4!)^2 + 5</tt>.)</strong>"
...
C(5,2) &middot; (0.8)<sup>2</sup> &middot; (0.2)<sup>3</sup>
       ...
       (! "<strong>What is the probability that Bruce breaks at most 3 out of the 5 boards 
that are placed before him? <br>
(Your answer can be an infix expression such as <tt>(3! * 4!)^2 + 5</tt>.)</strong>"
