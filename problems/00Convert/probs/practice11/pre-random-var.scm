...
(define-problem
    '(
      ...
      (intro "<strong>Here is a process to construct a random number: first,
...
<p> Let <em>N</em> be the number that you return.  <br>Let <em>F</em> be 1
or 0 indicating whether the first coin flip (the one with the biased coin)
came up heads.</strong>")
