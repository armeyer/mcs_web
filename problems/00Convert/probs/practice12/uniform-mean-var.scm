...
(define-problem
  '(
    ...
    (intro 
"<strong>Let <em>X</em> be a random variable with uniform distribution over
...
Give you answer as a sequence of numbers separated by spaces (e.g., \"6 2 4\").</strong>"
)
    (questions
