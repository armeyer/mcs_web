...
(define-problem
  '(
    ...
    (intro "For each of the following relations &#65293; the first three
are on the set {1,2,3,4} &#65293; indicate whether it is <b>r</b>eflexive,
<b>i</b>rreflexive, <b>s</b>ymmetric, <b>a</b>ntisymmetric, or
<b>t</b>ransitive by entering a sequence of the letters <b>r i s a t</b>
(in any order, but without commas or quotes).")
