...
\item[\ \textbf{V}:]\ \ \textbf{V}oldemort is released.

\item[\textbf{``F''}:] The guard tells Voldemort that \textbf{F}oo Foo will be released.

\item[\textbf{``S''}:] The guard tells Voldemort that \textbf{S}auron will be released.
...
which outcomes in the the events $V$, ``F,'' and ``S.''
...
because
\[
\prcond{V}{\text{``F''}} = \frac{ \pr{V \QAND \text{``F''} }}{ \pr{\text{``F''}} }
...
\frac{2}{3}
 ...
 & = \frac{1}{2}\frac{2}{3} + 1 \cdot \frac{1}{3}\\
