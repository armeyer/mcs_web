...
\begin{solution}
$$P[\texttt{released} | \texttt{says foofoo} ] = \frac{ \texttt{released}\intersect \texttt{says foofoo} }{ \texttt{says foofoo} } = $$\\
...
\begin{solution}
$$P[\texttt{released} | \texttt{says sauron} ] = \frac{ \texttt{released}\intersect \texttt{says sauron} }{ \texttt{says says sauron} } = $$\\
$$\frac{ 1/3 }{ 1/3 } = 1$$ 
\end{solution}
