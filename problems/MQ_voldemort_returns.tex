...
\begin{align*}
\prob{\texttt{V released}} & = \prcond{\texttt{V released}}{\texttt{says
    foofoo}} \cdot \prob{\texttt{says foofoo}}\\
                         & \quad + 
\prcond{\texttt{V released}}{\texttt{says sauron}} \cdot
\prob{\texttt{says sauron}}\\
              & = 
\end{align*}
\end{solution}
\end{problemparts}
