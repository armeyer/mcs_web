...
\begin{pcomments}
  ...
  \pcomment{strengthened using congruences in CP_congruence_no_prime_polynomial}
...
infinitely many $q(n) \in \integers$ that are not primes.%
\index{prime}
...
\ppart Conclude that for every nonconstant polynomial $q$
there must be an $n \in \nngint$ such that $q(n)$ is not prime.
