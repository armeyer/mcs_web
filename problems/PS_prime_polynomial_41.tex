...
\begin{staffnotes}
(Spring 2011) This part of the problem was modified to make them prove there are \emph{infinitely} many non prime integers in the image of the polynomial, but originally only required them to show at least one exsits. Do \emph{not} penalize them in the grading if they proved the weaker claim.
\end{staffnotes}
