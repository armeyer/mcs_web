...
\[
a \mrel{S \compose R} c \QIFF \exists b.  a \mrel{R} b \QAND
b \mrel{S} c.
\]
If we represent relations as matrices,
%need to explain how; this is not in text
...
\begin{description}
\item[Case 1:($\QIMPLIES$)] If $(i, j) \in S\circ R$, then for
...
$k$, say $k'$,  for which $\left[M_R(i,k') \QAND
...
of composition, $(i,j)\in S\compose R$ 
\end{description}
