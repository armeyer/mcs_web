...
\begin{problem}
  ...
  connection to \emph{\idx{relational databases}}, a very popular
  software application building block implemented by such software
  packages as \idx{MySQL}.  This problem explores the connection by
  ...
  \item A binary relation $L$ (for \emph{link}) over pages, defined
    such that $p_1 L p_2$ iff page $p_1$ links to $p_2$
  ...
  \item And one extra: \emph{relational composition} which generalize
