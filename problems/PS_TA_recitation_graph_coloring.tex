...
% Problem starts here
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\TAonename}{Ali}
\newcommand{\TAtwoname}{Oshani}
\newcommand{\TAthreename}{Henrique}
\newcommand{\TAfourname}{Subha}
\newcommand{\TAfivename}{Radhika}
\newcommand{\TAsixname}{Becky}
\newcommand{\TAsevenname}{Oscar}
\newcommand{\TAeightname}{Nick}
\newcommand{\TAninename}{Kyle}
