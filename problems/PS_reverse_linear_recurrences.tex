...
\end{equation}
for some $c_i \in \nngint$ and all $n \geq d$ is called a \emph{degree
  $d$ linear-recursive}.
...
\begin{solution}
First substitute $n+1$ for $n$ and then $k+1$ for $k$ in
...
reverse-linear function and $f(k) = 0$ for some $k \in \Zintvco{0}{d}$, then
