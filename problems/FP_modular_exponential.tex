...
\ppart[1] What is the probability that an  integer from 1 to 360 selected
with uniform probability is relatively prime to 360? \hfill \examrule[0.75in]

\iffalse
What is the value of $\phi(360)$, where $\phi$ is Euler's
function? \hfill\brule{4em}
\fi
...
\begin{solution}
\[
\frac{\phi(360)}{360}= \frac{4}{15}.
\]
Since $360=2^3\cdot3^2\cdot5$, it follows that $\phi(360)=4\cdot6\cdot4=96$.
\end{solution}

\ppart[2] What is the value of $\rem{7^{98}}{360}$? \hfill\examrule[0.75in]
