...
\begin{pcomments}
    \pcomment{FP_basic_set_formulas}
    \pcomment{excerpt of TP_basic_set_formulas}
...
set theory\inbook{\footnote{See Section~\bref{ZFC_sec}.}}, where each
answer may use abbreviations introduced earlier (so it is now legal to
use ``$=$'' because we just defined it).
