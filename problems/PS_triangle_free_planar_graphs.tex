...
\begin{problem} A simple graph is \emph{triangle-free} when it has no simple
cycle of length three.

\bparts

\ppart\label{e2v4} Prove for any connected triangle-free planar graph
with $v>2$ vertices and $e$ edges, $e \leq 2v - 4$.
...
\mbox{}
  ...
  \textbf{base case:} A planar graph with a single vertex is trivially
  connected, triangle-free and 1-colorable.

  \textbf{inductive step:} Any connected triangle-free planar graph
