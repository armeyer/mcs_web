%PS_Euler_function_multiplicativity
%formerly called PS_distributive_law_for_phi
...
\href{http://www.cut-the-knot.org/blue/chinese.shtml}
{\texttt{http://www.cut-the-knot.org/blue/chinese.shtml}}.}
...
$k-1$ that are relatively prime to $k$.  Conclude from part~\eqref{uniq} that
the function
\[
