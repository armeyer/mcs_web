...
\begin{solution}
\[
\pr{H > a/p} =  \sum_{k >a/p} (1-p)^{k-1}p = p(1-p)^{\floor{a/p}} \sum_0^{\infty}
(1-p)^j = p(1-p)^{\floor{a/p}}\cdot\frac{1}{1-(1-p)} = (1-p)^{\floor{a/p}}.
\]
So
\[
\pr{H > a/p} \leq (1-p)^{(a-p)/p} = \paren{(1-p)^{1/p}}^{a-p} <
