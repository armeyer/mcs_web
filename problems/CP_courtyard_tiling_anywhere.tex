...
\begin{pcomments}
  \pcomment{CP_courtyard_tiling_anywhere}
...
\times 1$ statue of Bill in \emph{any position} can be covered with
$L$-shaped tiles.
...
\ppart \emph{(Discussion Question)} In part~(a) we saw that it can be
...
to prove the conclusion $P(n+1)$ of the induction step.
\end{solution}
