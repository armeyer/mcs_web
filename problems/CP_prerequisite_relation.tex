...
\ppart Describe a collection of sets partially ordered by the proper
subset relation, $\subset$, that is isomorphic to (``same shape
as'') the prerequisite relation among MIT subjects from
...
subset relation that is isomorphic to the empty relation on 5 elements
---that is, the relation under which no element is related to
anything.
