...
& \qiff x \in A & \text{(since $P \QOR (Q \QAND P)$ is equivalent to $P$).}
\end{align*}
...
\[
x \in \bar{A-B} \qiff
x \in \paren{\bar{A}-\bar{C}} \union \paren{B\intersect C} \union
      \paren{\paren{\bar{A}\union B}\intersect\bar{C}}.
\]
...
\lefteqn{x \in \bar{A-B}}\\
 & \qiff \QNOT\paren{x \in \paren{A\intersect\bar{B}}}\\
 & \qiff \QNOT\paren{x \in A \QAND x \in \bar{B}}\\
 & \qiff \QNOT\paren{x \in A \QAND \QNOT\paren{x \in B}}\\
 & \qiff \QNOT\paren{P \QAND \QNOT\paren{Q}}
\end{align*}
Then express membership in
\[
\paren{\bar{A} - \bar{C}} \union \paren{B \intersect C} \union
\paren{\paren{\bar{A}\union B} \intersect \bar{C}}
\]
