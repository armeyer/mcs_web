...
What is $\expect{I_T}$? \brule{0.75in}

What is $\variance{I_T}$?  \brule{0.75in}
...
$I_{T'}$ are independent.  Suppose that $r = 1/2$ and $T$ and $T'$ do
share an edge.  Show that $I_T$ and $I_{T'}$ remain independent in
this case.
