...
\begin{pcomments}
  \pcomment{CP_partial_order_on_power_setb}
  \pcomment{subsumes CP_subset_relation_on_power_set}
...
\begin{problem}
The proper subset relation, $\subset$, defines a strict partial order
on the subsets of $\Zintvcc{1}{6}$, that is $\power(\Zintvcc{1}{6})$.
