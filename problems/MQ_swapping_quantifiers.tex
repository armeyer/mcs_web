...
One of the implications below is invalid.  Circle it, and provide a
counter model for it with domain of discourse $D \eqdef \set{\True,
  \False}$.  You do not need to explain your answer.
\begin{align}
