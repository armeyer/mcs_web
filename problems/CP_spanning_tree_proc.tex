%CP_spanning_tree_proc
%subsumes CP_Mark_a_spanning_tree
...
\begin{enumerate}
\item If an edge $\edge{u}{v}$ of $G$ is on a cycle, then delete
  $\edge{u}{v}$.
...
\ppart Conclude that the procedure terminates.
