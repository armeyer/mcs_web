...
matching.  Briefly explain why it works.
...
(Theorem~\bref{boyopt}).  If every boy's optimal and pessimal choices
are the same, then this is the only possible stable spouse for the
boy.  So the solution is unique.
