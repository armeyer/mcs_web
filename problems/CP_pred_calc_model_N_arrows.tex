...
famous mathematical problems---the Goldbach or the Twin Primes
Conjectures, for example---can easily be expressed in predicate logic
using a symbols $\nextsym,\prevsym$ along with symbols for plus and
times (see Problem \bref{CP_express_goldbach_twinprime_in_logic}).  So
it is not surprising that, in general, it is very hard\footnote{In
