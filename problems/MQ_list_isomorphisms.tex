...
\pcomment{CP_list_isomorphisms is same but does not give number of isomorphims}
...
\begin{problem}
  There are four isomorphisms between the two graphs give in
  Figure~\ref{iso_graphs_S12_cp7w}. List them.
...
to exactly the degree-3 nodes, so the ismorphism must divide 1 and 2
