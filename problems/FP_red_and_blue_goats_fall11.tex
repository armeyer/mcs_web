...
\begin{problem}
  ...
  different rules using two goats, one red and one blue.  There
  are three doors, with a prize hidden behind one of them and the
  goats behind the others.  No doors are opened until the contestant
  makes a final choice to stick or switch.  The contestant is allowed
  ...
  switch to either of the other doors.  \iffalse
