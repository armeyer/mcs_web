...
\begin{problem} The method of partial fractions can only be applied to
  rational functions (i.e. quotients of polynomials) and there are many
  interesting generating functions that are not of this form.  Catalan
  numbers come up frequently in counting the sizes of various recursively
  defined sets -- there are in fact hundreds of interpretations of these
