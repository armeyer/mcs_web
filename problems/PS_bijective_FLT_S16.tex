...
\ppart\label{countak} How many length-$k$ strings $a$ are there? \hfill\examrule
\begin{solution}
$a^k$.
\end{solution}
...
\begin{solution}
\TBA{fill in.  proof by induction on length $x$ is another approach.}
\end{solution}
...
$z$ is equivalent under $\approx$ to exactly $p$ other strings.
