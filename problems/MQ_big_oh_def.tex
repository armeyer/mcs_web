...
\problempart $f(n) = 2^n, g(n) = n^4\ln{n}$\\\\
$c =$ \brule{.5in}, $n_0$ = \brule{0.5in}
\examspace[2.5in]

\begin{solution}
Polynomials are $o()$ of exponentials, no matter what the base is. Hence we will not be able to find any finite $c$ like we would like to.
So the answer is  $c = \infty$, $n_0 = \infty$.
\end{solution}
