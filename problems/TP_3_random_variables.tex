...
\begin{pcomments}
  ...
  \pcomment{trivial instance of CP_max_ranvar_n}
...
\begin{problem}
Suppose $R$, $S$ and $T$ be mutually independent random variables on
the same probability space with uniform distribution on the range
$\set{1,2,3}$.  \iffalse
\[
