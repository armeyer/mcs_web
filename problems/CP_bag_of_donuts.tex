...
\ppart The donuts must be chocolate, glazed, coconut, or plain with
...
withj these constraints is the product of the preceding generating
functions:
...
\ppart\label{bagplast} Find a closed form for the number of ways to
select $n$ donuts subject to the constraints of the previous part.
