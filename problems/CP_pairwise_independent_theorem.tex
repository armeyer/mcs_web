...
\[
\Variance{\frac{A_n}{n}} \leq \frac{b}{n}.\label{Anv}
\]
because
\begin{align*}
\Variance{\frac{A_n}{n}} & =  \paren{\frac{1}{n}}^2 \variance{A_n}
          & \mbox{(by Theorem~\bref{var.const})}\\
...
\begin{align*}
\Prob{\abs{\frac{A_n}{n} - \mu_n} \geq \epsilon}
    & \leq \frac{\Variance{A_n/n}}{\epsilon^2}.
