...
\begin{pcomments}
  ...
  \pcomment{CH Spring '14; edited ARM 4/1/14}
\end{pcomments}
...
endpoints of the edge.  \iffalse For example, if $G$ is a 4-vertex
tree, then its degree sequence is either $\ang{1,1,1,3}$ or
$\ang{1,1,2,2}$.  \fi
