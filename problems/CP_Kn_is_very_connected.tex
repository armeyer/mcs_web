...
\begin{pcomments}
  \pcomment{CP_Kn_is_very_connected}
...
\begin{proof}
  ...
  between $u$ and $v$, namely the $n-2$ length 2 paths above and the
...
\ppart Draw a picture of $M_3 (\dots M_4)$.

\begin{staffnotes}
If one of your teams comes up with a nice picture, ask if one of them
would volunteer to redraw it and send us an electronic copy that we
can use for the missing solution below.
\end{staffnotes}
