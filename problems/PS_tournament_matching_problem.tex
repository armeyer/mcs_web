...
\card{D} = 2m-1 < 2m = \card{\neighbors{D}}
\]
and~($D\leq N$) holds.  On the other hand, suppose there is a team $t$ that
...
\]
since $W_t \subseteq \neighbors{D}$.  Again~($D\leq N$) holds.  

So~($D\leq N$) holds in any case, and we conclude by Hall's Theorem that
