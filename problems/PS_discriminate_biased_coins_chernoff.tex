...
So, for the required confidence level, we require that \[ (0.986)^n
\leq 0.05, \] namely, $n \geq 220$, which is a modest improvement
over the estimate of $279$ flips obtained using the Chebyshev Bound.
