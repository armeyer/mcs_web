...
Section~\ref{infinite_repeat_subsec}, you keep tossing until you get a
long run of tails, but this time let ``long run'' mean a run of tails
that is with 10 of the length your initial run.  Prove that the
expected number of times you toss a head and start over is still
infinite.
