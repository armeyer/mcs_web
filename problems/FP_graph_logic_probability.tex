...
\begin{itemize}
\item $P(x,y) \eqdef \exists z.\ E(x,z) \land E(y,z)$
\vspace{0.15in}
\item $P(x,y) \eqdef x \neq y \land \exists z.\ E(x,z) \land E(y,z)$
\vspace{0.15in}
\item $P(x,y) \eqdef \forall z.\ E(x,z) \lor E(y,z)$
\vspace{0.15in}
\item $P(x,y) \eqdef \forall z.\ x \neq y \implies [E(x,z) \lor E(y,z)]$
\end{itemize}

\begin{solution}
$P(x,y) \eqdef \exists z.\ E(x,z) \land E(z,y)$
\end{solution}
...
\vspace{0.15in}
\item\label{wz-indep} $\paren{E(w,x) \land E(w,y)}$ versus
      $\paren{E(z,x) \land E(z,y)}$
\insolutions{\textbf{TRUE}}
\vspace{0.15in}
...
\begin{align*}
\pr{\text{not } P(x,y)}
  & = \pr{\Land_{z \in Z} \bar{E(x,z) \land E(y,z)}} & \\
  & = \prod_{z \in Z} \pr{\bar{E(x,z) \land E(y,z)}} &
...
$x$ and $y$ lie on a three-cycle iff $E(x,y) \land
P(x,y)$.

Since $E(x,y)$ and $P(x,y)$ are independent,
\begin{align*} 
\pr{E(x,y) \land P(x,y)} & = \pr{E(x,y)} \cdot \pr{P(x,y)} \\
                        & = p (1-r) .
\end{align*}
Substituting in for $r$ (not asked), we get
\[\pr{E(x,y)\land P(x,y)} = p (1-(1-p^2)^{n-2}).\]
\end{solution}
