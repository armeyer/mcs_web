...
game.  Indeed, we showed in problem~\bref{CP_conditional_convergence}
that by reordering its terms, the series can be made to converge to
any real value or diverge to $\pm\infty$.
\end{solution}
