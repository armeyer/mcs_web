...
\hint By cases: whether $R$ and $S$ are both \texttt{0}-finite,
whether $R$ or $S$ contains no all-\texttt{0} words at all (including
...
either, which means it is \texttt{0}-finite and boring.
...
\cdot S$ is \texttt{0}-finite and therefore is boring.
...
So we have proved that the set of even length all-\texttt{0} words is
not a c-d set.
