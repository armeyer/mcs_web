...
\begin{pcomments}
  \pcomment{FP_check_factor_by_digits_proof_conflict}
  \pcomment{virtually same as FP_check_factor_by_digits_proof}
...
\begin{staffnotes}
parts a,b,c,d worth 2,3,5,3 points.
\end{staffnotes}
...
\ppart Prove conversely, that if $k$ is good for some base $b \geq 2$,
then $b \equiv 1 \pmod k$.

\iffalse TYPO USED ON EXAM:
...
\ppart Exactly which integers $k>1$ are good moduli for base 85?
