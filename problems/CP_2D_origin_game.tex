...
\begin{problem}\label{nngame}
  ...
  In the \emph{2D Origin Game}, two players make alternate moves in a
...
\textbf{Strategy 1:} The first player starts with $(1,1)$.  Then the
...
\textbf{Strategy 2:} The second winning strategy is slightly more tricky:
