...
\begin{pcomments}
  ...
  \pcomment{superset of MQ_covering_edges}
...
\item  % \index{directed graph!complete digraph|textbf}

The \emph{complete digraph} without self-loops on vertices $1,2,3$ has
directed edges in each direction between every two distinct vertices.
What are its covering edges?
...
\ppart Explain in one (maybe two) sentences why the \idx{positive walk
  relation} of $D$ is a strict partial order.
