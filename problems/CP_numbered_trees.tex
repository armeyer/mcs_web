...
the leaves of the tree.  This follows because numbers in the code are
precisely the fathers of vertices that get deleted, and both vertices
left at the end of the process have become leaves.
