...
\begin{pcomments}
  ...
  \pcomment{subsumed by PS_alphabet}
\end{pcomments}
...
so that there are \emph{at least two} consonants immediately following
each vowel?
...
\ppart How many different solutions over the nonnegative integers are
