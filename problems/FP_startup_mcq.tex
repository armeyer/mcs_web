...
\begin{pcomments}
  ...
  \pcomment{BUGGY: do not use ARM 11/17/17}
...
\begin{problem}
You want to choose a team of $m$ people from a pool of $n$ applicants,
and from these $m$ people you want to choose $k$ to be the team
managers.  You know you can do this in
\[
\binom{n}{m}\binom{m}{k}
\]
ways.  
...
he has an equivalent combinatorial formula.  He gives you a bijection
...
\ppart \inhandout{Circle }\inbook{Indicate} the formula that matches
the description given by your competitor.
