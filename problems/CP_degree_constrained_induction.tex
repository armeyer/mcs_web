...
For example, if $G$ is a balanced graph with vertex degree 3 and $2k$
...
matching.  That is, two edges in the same block never incident to the
same vertex.

\begin{staffnotes}
\hint Induction on degree.

\ARM{I don't see a way to do this by induction on number of vertices.}
\end{staffnotes}
