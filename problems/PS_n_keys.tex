...
\begin{problem}
A man has a set of $n$ keys, one of which is for opening the door to his apartment.
He tries the keys until he finds the right one.  Give the expectation
and variance of the number of keys he has to try, when:
...
\ppart he chooses keys randomly among the ones that he has not yet tried.
