...
For each of the binary
  relations below, select any of the properties terms that apply to it
  (to add: multiple choice reflexive, transitive, symmetric,
  anti-symmetric, strict partial, weak partial)
