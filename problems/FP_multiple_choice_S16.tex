...
\textbf{\large Circle \True\ or \False\ for the statements below, and
...
\item If $a,b >1$, then
 ...
 [$a$ has a multiplicative inverse mod $b$ iff $b$ has a
   multiplicative inverse mod $a$].  \hfill \True \qquad
...
\item Any connected subgraph is a tree.  \hfill \True \qquad
  \False \examspace[0.4in]
...
\item Adding an edge between two nonadjacent vertices creates a
  cycle. \hfill \True \qquad \False \examspace[0.4in]
...
\item Any subgraph of a tree is a tree.  \hfill \True \qquad
  \False \examspace[0.4in]
...
\item The number of vertices in a tree is one less than the number of
  edges.  \hfill \True \qquad \False \examspace[0.4in]
...
\begin{itemize}
\item  It has a spanning tree.  \hfill \True \qquad
  \False \examspace[0.4in]
...
\item $\card{\vertices{G}} = O(\card{\edges{G}})$ for connected $G$.  \hfill \True \qquad
  \False \examspace[0.4in]
...
\item $\card{\edges{G}} = O(\card{\vertices{G}})$.  \hfill \True \qquad
  \False \examspace[0.4in]
...
\item The chromatic number $\chi(G) \leq \max\set{\degr{v} \suchthat
  v \in \vertices{G}}$.  \hfill \True \qquad
  \False \examspace[0.4in]
...
\item The chromatic number $\card{\edges{G}} = O(\chi(G))$.  \hfill \True \qquad
  \False \examspace[0.4in]
...
\ppart \textbf{Circle all the properties below that are preserved
...
edges leaving it.  \textbf{Circle whichever of the following
  assertions are true of stable distributions} on random walk graphs
with exactly two sinks:
