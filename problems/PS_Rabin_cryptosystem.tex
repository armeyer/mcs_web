...
\equiv 3 \pmod{4}$.  To send the message $x$, send
$\rem{x^2}{N}$.\footnote{We will see soon, that there are other
...
\ppart\label{peqv34} Suppose that $p$ is a prime such that $p \equiv 3 \pmod{4}$.  It
