...
\begin{problem}
  The $n$-input \emph{\idx{2-D Array}} network was shown in class to have congestion 2.  An $n$-input \term{2-Layer
    Array} consisting of two $n$-input 2-D Arrays connected as pictured
  below for $n=4$.
