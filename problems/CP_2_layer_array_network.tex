...
\begin{problem}
  The $n$-input \emph{\idx{2-D Array}} network was shown in of
  Chapter~\bref{2Darray} to have congestion 2.  An $n$-input \term{2-Layer
    Array} consisting of two $n$-input 2-D Arrys connected as pictured
  below for $n=4$.

  \begin{center}
  \includegraphics[width=2.25in,clip]{figures/2-layer-grid-new.pdf}
  \end{center}
