...
set of $n$ distinct vertices?\footnote{From
  \href{https://en.wikipedia.org/wiki/Double\_counting\_\%28proof\_technique\%29\#Counting\_trees}
       ...
       \href{https://en.wikipedia.org/wiki/prufer\_sequence}{Pr\"ufer
         Sequences}}  Cayley's formula gives the answer $T_n
= n^{n - 2}$.  One way to derive this appears in
Problem~\bref{CP_numbered_trees}.  This and three additional
derivations are given by Aigner \& Ziegler (1998), who comment that
``the most beautiful of them all'' is a counting argument due to Jim
Pitman that we now describe.
