...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{problem}
  Because of the incredible popularity of 6.042, Rajeev decides to give up
  on regular office hours.  Instead, each student can join some study
  groups.  Each group must choose a representative to talk to the staff,
  but there is a staff rule that a student can only represent one group.
  The problem is to find a representative from each group while obeying
  the staff rule.
...
\begin{solution}
  ...
  is at most 4, so the graph is \emph{degree-constrained} (see the
