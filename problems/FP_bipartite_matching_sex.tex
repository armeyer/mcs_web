...
%\ppart\label{partner-ratio}
 ...
 information on average numbers of partners (no explanation is
 required):
...
female's average, so $f/m = 1.15$ which implies~\eqref{mf/115} and the
equivalent assertion~\eqref{mf2023}.

Also, since there are more females than males,~\eqref{no-female-match} holds.
