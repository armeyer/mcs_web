...
\end{equation}
\inbook{using the method of Section~\bref{} of the text.}\inhandout{
  by reducing the set-theoretic equality to a valid propositional
  formula, as in the text.}
...
\begin{solution}
The following hint is not included in the problem statement itself.\\
\hint $P \QOR Q \QOR R$ is equivalent to
\[
(P \QAND \bar{Q}) \QOR (Q \QAND \bar{R}) \QOR (R \QAND \bar{P}) \QOR (P \QAND Q \QAND R).
\]
