...
\begin{solution}
As in part~\ref{threey}, it is even easier to write a formula,
...
\problempart Write a formula of set theory that
means that two sets are equal if they have the same
elements (this is the first axiom of Zermelo-Fraenkel set
theory, called the Axiom of extensionality).

\begin{solution}
$\forall x\forall y(\forall z(z \in x \QIFF z \in y) \QIFF x = y)$
\end{solution}
