...
\begin{problem}
  ...
  \begin{tabular}{cc}
    \includegraphics[height=1in]{figures/sttnry0.pdf}
    & \includegraphics[height=1in]{figures/sttnry1.pdf} \\
    \includegraphics[height=1in]{figures/sttnry2.pdf}
    & \includegraphics[height=1in]{figures/sttnry3.pdf} 
  \end{tabular}
