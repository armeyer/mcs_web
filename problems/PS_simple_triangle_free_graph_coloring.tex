...
\begin{problem} 
A simple graph is \emph{triangle-free} if it has no subgraphs 
isomorphic to $K_3$.

\begin{problemparts}

\problempart
\label{e2v4} While a triangle-free graph is not necessarily bipartite, 
...
\problempart
\label{triangle-free} Show that any connected triangle-free planar 
...
\problempart
Prove by induction on the number of vertices that any connected 
