...
On May 19, 2013, the MIT fabrication facility produced a large batch
of silicon wafers.  To estimate the fraction $d$ of defective wafers
in this batch, we will take a small sample of wafers from the batch,
chosen randomly and independently.  Then we will test the chosen
wafers for defects, and will estimate that $d$ is approximately the
same as the fraction of defective wafers in the sample.
