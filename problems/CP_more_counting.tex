...
The number of paths through $(10, 10)$ is the number of paths from
$(0,0)$ to $(10,10)$ times the number of paths from $(10,10)$ to
$(20,30)$.
\end{solution}
...
$P - (N_1 \union N_2)$ is the set of paths to be counted.
\begin{align*}
