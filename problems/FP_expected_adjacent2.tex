...
Therefore,
\[
\pr{\text{4th, 5th and 6th cards match}}= \prcond{\text{card 6 matches card 4}}{\text{card 5 matches card 4}}\cdot \pr{\text{card 5 matches card 4}} = \frac{2}{16\cdot 17}.
\]
\end{solution}
...
The probability of a matching triple at any of the first 16 positions
is $p$ and therefore the expected number is also $p$.  Of course a
matching triple cannot begin the 17th or 18th position.  So by
linearity of expectation, the expected number of matching triples is
the sum of the expected number at each of the first 16 positions.
\end{solution}
