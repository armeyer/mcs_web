...
\begin{pcomments}
  ...
  \pcomment{part (a) SAME AS CP_structural_induction_rational_composition}
...
of such functions.  Corresponding identities hold for the other constructor
...
key observation on which the proof hinges.
...
$\circledast$, breaks down for composition on the right.  For example,
\[
