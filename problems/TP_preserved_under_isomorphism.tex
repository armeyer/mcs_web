...
\begin{staffnotes}
If need be, remind students that edges are sets of size 2.
\end{staffnotes}
...
Since no set of size 2 can be a subset of an\emph{other} subset of
size 2, item~\eqref{edgesubset} property is always false and so is
preserved vacously.
