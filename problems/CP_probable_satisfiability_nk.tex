...
Let $\clauses$ be a sequence of $n$ distinct $k$-clauses involving $v$
...
\ppart What is the probability that the last $k$-clause in $\clauses$
...
\begin{solution}
  ...
  making $> n-1$ of the clauses true, that is, an assignment for which
