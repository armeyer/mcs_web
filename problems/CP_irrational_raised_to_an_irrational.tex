...
true\footnote{The number $\sqrt{2}^{\sqrt{2}}$, known as the
  ...
  (which not only implies that it is not rational, but also implies that
  it is not even the root of any polynomial with rational coefficients)
  by Rodion Kuzmin in 1930. In 1934, Aleksandr Gelfond~\cite{Gelfond34} proved
  the more general Gelfond-Schneider theorem, which states that for any
  $\alpha \not\in \{0, 1\}$ and $\beta \not\in \mathbb{Q}$,
