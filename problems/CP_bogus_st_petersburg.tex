...
\begin{pcomments}
  \pcomment{CP_bogus_st_petersburg}
  \pcomment{NOT READY: draft added by ARM 4/15/11}
  \pcomment{may be subsumed by PS_fair_martingale}
  \pcomment{need to update to martingale language}
\end{pcomments}
...
diverge, so better to revise to be a fair roulette wheel as was
