...
\begin{solution}
Fix the middle vertex $v$.  Suppose $v$ is adjacent to $r$ vertices through a red
...
and every 2-colored triangle maps to exactly 2 such triples.  Therefore,
there are at most eighteen 2-colored triangles.  The total number of
triangles is $\binom{6}{3} = 20$, and therefore $K_6$ contains at least
$20 -18 = 2$ monochromatic triangles.  So in fact, we have proved
