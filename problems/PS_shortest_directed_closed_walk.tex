...
\begin{pcomments}
  \pcomment{PS_shortest_directed_closed_walk}
...
As in Figure~\ref{fig:walkpath}, let the vertices be $a,b,c$ and edges
be $(a,b), (b,a), (b,c), (c,b)$.  Now $a$ and $c$ are on the closed
walk $a,b,c,b,a$, but every closed walk from $a$ to $c$ must go
through $b$ at least twice, and so will not be a cycle.
