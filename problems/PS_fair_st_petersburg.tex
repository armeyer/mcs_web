...
\begin{pcomments}
  ...
  \pcomment{PS_fair_st_petersburg}
  \pcomment{subsumed by PS_fair_martingale}
  \pcomment{related to MQ_st_petersburg}
...
gambler gets back the amount he bet along with an additional wins the
amount equal to his bet.  Otherwise he loses the amount bet.  For
example, suppose a gambler bets \$10.  Then if he wins, he gets back
...
such a game.  A well know strategy of this kind is \emph{bet
  doubling}---also known as the St. Peterberg strategy---because of an
alleged attempt to bankrupt the famous St. Petersberg casino in 19th
century Russia.  With this strategy, he makes some initial bet, say
\$10.  If he wins, he stops playing and leaves with his \$10 profit.
If he loses, he doubles his bet, and continues in this way until a
Head finally gets tossed.  Thus, if the gambler loses \$10 on the
first toss, he bets \$20 on the second toss.  Now if the second toss
is Heads, he gets his \$20 bet plus \$20 back and again walks away
with a net win of $20-10 = \$10$.  If he loses the second toss, he
bets \$40 on the third toss, and so on.
...
\ppart
Verify that if there was a fixed
