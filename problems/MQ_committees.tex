...
possible arrangements (or pairs $\paren{S_1,S_2}$) where Aleph
...
pairs $\paren{S_1,S_2}$) where Aleph and Beth serve together
on the second committee.  So the number of possible arrangements (or
pairs $\paren{S_1,S_2}$) in which Aleph and Beth serve on the
