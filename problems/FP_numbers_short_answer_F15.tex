...
as stated, write the numeral of the \emph{weakest} of the
side-conditions necessary to make the assertion true, or write
\False\ if none of the side-conditions imply the assertion is correct.
...
\ppart If $a \divides b c$, then $a \divides c$.  \hfill\examrule
...
\ppart No integer linear combination of $a^2$ and $b^2$ equals two.\hfill\examrule
