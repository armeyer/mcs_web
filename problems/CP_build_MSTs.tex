...
\end{staffnotes}
\ppart Grow an MST for $G$ starting with the tree consisting the
...
any connected weighted graph where no two edges have the same weight.
\end{solution}
