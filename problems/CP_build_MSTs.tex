...
\ppart Look up the proof of the ``gray edge''
Lemma~\bref{lem:edgeextends}, and spend up to 15 minutes drawing one
or two figures that could be added to the text to help make the proof
clearer.

\begin{solution}
When we get the figures, we'll add them to the text.
\end{solution}
