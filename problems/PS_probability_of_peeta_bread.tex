...
\qquard If $k$ is odd and $k \le n$, then the probability is $\frac{1}{2n}$.

\qquard If $k$ is even and $k \le n$, then the probability is $\frac{1}{n}$.

\qquard If $k$ is odd and $k > n$, then the probability is $0$.

\qquard If $k$ is even and $k > n$, then the probability is $\frac{1}{2n}$.
...
\qquard If $c=H$, then the sum of the $n$ possible outcomes is
$\sum_{i=1}^{n}{i} = \frac{n(n+1)}{2}$.

\qquard If $c=T$, then the sum of the $n$ possible outcomes is doubled,
$\sum_{i=1}^{n}{2i} = n(n+1)$.
