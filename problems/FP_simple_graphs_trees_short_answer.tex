...
\begin{solution}
$10!$ A cycle is determined by the sequence of 11 vertices in it, but
  since a cycle has no ``first'' or ``last'' vertex, 11 different
  sequences determine the same cycle.  So the number of cycles equals
  the number of sequences, namely $11!$ divided by 11.
\end{solution}
