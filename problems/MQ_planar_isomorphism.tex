...
\begin{pcomments}
  ...
  \pcomment{needs reformatting as handout problem}
\end{pcomments}
...
\solution[\vspace{1in}]{The composition of an isomorphism from $G_1$ to
...
\solution[\vspace{1in}]{The embedding pictured in $G_2$ is not isomorphic
  to either of the other embeddings pictured because the $G_2$ embedding
  has a face with four edges, while neither of others do.}

\ppart Explain why all embeddings of two isomorphic planar graphs must
have the same number of faces.

\solution[\vspace{1in}]{$f=2+v-e.$}
