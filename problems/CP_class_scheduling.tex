...
\begin{problem}
  ...
  defines an indirect prerequisite relation, $\prec$, that is a DAG
  with these subjects as vertices.
%
\begin{align*}
...
6.034.  Then a fourth subject could be any of 6.042, 6.046, and 6.840.
