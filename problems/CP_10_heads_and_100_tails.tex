...
\begin{solution}
States are tuples of the form $(H, T)$ where $H \ge 0$ and $T \ge 0$.
The start state is $(10, 100)$.
The transitions are of the form
$(H, T) \rightarrow (2H, T)$ with the restriction of $T > H$,
and $(H, T) \rightarrow (H-10, T-10)$ with the restriction of
$H \ge 10$ and $T \ge 10$.
\end{solution}
