...
\begin{problem}
Prove by induction that the gcd of a nonempty finite set of integers
is an integer linear combination of the numbers in the set.  You may
assume that the gcd of two integers is an integer linear combination
of them, which was proved \inhandout{in the
