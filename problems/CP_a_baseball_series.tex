...
\begin{problem}
In the alternate universe where the Red Sox don't utterly collapse at the end of their season, the New York Yankees and the Boston Red Sox are playing a
...
the series ends. Again, a fantasy world we can only dream of.)  Assume that the Red Sox win each game with
