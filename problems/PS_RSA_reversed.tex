...
secret key $(d,n)$ and posts a public key, $(e,n)$, which anyone can
...
encrypt his message using his secret key as though it was someone's
...
by using Pete's public key as though it were their own secret key.
...
\begin{solution}
We write ``$\equiv$'' for  ``$\equiv pmod n$:''
\begin{align*}
