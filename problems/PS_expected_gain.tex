...
\hint Let $X_i$ be $2$ or $1/2$ depending on what happens to your
money at the end of the $i$th year.
...
\]
Therefore, the number of dollars after $k$~years is
\[
10^6 \paren{\frac{5}{4}}^k.
\]
\end{solution}
...
number of dollars in dividend payments you will receive over the
10~years.  You do need to evaluate your expressoin.
...
\begin{solution}
\[
\sum_{k=1}^{10} 10^6 \cdot \paren{\frac{5}{4}}^k =
10^6 \cdot \sum_{k=1}^{10} \paren{\frac{5}{4}}^k =
10^6 \cdot \frac{(5/4)^{11} - 1}{5/4 - 1} = 10^6 \cdot \frac{5^{11}-4^{11}}{4^{10}}.
\]
\end{solution}
