...
\solution{Create a vertex in $G$ for each entry in the Latin Square.
...
\solution{Construct a bipartite graph as follows. One set of vertices 
...
\solution{Suppose the Latin rectangle has $k$ rows of width $n$. Then
