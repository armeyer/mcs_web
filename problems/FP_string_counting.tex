...
\texttt{THTTHHHHHT} and \texttt{HHHHHHHHH} describe sequences of flips
with 5 consecutive heads, but \texttt{HHHHTHHHHT} does not.''
...
\ppart[1] Give a counter-example to~\eqref{n416}.
...
\ppart[3] Explain what the mistake is in the false proof.  You do
