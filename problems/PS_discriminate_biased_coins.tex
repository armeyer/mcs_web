...
\ppart Suppose you had access to a computer program that would accept
any $n \geq 0$ and $p\in[0,1]$ and generate, in the form of a plot or
table, the full binomial probability density and cumulative
distribution functions corresponding to those parameters.  How would
