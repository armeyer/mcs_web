...
expectation and
variance are $n\frac{1}{2}=\frac{n}{2}$ and 
$n\paren{\frac{1}{2}}\paren{1-\frac{1}{2}}=\frac{n}{4}$, respectively.  Using Chebyshev's
inequality for the fair coin,
\begin{align*}
\pr{\frac{F}{n} > \frac{5}{8}} 
& = \pr{\frac{F}{n} - \frac{1}{2} > \frac{5}{8} - \frac{1}{2}}
  = \pr{F - \frac{n}{2} > \frac{n}{8} } \\
& = \pr{F - \expect{F} > \frac{n}{8} } 
  \leq \pr{ \abs{F - \expect{F}} > \frac{n}{8} } \\
...
distribution, 
so its expectation and variance are $n\frac{3}{4}=\frac{3n}{4}$ and
...
& = \pr{\expect{B} - B > \frac{n}{8} } 
  \leq \pr{ \abs{B - \expect{B}} > \frac{n}{8} } \\
