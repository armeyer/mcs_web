...
$n =pq$ in the public key, explain why RSA would also be trivial to
crack knowing $\phi(pq)$.
...
\ppart Show that if you knew $n = pq$ and $\phi(n)$, you could easily factor $n$.
\hint Replace $q$ by $n/p$ in the expression for $\phi(n)$ and solve for $p$.
