...
\begin{problem}
  ...
  term, every student in 6.042 possessed exactly \emph{eight} of these
  virtues.  Furthermore, every student was unique; that is, no two
  students possessed exactly the same set of virtues.  The 6.042
  course staff must select \emph{one} additional virtue to impart to
  each student by the end of the term.  Prove that there is a way to
  select an additional virtue for each student so that every student
  is unique at the end of the term as well.
