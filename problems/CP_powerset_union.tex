...
\begin{pcomments}
  ...
  \pcomment{idea from Bender \& Williamson [Bender2005], Sets & Functions, prob 1.20}
...
\begin{solution}
To show $\subseteq$, we show that every element of $\power(A) \union
\power(B)$ is an element of $\power(A \union B)$.  Namely,
\begin{align*}
