...
\begin{problem}
Show that $\log_7 n$ is either an integer or irrational, where $n$ is a
positive integer.  Use whatever familiar facts about integers and primes
you need, but explicitly state such facts.

\iffalse \inhandout{(This problem will be graded on the clarity and
  simplicity of your proof.  If you can't figure out how to prove it,
  ask the staff for help and they'll tell you how.)}  \fi
...
since the only prime dividing the right-hand of~\eqref{nj} is 7,
