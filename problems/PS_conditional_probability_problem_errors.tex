...
\begin{problem}
  ...
  There is a course ---not 6.042, naturally ---in which $10 \%$ of the
  assigned problems contain errors.  If you ask a TA whether a problem
  has an error, then he or she will answer correctly $80\%$ of the
  time.  This $80 \%$ accuracy holds regardless of whether or not a
  problem has an error.  Likewise when you ask a lecturer, but with
  only $75 \%$ accuracy.
...
\end{solution}
  ...
  it, and she tells you that the problem is correct.  To double-check,
