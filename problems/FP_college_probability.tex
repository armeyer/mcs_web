...
Sally is either be happy or unhappy in college.
...
\ppart A tree diagram to help Sally projects her chance at happiness is shown below.  On the diagram, fill in the edge probabilities, and at each leaf write the probability of corresponding outcome and happiness event label ("H" for happy, "U" for unhappy).
...
\ppart What is the probability that Sally will be happy in college?
\examspace[2in]

\begin{solution}
The probability that she will be happy is equal to
...
right side is $4/12$, and the probability that she is happy is nonzero.
\end{solution}
...
\begin{solution}
These twevents are independent if:
