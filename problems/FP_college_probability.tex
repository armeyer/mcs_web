...
\ppart A tree diagram for Sally's situation is shown below.  On the
...
\ppart What is the probability that Sally Smart attends Yale, given
...
\ppart Show that the event that Sally attends Yale is \textbf{not}
...
\ppart Show that the event that Sally Smart attends MIT \textbf{is}
independent of the event that she is happy.
\examspace[2in]
