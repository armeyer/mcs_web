...
\begin{solution}
  We compare $(P \QOR Q \QOR R)$ and $K \eqdef (P \QAND \QNOT(Q)) \QOR (Q \QAND
  \QNOT(R)) \QOR (R \QAND \QNOT(P)) \QOR (P \QAND Q \QAND R)$ using a truth
  table:
...
Both $(P \QOR Q \QOR R)$ and $K$ have identical truth tables, thus the two
