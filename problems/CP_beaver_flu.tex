...
\begin{pcomments}
  ...
  \pcomment{same as CP_beaver_flu_using_invariant w/o hint}
...
of infection then define the transitions of a state machine.  Find a
weakly decreasing derived variable that leads to a proof of this
theorem.  \inhandout{(If you don't see it within 4 minutes, ask your
  TA for a four word hint.)}

\begin{staffnotes}
\hint ``perimeter of infected region''
\end{staffnotes}
