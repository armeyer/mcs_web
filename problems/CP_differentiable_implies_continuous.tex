...
\begin{pcomments}
  \pcomment{PS_differentiable_implies_continuous}
  \pcomment{from: S17.cp2f, S09.cp2m, F17.cp2w}
\end{pcomments}
...
you can't watch TV,'' then letting $T$ stand for ``can watch TV'' and $H$ for
...
\begin{staffnotes}
If a discussion about the watching TV and homework doesn't get going
on its own, ask students to come up with rationales for both the
$\QIFF$ and the $\QIMP$ interpretations, like those below for example.
...
But circumstances in the household might instead be that the boy may
watch TV when he has not only done his homework, but \emph{also}
cleaned up his room.  In this case, just doing homework would not
imply being allowed to watch TV---the boy won't be allowed to watch TV
if he hasn't cleaned his room, even if he has done his homework, so in
this case the Mother really means $\QIMPLIES$.

The general point here is that semantics (meaning) trumps syntax
(sentence structure).  Even though the mathematician's and mother's
statements have the same structure, their meaning may warrant
different translations into precise logical language.
