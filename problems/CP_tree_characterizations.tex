...
\begin{pcomments}
  ...
  \pcomment{subsumed by Theorem~th:treeprops in the text}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{problem}
Starting with the definition of a tree as a simple graph that is
connected and acyclic, prove that a graph is a tree iff it has a
unique path between every two vertices.
