...
subset relation, $\subset$.  For example, the task corresponding to
the set $\set{2,4}$ must be completed before the task corresponding to
the set $\set{1, 2, 4}$ because $\set{2,4} \subset \set{1,2,4}$.
