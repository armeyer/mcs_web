...
%\textbf{First-order Logic and Counting}
  There are 10 students A, B, \dots, J that will be lined up according to
  the some rules below.

  Translate each of the following rules into predicate formulas (with the
  set of all students as the domain of discourse).  The only predicates
  you may use are
\begin{itemize}
\item equality and,
...
\ppart
Rule I: Student A must not be last.
...
\ppart
Rule II: Student B must be next to C (directly in front of or behind C).
