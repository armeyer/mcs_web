...
\begin{solution}
We first use the Pulverizer to $s,t$ such that $\gcd(23,13) = s\cdot 23 +
t\cdot 13$, namely,
\[
...
$\remainder{-7}{23}$, namely \textbf{16}.

\end{solution}

\ppart Use \idx{Fermat's theorem} to find the inverse of 13 modulo 23 in
