...
Prove that if a inverse-linear-recursive function repeats modulo $m$ at
...
implies that there will be such a $j < d+ m^d$.
\end{solution}

\ppart\label{ppart:alldivisors}
Conclude that if $f$ is a inverse-linear-recursive function and $f(k) =
...
\begin{solution}
Let $f$ be the inverse-linear-recursive function such that $f(0) =0, f(1)
