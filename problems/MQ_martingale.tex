...
\begin{pcomments}
  \pcomment{MQ_martingale}
  \pcomment{renamed from MQ_st_petersburg}
  \pcomment{renamed from CP_st_petersbErg}
  \pcomment{F07.rec14h}
  \pcomment{subsumed by sec:martingale}
\end{pcomments}
...
\ppart The paradoxical fact that the gambler's expected profit is
positive, despite the fact that the game is biased against him, is
explained by the fact that bet doubling is not a feasible strategy.
...
Verify that the gambler needs an infinite bankroll to follow the bet
doubling strategy.  In particular, prove that the expected size of the
gambler's last bet is infinite.
