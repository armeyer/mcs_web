...
the $\lnth{y}$ left shift of the binary representation of $x$.
...
\ppart By using binary strings of the form
\[
10^{r_0}10^{r_1}10^{r_2}10^{r_3}1\cdots
\]
to represent the contents of an arbitrary number of counters
$R_0,R_1,R_2,R_3,\dots$, outline how a Counter Machine with a fixed
number of counters can simulate a machine with an arbitrary number of
indirectly addressable counters.

\begin{solution}
\TBA{little bit of story}
\end{solution}
\eparts
