...
\[\begin{array}{lr}
(\bar{A} \QAND\, \bar{B} \QAND\, \bar{C} \QAND\, D) &
   \QOR\\
(\bar{A} \QAND\, \bar{B} \QAND\, C \QAND\, D)       &
   \QOR\\
(A \QAND\, \bar{B} \QAND\, \bar{C} \QAND\, D)       &
   \QOR\\
(A \QAND\, \bar{B} \QAND\, C \QAND\, D)             &
   \QOR\\                                            
(A \QAND\, B \QAND\, \bar{C} \QAND\, \bar{D})       &
   \QOR\\                                            
(A \QAND\, B \QAND\, \bar{C} \QAND\, D)             
\end{array}\]
