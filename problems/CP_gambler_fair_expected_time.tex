...
so
\begin{align*}
E(x) & = \frac{2 + (d+2)x - 2/(1-2x)}{1-2x+x^2}\\
     & = \frac{(1-2x)(2 + (d+2)x) - 2}{(1-2x)(1-x)^2}\\
     & = \frac{(d-2)x - 2(d+2)x^2}{(1-2x)(1-x)^2}
\end{align*}
...
\[
(d-2)x - 2(d+2)x^2 = A(1-x)^2 + B(1-2x)(1-x) + C(1-2x).
\]
