...
\item[(ii)] Let $n$ be the number of green lights showing.  Add $n+1$
...
\ppart\label{derivedvars_part} In any given state, let $G$ be the
number of green lights and $R$ be the number of red lights.  For the
following six derived variables
\[\begin{array}{|l|l|}\hline
 G   &  \rem{G}{2},\\
 R   &  \rem{R}{2},\\
 R+G &  \rem{R+G}{2},\\\hline
\end{array}\]
indicate which is\dots
