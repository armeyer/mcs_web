...
\begin{problem}
  Santa's elves have decided to pimp his ride.  They add spinners,
...
\[\begin{array}{|ll|l|}\hline
 G & \eqdef  \mbox{the number of green lights},&  G_2 \eqdef \rem{G}{2},\\
 R & \eqdef  \mbox{the number of red lights},  &  R_2 \eqdef \rem{R}{2},\\
 T & \eqdef \mbox{R+G},                        &  T_2 \eqdef \rem{R+G}{2}.\\\hline
\end{array}\]
...
$(g,r)\rightarrow(g-2a+10,r+2a-10)$.  Since $-2a+10$ is even, $G_2((g,r))=
G_2(g-2a+10, r+2a-10)$.
...
state is always even.  But since 1 is odd, it is not possible to reach a
state in which there is exactly 1 green light showing.
