...
\begin{staffnotes}
\hint The complete bipartite graph $K_{n+1, n+1}$.
\end{staffnotes}

\begin{solution}
An example would be the complete bipartite graph $K_{n+1, n+1}$.
Every vertex has degree $n+1$ and therefore by
part~\eqref{widthmindeg}, it has minimum width $n$.  But every
