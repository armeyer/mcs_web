...
most $k$.\footnote{Problem~\bref{PS_directed_Euler_circuits} shows
  ...
  substring.  Such strings are known as \emph{de Bruijn sequences}
  having been studied by the great Dutch mathematician/logician
  Nicolaas de Bruijn,%
\index{de Bruijn, Nicolaas} 
who died in February, 2012 at the age of 94.}
...
bit-strings, the minimum length, $n$, of any $(k+1)$-good bit-string must
