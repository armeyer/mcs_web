...
\begin{pcomments}
  \pcomment{FP_graphs_short_answer_fall11_monday}
...
\begin{solution}
\begin{editingnotes}
Corrected part(a) 12/13/13,
\end{editingnotes}
All but the first are preserved.  The first is not a property of
graphs, but rather of drawings of graphs.
\end{solution}
...
it.  \inbook{Indicate}\inhandout{Circle} whichever of the following assertions are true of
