...
\begin{solution}
1/3. If you ever arrive at $d$ you will stay there, so consider all walks from $b$ to $d$. 
They are BCD, BCBCD, BCBCBCD, and so on. probability of each walk is a geometric sequence that 
sums to 1/3.
\end{solution}
