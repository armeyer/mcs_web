...
\begin{figure}[h] %[htbp]
\begin{center}
\mbox{  \subfloat[$G_1$]{\includegraphics[width=1.5in,clip]{figures/G1}}
        \hspace{17mm}
        \subfloat[$G_2$]{\includegraphics[width=1.5in,clip]{figures/G4}} }
\mbox{  \subfloat[$G_3$]{\includegraphics[width=1.5in,clip]{figures/G2}}
        \hspace{17mm}
        \subfloat[$G_4$]{\includegraphics[width=1.5in,clip]{figures/G3}}
        }
\end{center}
