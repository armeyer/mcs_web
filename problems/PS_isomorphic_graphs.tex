...
\begin{figure}[h] %[htbp]
\begin{center}
\mbox{  \subfloat[$G_1$]{\graphic[width=1.5in,clip]{G1}}
        \hspace{17mm}
        \subfloat[$G_2$]{\graphic[width=1.5in,clip]{G4}} }
\mbox{  \subfloat[$G_3$]{\graphic[width=1.5in,clip]{G2}}
        \hspace{17mm}
        \subfloat[$G_4$]{\graphic[width=1.5in,clip]{G3}}
        }
\end{center}
