...
\begin{pcomments}
  \pcomment{CP_Cantor_Schroeder_Bernstein_theorem}
...
\pparts It is OK to assume that $A$ and $B$ are disjoint.  Why?
...
\begin{solution}
 Since $B \surj A$ there is a surjective function $h:B \to A$, so
