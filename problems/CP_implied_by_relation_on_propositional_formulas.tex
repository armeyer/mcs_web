...
\begin{pcomments}
  \pcomment{CP_implied_by_relation_on_propositional_formulas.tex}
  \pcomment{about the same as CP_images_and-propositional_formulas,
    CP_implies_relation_on_propositional_formulas}
...
function.
 ...
 \ppart\label{Iprops} \inbook{Indicate}\inhandout{Circle} the properties below possessed by the
 relation $J$:
  \[
  \begin{array}{ccccc}
  \mbox{function~~} & 
  ...
  \ppart \inbook{Indicate}\inhandout{Circle} the properties below
  possessed by the relation $\inv{J}$:
  \[
  \begin{array}{ccccc}
  \mbox{function~~} & 
  \mbox{~~total~~} &
