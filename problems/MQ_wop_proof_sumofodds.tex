...
\begin{pcomments}
  ...
  \pcomment{ARM revised MQ_prove_by_wop_odds into parts, 9/15/11}
\end{pcomments}
...
\begin{problem}
We'll use the Well Ordering Principle to prove that for every positive
integer, $n$, the sum of the first $n$ odd numbers is $n^2$, that is,
