...
\begin{pcomments}
  ...
  \pcomment{from: F09 tutor problem practice13/prob1}
\end{pcomments}
...
\ppart[4] Our theorems about sampling and distributions allow us to calculate
how confident we can be that the random variable, $P$, takes a value near
the constant, $p$.  This calculation uses some facts about voters and the
way they are chosen.  Which of the following facts are true?
