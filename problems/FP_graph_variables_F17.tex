...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{problem}
For any simple graph $G$ and ``new'' edge $e \in \vertices{G}^2 -
\edges{G}$, let $G+e$ be the graph that results from adding $e$ to
$\edges{G}$.  A real-valued function $f$ on finite simple graphs is
\begin{itemize}
