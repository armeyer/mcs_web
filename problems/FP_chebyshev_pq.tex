...
Write a simple expression in terms of $p$ and $n$ for each of the
following quantities.

\bparts

\ppart\label{expected} The expected number of Heads.
...
\ppart  The variance of the number of Heads.
...
\ppart The upper bound that Markov's Theorem gives for the probability
that the number of Heads is larger than expected by as much as 1\% of
the number of flips.
