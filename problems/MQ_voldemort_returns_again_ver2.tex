...
\item if both Foo Foo and Voldemort are getting released, say ``Foo Foo''
  with probability 1/4 and ``Voldemort'' with probability 3/4.
...
\put(102,70){\makebox(0,0){$1/4$}}
\put(102,50){\makebox(0,0){$3/4$}}
\put(90,8){\makebox(0,0){$1$}}
\put(150,120){\makebox(0,0){$1/3$}}
\put(150,90){\makebox(0,0){$1/12$}}
\put(150,30){\makebox(0,0){$1/4$}}
...
\prcond{S}{\textbf{``$V$''}} = \frac{ \pr{S \intersect \textbf{``$V$''} }}{ \pr{\textbf{``$V$''}} }
       = \frac{ 1/3 }{ 1/3 + 1/4 } = \frac{4}{7} < \frac{2}{3}\, .
\]
\end{solution}
...
\prcond{S}{\text{``$F$''}}
  ...
  =\frac{ 1/3 }{ 1/3 + 1/12} = \frac{4}{5} > \frac{2}{3}\, .
\]
\end{solution}
...
\frac{2}{3}
 ...
 & = \frac{4}{5} \cdot \frac{5}{12} + \frac{4}{7} \cdot \frac{7}{12}
