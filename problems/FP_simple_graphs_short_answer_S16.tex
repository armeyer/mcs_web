...
\begin{pcomments}
  \pcomment{FP_simple_graphs_short_answer_S16} \pcomment{
...
\ppart\label{numl11p} How many length 11-paths are there in $K_{41}$? \hfill \examrule
...
$s$ is the correct answer to part~\eqref{numl11p}.  How many length-11
\emph{cycles} are in $K_{41}$?  You may use $s$ in your answer.\hfill
\examrule
