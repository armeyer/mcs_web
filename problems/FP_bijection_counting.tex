...
\begin{solution}
  ...
  We can also define $f: \naturals \to \integers$ by the formula,
  \begin{align*}
  f(2k) & \eqdef 2k,\\
  f(2k+1) & \eqdef -2k-2,
  \end{align*}
  for $k \in \naturals$.  An equivalent formulation is:
  \[
...
\texttt{011} are there?  You should express your answer as an integer or
...
\begin{solution}
  ...
  of the remaining $n-3$ bits besides the substring \texttt{011}.
  ...
  only length 9 string containing 3 occurrences of \texttt{011}.  So,
