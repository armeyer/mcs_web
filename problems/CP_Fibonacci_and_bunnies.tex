...
\begin{pcomments}
  \pcomment{PS_Fibonacci_and_bunnies}
...
\begin{problem}
  ...
  Fibonacci decides that in order to never to run out of rabbits or money,
...
\[
R(x) \eqdef r_0+r_1x+r_2x^2+\cdot.
\]
...
\[
\begin{array}{rcrccrcrcccr}
A/(1+x)  & = & - & 1/4 & - & (1/4)  (-x) & - & (1/4)  (-x)^2 & - & \cdots & - & (1/4)       (-x)^n - \cdots\\
B/(1-x)  & = & - & 1/4 & - & (1/4)  x    & - & (1/4)  x^2    & - & \cdots & - & (1/4)       x^n - \cdots\\
C/(1-x)^2& = &   & 1/2 & + & (2/2)  x    & + & (3/2)  x^2    & + & \cdots & + & ((n+1)/2)   x^n + \cdots\\
\hline
R(x)     & = &   &     &   &   1    x    & + &   1    x^2    & + & \cdots & + & \paren{\frac{n+1}{2} - \frac{(-1)^n +1}{4}}
                                                                                      x^n + \cdots
\end{array}
\]
so
