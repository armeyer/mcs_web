...
\begin{problem}
  ...
  The \term{degree sequence} of a simple graph is the weakly decreasing
  sequence of degrees of its vertices.  For example, the degree sequence
  for the 5-vertex numbered tree pictured below is $(2,2,2,1,1)$ and for
  the 7-vertex tree it is $(3,3,2,1,1,1,1)$.

We're interested in counting how many numbered trees there are with a
given degree sequence.  We'll do this using the bijection between
$n$-vertex \idx{numbered trees} and length $n-2$ code words whose
characters are integers between $1$ and $n$.  This bijective coding of
trees to code words is reviewed in the box below.
