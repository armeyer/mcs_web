...
\lefteqn{[\forall x\, \exists y.\, P(x) \QAND Q(x,y)]\ \QIMPLIES}\\ 
 ...
 & \corresp
  \QNOT(\forall x\, \exists y.\, P(x) \QAND Q(x,y))\ \QOR\\
  & \qquad\qquad   (\exists x_1.\, R(x_1,y)) \QOR \exists z\, \forall x_2.\, ((S(z) \QOR T(x_2)) \QAND \QNOT(S(z) \QAND T(x_2)))
         &\text{(step~\ref{toandor}.)}\\
 & \corresp
  \exists x\, \QNOT(\exists y.\, P(x) \QAND Q(x,y)))\ \QOR\\
  & \qquad\qquad   (\exists x_1.\, R(x_1,y)) \QOR \exists z\, \forall x_2.\, ((S(z) \QOR T(x_2)) \QAND (\QNOT S(z) \QOR \QNOT T(x_2)))
         &\text{(start step~\ref{appDeM}.)}\\
 & \corresp
 ...
 & \corresp
  ...
  & \qquad\qquad  \QNOT(P(x) \QAND Q(x,y)) \QOR  R(x_1,y) \QOR  ((S(z) \QOR T(x_2)) \QAND (\QNOT S(z) \QOR \QNOT T(x_2))).
         &\text{(step~\ref{qtfront}.)}\\
\end{align*}
