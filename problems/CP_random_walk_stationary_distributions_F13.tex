...
But starting at $b$, the probability of getting stuck at $d$ is
obviously $1/2$ times the probability of getting stuck at $d$ starting
at $c$.  Now by symmetry, the probability that starting at node $c$
you wind up stuck in $a$ is also $x$.  Since the probability of never
getting stuck at either $a$ or $d$ is obviously 0, the probability
that starting at node $c$ you wind up stuck at $d$ is $1-x$.
Therefore,
\[
x = \frac{1}{2}(1-x),
\]
