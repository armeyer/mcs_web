...
\begin{center}
  \begin{tabular*}{\textwidth}{@{\extracolsep{\fill}} | c | c | c | c | c | c |}
    ...
    $\mathbb{N}$ & $a | b$\footnotemark & & & & \\ \hline
    $P(\{1, 2, 3\})$ & $a\subseteq b$ & & & &  \\ \hline
    $\mathbb{N} \cup \{i\}$ & $a > b$\footnotemark & & & &  \\
    \hline
  \end{tabular*}
\end{center}
...
\footnotetext[1]{Definition: $a | b$ iff $b=ak$ for some $k \in \mathbb{N}$}
\footnotetext[2]{Definition: $a > b$ iff $a, b \in \mathbb{N}$ and $a > b$}
