...
of these.  If it is a partial order, state whether it is a path-total
...
This problem took longer than expected for students to go through in the class. Parts (f) and (h) are the trickiest parts, usually where students made mistakes.
...
\begin{solution}
  ...
  order.  It's not path-total.  It not an equivalence relation because
  it is not reflexive.
\end{solution}
...
\begin{solution}
  ...
  weak partial order.  It's not path-total.  It's also an equivalence
