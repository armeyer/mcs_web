...
\ppart[1] What is the expected number of people who get their own hat back?
...
\problempart[2] Write a simple formula for $\expect{X_i X_j}$ for $i \neq j$.
...
problempart[1] Explain why you cannot use the \idx{variance} of sums formula to
...
\problempart[3] Show that $\expect{S_n^2} = 2$. \hint $X_i^2 = X_i$.
...
\problempart[1] What is the variance of $S_n$?
...
\problempart[3] Use the \idx{Chebyshev bound} to show that the probability
