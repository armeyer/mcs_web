...
\begin{pcomments}
  ...
  \pcomment{total f added by ARM 2/22/12}
\end{pcomments}
...
\problempart If $f$ is a total injection and $g$ is a surjection, then
is $g \compose f$ necessarily a bijection?
...
In this case, $f$ is a total injection, $g$ is surjective, but $g
\compose f$ is not a bijection.
\end{solution}
