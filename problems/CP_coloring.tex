...
\begin{solution}
There are some $K_3$'s---triangles---in the graph, so at least three
colors will be needed.  Three colors are all that's needed, as
illustrated in Figure~\ref{fig:colored}.
